                            ...
                            create.addListener(new Runnable() {
                                public void run() {
                                    try {
                                        ...
                                        Logger.get().info(WorkerWrapper.TAG, String.format("%s was cancelled", new Object[]{str}), e2);
                                    } catch (InterruptedException | ExecutionException e3) {
                                        Logger.get().error(WorkerWrapper.TAG, String.format("%s failed because it threw an exception/error", new Object[]{str}), e3);
                                    } catch (Throwable th) {
