        ...
        if (name.equals("gradient")) {
            ...
            if (namedInt == 1) {
                ...
                if (namedFloat7 > 0.0f) {
                    ...
                    return new RadialGradient(f3, namedFloat6, namedFloat7, iArr, checkColors.mOffsets, parseTileMode(namedInt2));
                }
                ...
                return new SweepGradient(f2, namedFloat6, checkColors.mColors, checkColors.mOffsets);
            }
        } else {
