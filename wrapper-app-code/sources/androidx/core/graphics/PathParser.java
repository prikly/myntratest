            ...
            while (i3 < fArr3.length) {
                if (c4 != 'A') {
                    if (c4 == 'C') {
                        ...
                        int i45 = i3 + 6;
                        i2 = i3;
                        drawArc(path, f18, f19, fArr3[i44] + f18, fArr3[i45] + f19, fArr3[i3 + 0], fArr3[i3 + 1], fArr3[i3 + 2], fArr3[i3 + 3] != 0.0f, fArr3[i3 + 4] != 0.0f);
                        f2 = f18 + fArr3[i44];
                        f3 = f19 + fArr3[i45];
                    }
                    i3 = i2 + i;
                    ...
                    int i46 = i2 + 5;
                    int i47 = i2 + 6;
                    drawArc(path, f18, f19, fArr3[i46], fArr3[i47], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                    f2 = fArr3[i46];
                    f3 = fArr3[i47];
                }
                f15 = f19;
