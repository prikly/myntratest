...
public class MotionController {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (easing != null) {
                ...
                float f9 = f7 - f8;
                d2 = (double) ((((float) easing.get((double) ((f6 - f8) / f9))) * f9) + f8);
            }
            double d3 = d2;
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            if (easing != null) {
                ...
                float f7 = f5 - f6;
                d4 = (double) ((((float) easing.get((double) ((f4 - f6) / f7))) * f7) + f6);
            }
            ...
            f3 = i2 > 0 ? (float) (((double) f8) + Math.hypot(d3 - ((double) fArr[1]), d2 - ((double) fArr[0]))) : f8;
            d2 = (double) fArr[0];
            i = i2 + 1;
            d3 = (double) fArr[1];
        }
    ...
    public void buildRect(float f2, float[] fArr, int i) {
        this.mSpline[0].getPos((double) getAdjustedPosition(f2, (float[]) null), this.mInterpolateData);
