    ...
    public void updateRunCenter(Dependency dependency, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i) {
        ...
        if (target.resolved && target2.resolved) {
            ...
            if (this.dimension.resolved) {
                ...
                if (i == 0) {
                    f2 = constraintWidget.getHorizontalBiasPercent();
                } else {
                    f2 = constraintWidget.getVerticalBiasPercent();
                }
                if (target == target2) {
                    margin = target.value;
                ...
                this.start.resolve((int) (((float) margin) + 0.5f + (((float) ((margin2 - margin) - this.dimension.value)) * f2)));
