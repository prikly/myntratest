...
public class ConstraintAnchor {
    ...
    int mGoneMargin = RecyclerView.UNDEFINED_DURATION;
    ...
    public void reset() {
        ...
        this.mTarget = null;
        this.mMargin = 0;
        this.mGoneMargin = RecyclerView.UNDEFINED_DURATION;
        this.mHasFinalValue = false;
        this.mFinalValue = 0;
    }
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i) {
        return connect(constraintAnchor, i, RecyclerView.UNDEFINED_DURATION, false);
    }
