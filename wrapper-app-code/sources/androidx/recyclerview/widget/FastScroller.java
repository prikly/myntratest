...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        this.mMargin = i3;
        this.mVerticalThumbDrawable.setAlpha(KotlinVersion.MAX_COMPONENT_VALUE);
        this.mVerticalTrackDrawable.setAlpha(KotlinVersion.MAX_COMPONENT_VALUE);
    ...
    public void setState(int i) {
        ...
        if (this.mState == 2 && i != 2) {
            ...
            resetHideDelay(IronSourceConstants.RV_INSTANCE_LOAD_FAILED);
        } else if (i == 1) {
            resetHideDelay(1500);
        }
        this.mState = i;
    ...
    public boolean isPointInsideVerticalThumb(float f2, float f3) {
        if (!isLayoutRTL() ? f2 >= ((float) (this.mRecyclerViewWidth - this.mVerticalThumbWidth)) : f2 <= ((float) this.mVerticalThumbWidth)) {
