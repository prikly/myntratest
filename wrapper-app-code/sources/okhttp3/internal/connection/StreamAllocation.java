...
public final class StreamAllocation {
    ...
    public void streamFailed(java.io.IOException r7) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r7 instanceof okhttp3.internal.http2.StreamResetException     // Catch:{ all -> 0x006a }
            r2 = 0
            r3 = 0
            r4 = 1
            if (r1 == 0) goto L_0x0024
            okhttp3.internal.http2.StreamResetException r7 = (okhttp3.internal.http2.StreamResetException) r7     // Catch:{ all -> 0x006a }
            okhttp3.internal.http2.ErrorCode r1 = r7.errorCode     // Catch:{ all -> 0x006a }
            okhttp3.internal.http2.ErrorCode r5 = okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x006a }
            if (r1 != r5) goto L_0x0017
            int r1 = r6.refusedStreamCount     // Catch:{ all -> 0x006a }
            int r1 = r1 + r4
            r6.refusedStreamCount = r1     // Catch:{ all -> 0x006a }
        L_0x0017:
            okhttp3.internal.http2.ErrorCode r7 = r7.errorCode     // Catch:{ all -> 0x006a }
            okhttp3.internal.http2.ErrorCode r1 = okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x006a }
            if (r7 != r1) goto L_0x0021
            int r7 = r6.refusedStreamCount     // Catch:{ all -> 0x006a }
            if (r7 <= r4) goto L_0x004b
        L_0x0021:
            r6.route = r3     // Catch:{ all -> 0x006a }
            goto L_0x0049
        L_0x0024:
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x006a }
            if (r1 == 0) goto L_0x004b
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x006a }
            boolean r1 = r1.isMultiplexed()     // Catch:{ all -> 0x006a }
            if (r1 == 0) goto L_0x0034
            boolean r1 = r7 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x006a }
            if (r1 == 0) goto L_0x004b
        L_0x0034:
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x006a }
            int r1 = r1.successCount     // Catch:{ all -> 0x006a }
            if (r1 != 0) goto L_0x0049
            okhttp3.Route r1 = r6.route     // Catch:{ all -> 0x006a }
            if (r1 == 0) goto L_0x0047
            if (r7 == 0) goto L_0x0047
            okhttp3.internal.connection.RouteSelector r1 = r6.routeSelector     // Catch:{ all -> 0x006a }
            okhttp3.Route r5 = r6.route     // Catch:{ all -> 0x006a }
            r1.connectFailed(r5, r7)     // Catch:{ all -> 0x006a }
        L_0x0047:
            r6.route = r3     // Catch:{ all -> 0x006a }
        L_0x0049:
            r7 = 1
        ...
        L_0x004c:
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x006a }
            java.net.Socket r7 = r6.deallocate(r7, r2, r4)     // Catch:{ all -> 0x006a }
            okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch:{ all -> 0x006a }
            if (r2 != 0) goto L_0x005c
            boolean r2 = r6.reportedAcquired     // Catch:{ all -> 0x006a }
