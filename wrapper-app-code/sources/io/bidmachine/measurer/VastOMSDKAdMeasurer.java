...
public class VastOMSDKAdMeasurer extends OMSDKAdMeasurer<View> implements VastAdMeasurer, VastPlaybackListener {
    ...
    /* access modifiers changed from: private */
    public final List<VerificationScriptResource> resourceList = new ArrayList();
    ...
    public void addVerificationScriptResourceList(final List<AdVerificationsExtensionTag> list) {
        if (list != null) {
            Utils.onUiThread(new Runnable() {
                ...
                static {
                    Class<VastOMSDKAdMeasurer> cls = VastOMSDKAdMeasurer.class;
                }
                    ...
                    try {
                        for (AdVerificationsExtensionTag adVerificationsExtensionTag : list) {
                            if (adVerificationsExtensionTag != null) {
                                for (VerificationTag next : adVerificationsExtensionTag.getVerificationTagList()) {
                                    JavaScriptResourceTag javaScriptResourceTag = next.getJavaScriptResourceTag();
    ...
    public void addVerificationScriptResource(String str, String str2, String str3) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str2) || TextUtils.isEmpty(str3)) {
                ...
                verificationScriptResource = VerificationScriptResource.createVerificationScriptResourceWithParameters(str2, url, str3);
            }
            this.resourceList.add(verificationScriptResource);
        } catch (Throwable th) {
            Logger.log(th);
        }
    }
        ...
        Utils.onUiThread(new Runnable() {
            public void run() {
                try {
                    ...
                    if (!VastOMSDKAdMeasurer.this.isSessionPrepared()) {
                        ...
                        MediaEvents unused = VastOMSDKAdMeasurer.this.mediaEvents = MediaEvents.createMediaEvents(createAdSession);
    ...
    public void onAdLoaded(AdEvents adEvents) throws Throwable {
        ...
        if (f2 == -1.0f) {
            ...
            vastProperties = VastProperties.createVastPropertiesForSkippableMedia(f2, true, Position.STANDALONE);
        }
    ...
    public void destroy() {
        Utils.onUiThread(new Runnable() {
            public void run() {
                MediaEvents unused = VastOMSDKAdMeasurer.this.mediaEvents = null;
            }
        });
        super.destroy();
    }
