...
public enum LossReason implements ProtocolMessageEnum {
    ...
    LOSS_REASON_CREATIVE_FILTERED_DISAPPROVED(LOSS_REASON_CREATIVE_FILTERED_DISAPPROVED_VALUE),
    ...
    private static final LossReason[] VALUES = null;
    private static final Internal.EnumLiteMap<LossReason> internalValueMap = null;
    private final int value;

    static {
        internalValueMap = new Internal.EnumLiteMap<LossReason>() {
