...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v1, resolved type: com.explorestack.protobuf.GeneratedMessageLite$GeneratedExtension} */
