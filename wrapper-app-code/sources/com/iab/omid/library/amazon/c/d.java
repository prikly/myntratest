...
public class d implements a {
    ...
    private final int[] f7578a = new int[2];

    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.C0067a aVar, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            aVar.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0067a aVar, boolean z) {
    ...
    public JSONObject a(View view) {
        ...
        view.getLocationOnScreen(this.f7578a);
        int[] iArr = this.f7578a;
