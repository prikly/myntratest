...
public abstract class AdSessionStatePublisher {
    ...
    private b f7477a = new b((WebView) null);

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f7478b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f7479c;
    ...
    public void a(WebView webView) {
        this.f7477a = new b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f7478b = adEvents;
    }
    ...
    public void a(String str, long j) {
        if (j >= this.f7481e) {
            this.f7480d = a.AD_STATE_VISIBLE;
    ...
    public void b(String str, long j) {
        a aVar;
        if (j >= this.f7481e && this.f7480d != (aVar = a.AD_STATE_NOTVISIBLE)) {
            this.f7480d = aVar;
            e.a().b(getWebView(), str);
        }
    }
    ...
    public WebView getWebView() {
        return (WebView) this.f7477a.get();
    }
    ...
    public void i() {
        this.f7481e = com.iab.omid.library.adcolony.d.d.a();
        this.f7480d = a.AD_STATE_IDLE;
    }
}
