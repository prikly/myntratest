...
public class d implements a {
    ...
    private final int[] f7907a = new int[2];

    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.C0076a aVar) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            aVar.a(viewGroup.getChildAt(i), this, jSONObject);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0076a aVar) {
    ...
    public JSONObject a(View view) {
        ...
        view.getLocationOnScreen(this.f7907a);
        int[] iArr = this.f7907a;
