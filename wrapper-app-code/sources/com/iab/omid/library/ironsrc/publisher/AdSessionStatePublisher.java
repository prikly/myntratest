...
public abstract class AdSessionStatePublisher {
    ...
    private b f7913a = new b((WebView) null);

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f7914b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f7915c;
    ...
    public void a(WebView webView) {
        this.f7913a = new b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f7914b = adEvents;
    }
    ...
    public void a(String str, long j) {
        if (j >= this.f7917e) {
            this.f7916d = a.AD_STATE_VISIBLE;
    ...
    public void b(String str, long j) {
        if (j >= this.f7917e && this.f7916d != a.AD_STATE_NOTVISIBLE) {
            this.f7916d = a.AD_STATE_NOTVISIBLE;
            e.a().b(getWebView(), str);
        }
    }
    ...
    public WebView getWebView() {
        return (WebView) this.f7913a.get();
    }
    ...
    public void i() {
        this.f7917e = com.iab.omid.library.ironsrc.d.d.a();
        this.f7916d = a.AD_STATE_IDLE;
    }
}
