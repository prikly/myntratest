...
public class d implements a {
    ...
    private final int[] f7799a = new int[2];

    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.C0073a aVar) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            aVar.a(viewGroup.getChildAt(i), this, jSONObject);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0073a aVar) {
    ...
    public JSONObject a(View view) {
        ...
        view.getLocationOnScreen(this.f7799a);
