...
public class b {
    ...
    static float f7800a = Resources.getSystem().getDisplayMetrics().density;

    /* renamed from: b  reason: collision with root package name */
    private static WindowManager f7801b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f7802c = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};
    ...
    public static void a(Context context) {
        if (context != null) {
            f7800a = context.getResources().getDisplayMetrics().density;
            f7801b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b2 = b(jSONObject);
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, (double) b2.f7803a);
            jSONObject.put(IabUtils.KEY_HEIGHT, (double) b2.f7804b);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT < 17) {
            ...
            f7801b.getDefaultDisplay().getRealSize(point);
            f3 = a(point.x);
            f2 = a(point.y);
            return new a(f3, f2);
        }
