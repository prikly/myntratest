...
import com.iab.omid.library.appodeal.e.b;
...
public abstract class AdSessionStatePublisher {
    ...
    private b f7805a = new b((WebView) null);

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f7806b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f7807c;
    ...
    public void a(WebView webView) {
        this.f7805a = new b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f7806b = adEvents;
    }
    ...
    public void a(com.iab.omid.library.appodeal.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        for (VerificationScriptResource next : adSessionContext.getVerificationScriptResources()) {
            com.iab.omid.library.appodeal.d.b.a(jSONObject5, next.getVendorKey(), next.getVerificationParameters());
        }
        e.a().a(getWebView(), adSessionId, jSONObject2, jSONObject5, jSONObject);
    }

    public void a(MediaEvents mediaEvents) {
        this.f7807c = mediaEvents;
    }
    ...
    public void a(String str, long j) {
        if (j >= this.f7809e) {
            this.f7808d = a.AD_STATE_VISIBLE;
    ...
    public void b(String str, long j) {
        if (j >= this.f7809e && this.f7808d != a.AD_STATE_NOTVISIBLE) {
            this.f7808d = a.AD_STATE_NOTVISIBLE;
            e.a().b(getWebView(), str);
        }
    }
    ...
    public WebView getWebView() {
        return (WebView) this.f7805a.get();
    }
    ...
    public void i() {
        this.f7809e = com.iab.omid.library.appodeal.d.d.a();
        this.f7808d = a.AD_STATE_IDLE;
    }
}
