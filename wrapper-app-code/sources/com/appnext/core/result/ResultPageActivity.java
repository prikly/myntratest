...
public class ResultPageActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.ic = this.f5if.getSelectedAd();
            this.fJ = this.f5if.A();
            this.ca = this.f5if.B();
            this.userAction = new q(this, new q.a() {
                ...
                public final Ad e() {
                    return ResultPageActivity.this.f5if.D();
                }
                ...
                public final p g() {
                    return ResultPageActivity.this.f5if.C();
                }
            });
            this.ie = this.f5if.E();
    ...
    public class b {
        ...
        public final void adClicked(String str, int i) {
            ...
            q g2 = ResultPageActivity.this.userAction;
            AppnextAd b2 = ResultPageActivity.this.aE;
            StringBuilder sb = new StringBuilder();
            ...
            sb.append("1");
            g2.a(b2, sb.toString(), ResultPageActivity.this.placementID, new e.a() {
                public final void error(String str) {
                }
        ...
        public final void postView(String str) {
            ...
            q g2 = ResultPageActivity.this.userAction;
            g2.a(appnextAd, ResultPageActivity.this.h(appnextAd).getImpressionURL() + "&tem_id=" + ResultPageActivity.this.id + "1", (e.a) null);
        }
                ...
                public final void run() {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            try {
                                ResultPageActivity resultPageActivity = ResultPageActivity.this;
                                resultPageActivity.loadJS("Appnext.setParams(" + d.br().bs().getConfigParams().put("did", b2).toString() + ");");
                            } catch (Throwable unused) {
                            }
                            ResultPageActivity resultPageActivity2 = ResultPageActivity.this;
        ...
        try {
            ...
            if (appnextAd != null) {
                ...
                if (appnextAd.getStoreRating().equals("")) {
                    h(appnextAd).setStoreRating(BuildConfig.ADAPTER_VERSION);
                }
            }
            return appnextAd;
        } catch (Throwable unused) {
