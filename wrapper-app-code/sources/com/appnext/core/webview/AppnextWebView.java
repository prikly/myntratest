...
public final class AppnextWebView {
    ...
    public final HashMap<String, b> f16108io = new HashMap<>();
    ...
    public final synchronized void a(java.lang.String r8, com.appnext.core.webview.AppnextWebView.c r9) {
        /*
            r7 = this;
            monitor-enter(r7)
            java.util.HashMap<java.lang.String, com.appnext.core.webview.AppnextWebView$b> r0 = r7.f16108io     // Catch:{ all -> 0x004c }
        ...
        L_0x0045:
            java.util.HashMap<java.lang.String, com.appnext.core.webview.AppnextWebView$b> r9 = r7.f16108io     // Catch:{ all -> 0x004c }
    ...
    private class a extends AsyncTask<String, Void, String> {
        ...
        public final /* synthetic */ void onPostExecute(Object obj) {
            ...
            if (str.startsWith("error:")) {
                this.ir.state = 0;
                AppnextWebView.this.f16108io.put(this.ir.aQ, this.ir);
        ...
        public final String doInBackground(String... strArr) {
            try {
                b bVar = (b) AppnextWebView.this.f16108io.get(strArr[0]);
                bVar.is = f.a(strArr[0], (HashMap<String, String>) null, true, 10000);
                AppnextWebView.this.f16108io.put(strArr[0], bVar);
                return strArr[0];
    ...
    public final WebView a(Context context, String str, WebAppInterface webAppInterface, a aVar, String str2) {
        ...
        try {
            ...
            if (this.f16108io.containsKey(str)) {
                if (this.f16108io.get(str).state == 2 && !this.f16108io.get(str).is.equals("")) {
                    str3 = "<script>" + this.f16108io.get(str).is + "</script>";
    ...
    private void a(b bVar, String str) {
        ...
        synchronized (this.f16108io) {
            Iterator<c> it = bVar.hF.iterator();
            while (it.hasNext()) {
                it.next().error(str);
            }
            bVar.hF.clear();
            this.f16108io.remove(bVar.aQ);
        }
    }
    ...
    static /* synthetic */ void a(AppnextWebView appnextWebView, b bVar, String str) {
        new StringBuilder("webview error: ").append(str);
        synchronized (appnextWebView.f16108io) {
            Iterator<c> it = bVar.hF.iterator();
            while (it.hasNext()) {
                it.next().error(str);
            }
            bVar.hF.clear();
            appnextWebView.f16108io.remove(bVar.aQ);
        }
    }
