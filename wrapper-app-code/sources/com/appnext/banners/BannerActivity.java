            ...
            public final void onPageFinished(WebView webView, String str) {
                ...
                new Thread(new Runnable() {
                    public final void run() {
                        final String b2 = f.b(a.this.context, false);
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            public final void run() {
                                try {
                                    a aVar = a.this;
                                    aVar.loadJS("javascript:(function() { try { Appnext.setParams(" + a.this.getConfigParams().put("did", b2).toString() + "); } catch(err){ Appnext.jsError(err.message); }})()");
