    ...
    public int onRunJob(JobParameters jobParameters) {
        ...
        try {
            ...
            if (extras == null) {
                ...
                cVar = new c(extras.getString("status", ""), extras.getString(com.appnext.base.b.c.eQ, ""), extras.getString(com.appnext.base.b.c.eR, ""), extras.getString(com.appnext.base.b.c.eO, ""), extras.getString(com.appnext.base.b.c.eP, ""), string, extras.getString("service_key", ""), extras.getString("data", (String) null));
            }
            if (cVar == null) {
                b(jobParameters);
                return 0;
                ...
                try {
                    new b().a(getApplicationContext(), cVar.getKey(), (String) null, bundle, (Object) null, new a.C0158a() {
