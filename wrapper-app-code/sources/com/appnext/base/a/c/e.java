...
public abstract class e<MODEL extends d> {
    ...
    protected static long a(String str, ContentValues contentValues) {
        try {
            ...
            com.appnext.base.a.a.a.a(a.C0157a.DatabaseOrDiskFull$53629b42, new Exception(e2.getMessage()));
            return -1;
        } catch (Throwable th) {
            com.appnext.base.a.a.a.ac();
            com.appnext.base.a.a.a.a(a.C0157a.Global$53629b42, th);
            return -1;
        }
    }
    ...
    public final int a(String str, String[] strArr, String[] strArr2, List<a> list) {
        try {
            ...
            com.appnext.base.a.a.a.ac();
            com.appnext.base.a.a.a.a(a.C0157a.Global$53629b42, new Exception(th.getMessage()));
            return 0;
        }
    }
    ...
    public final List<MODEL> y(String str) {
        try {
            List<MODEL> e2 = e(com.appnext.base.a.a.a.ac().ad().query(str, at(), (String) null, (String[]) null, (String) null, (String) null, (String) null));
            com.appnext.base.a.a.a.ac().ae();
            return e2;
        } catch (Throwable unused) {
            return null;
    ...
    public final List<MODEL> a(String str, String[] strArr, String[] strArr2, String str2, List<a> list) {
        try {
            List<MODEL> e2 = e(com.appnext.base.a.a.a.ac().ad().query(str, at(), a(strArr, list), strArr2, (String) null, (String) null, str2));
            com.appnext.base.a.a.a.ac().ae();
            return e2;
        } catch (Throwable unused) {
            return null;
