...
public class Appnext {
                        ...
                        g.aN().b(new Runnable() {
                            ...
                            public final void run() {
                                /*
                                    ...
                                    android.content.Context r2 = r2.f4do     // Catch:{ all -> 0x00a6 }
                                    r0.init(r2)     // Catch:{ all -> 0x00a6 }
                                    com.appnext.base.Appnext r0 = com.appnext.base.Appnext.this     // Catch:{ all -> 0x00a6 }
                                    android.content.Context r0 = r0.f4do     // Catch:{ all -> 0x00a6 }
    ...
    public static void init(Context context) {
        ...
        if (context != null) {
            try {
                if (!appnext.dq || appnext.f4do == null) {
                    appnext.dq = true;
                    e.init(context);
                    appnext.f4do = context.getApplicationContext();
                    if (j.a(OperationService.class)) {
                        g.aN().b(new Runnable() {
                            /* Code decompiled incorrectly, please refer to instructions dump. */
                            public final void run() {
    ...
    static /* synthetic */ void b(Appnext appnext) {
        try {
            String b2 = f.b(appnext.f4do, true);
            if (!b2.equals(i.aR().getString(i.fB, ""))) {
                i.aR().clear();
                i.aR().putString(i.fB, b2);
            }
