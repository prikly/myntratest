...
public class InterstitialActivity extends AppnextActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            this.placementID = getIntent().getExtras().getString(OSOutcomeConstants.OUTCOME_ID);
        ...
        public void openResultPage(String str) {
            d.br().a(new c() {
                ...
                public final JSONObject getConfigParams() throws JSONException {
                    ...
                    String str = "";
                    jSONObject.put(ScarConstants.TOKEN_ID_KEY, InterstitialActivity.this.bR == null ? str : InterstitialActivity.this.bR.getTID());
                    ...
                    jSONObject.put(OSOutcomeConstants.OUTCOME_ID, getPlacementId());
