    ...
    public void showAd() {
        if (getPlacementID().equals("")) {
            ...
            if (Z2 == -1) {
                ...
                f.a(getTID(), getVID(), getAUID(), getPlacementID(), getSessionId(), a.f16102c, this.type == 1 ? "fullscreen" : "rewarded", "", "");
                if (b.j().b((Ad) this)) {
                    Intent intent = new Intent(this.context, FullscreenActivity.class);
                    intent.setFlags(268435456);
                    intent.putExtra(OSOutcomeConstants.OUTCOME_ID, getPlacementID());
    ...
    public void load() {
        b.j().a(this.context, (Ad) this, getPlacementID(), (d.a) new d.a() {
            public final <T> void a(T t) {
                AppnextAd b2 = b.j().b(Video.this.context, (Ad) Video.this);
