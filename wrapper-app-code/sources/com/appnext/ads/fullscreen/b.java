...
public final class b extends d {
    ...
    public final void a(Ad ad, String str, String str2) {
        if (ad != null) {
            f.a(ad.getTID(), ad.getVID(), ad.getAUID(), str2, str, a.k, ServiceProvider.NAMED_SDK, "", "");
        } else {
            f.a("300", "2.5.1.472", "700", str2, str, a.k, ServiceProvider.NAMED_SDK, "", "");
        }
    ...
    public final <T> void a(String str, Ad ad, T t) {
        f.a(ad.getTID(), ad.getVID(), ad.getAUID(), str, ((Video) ad).getSessionId(), a.j, ServiceProvider.NAMED_SDK, "", "");
    }
        ...
        try {
            ...
            if (b2 != null) {
                ...
                if (ad instanceof RewardedVideo) {
                    ...
                    if (mode.equals("multi") && (a2 = a(context, ad, b2.getBannerID())) != null) {
                        a(context, ad, a2);
                        return;
                    }
                    return;
