...
public class DefaultScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public void setScroll(float f2) {
        ...
        setPosition(((float) (this.pdfView.isSwipeVertical() ? this.pdfView.getHeight() : this.pdfView.getWidth())) * f2);
    }
    ...
    private void setPosition(float f2) {
        ...
        if (!Float.isInfinite(f2) && !Float.isNaN(f2)) {
            ...
            if (f4 < 0.0f) {
                f4 = 0.0f;
            } else if (f4 > f3 - ((float) Util.getDP(this.context, 40))) {
                f4 = f3 - ((float) Util.getDP(this.context, 40));
            }
            if (this.pdfView.isSwipeVertical()) {
                setY(f4);
            } else {
    ...
    private void calculateMiddle() {
        ...
        this.relativeHandlerMiddle = ((f3 + this.relativeHandlerMiddle) / ((float) i)) * f2;
    }
