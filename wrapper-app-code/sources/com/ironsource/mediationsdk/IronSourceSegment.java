...
public class IronSourceSegment {
    ...
    private int f8211b = 999999;

    /* renamed from: c  reason: collision with root package name */
    private double f8212c = 999999.99d;

    /* renamed from: d  reason: collision with root package name */
    private final String f8213d = OSNotificationFormatHelper.PAYLOAD_OS_ROOT_CUSTOM;

    /* renamed from: e  reason: collision with root package name */
    private final int f8214e = 5;
    ...
    public final Vector<Pair<String, String>> a() {
        ...
        if (!TextUtils.isEmpty(this.f8216g)) {
            vector.add(new Pair(GENDER, this.f8216g));
        }
        if (this.f8217h != -1) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append(this.f8217h);
        ...
        if (!TextUtils.isEmpty(this.f8210a)) {
            vector.add(new Pair("segName", this.f8210a));
        }
    ...
    public void setIAPTotal(double d2) {
        if (d2 <= 0.0d || d2 >= this.f8212c) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
            logger.log(ironSourceTag, "setIAPTotal( " + d2 + " ) iapt must be between 0-" + this.f8212c, 2);
            return;
        }
    ...
    public void setLevel(int i2) {
        if (i2 <= 0 || i2 >= this.f8211b) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
            logger.log(ironSourceTag, "setLevel( " + i2 + " ) level must be between 1-" + this.f8211b, 2);
            return;
        }
        this.f8217h = i2;
    }
