...
public final class C0884f {
    ...
    private static C0884f f8599b = new C0884f();

    /* renamed from: a  reason: collision with root package name */
    private final AtomicBoolean f8600a = new AtomicBoolean(false);
    ...
    public static class a {
        ...
        /* renamed from: b  reason: collision with root package name */
        List<com.ironsource.mediationsdk.server.b> f8602b;

        /* renamed from: c  reason: collision with root package name */
        com.ironsource.mediationsdk.server.b f8603c;
    ...
    static class b implements Runnable {
        ...
        public final void run() {
            boolean z = false;
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(this.f8610c).openConnection();
            ...
            if (!z) {
                ...
                try {
                    ...
                    jSONObject.put(IronSourceConstants.EVENTS_EXT1, this.f8608a + ";" + this.f8609b + ";" + this.f8610c);
    ...
    static a a(JSONObject jSONObject) {
        ...
        if (!TextUtils.isEmpty(optString)) {
            a aVar = new a();
            aVar.f8601a = optString;
            JSONObject jSONObject2 = null;
            if (jSONObject.has(com.appnext.core.a.b.hW)) {
                JSONObject jSONObject3 = jSONObject.getJSONObject(com.appnext.core.a.b.hW);
                aVar.f8603c = new com.ironsource.mediationsdk.server.b(jSONObject3);
                ...
                if (jSONObject3.has(IronSourceConstants.EVENTS_GENERIC_PARAMS)) {
                    aVar.f8604d = jSONObject3.optJSONObject(IronSourceConstants.EVENTS_GENERIC_PARAMS);
                }
                if (jSONObject3.has("configurations")) {
                    aVar.f8605e = jSONObject3.optJSONObject("configurations");
                }
            }
            aVar.f8602b = new ArrayList();
            ...
            while (i < jSONArray.length()) {
                ...
                if (bVar.g()) {
                    aVar.f8602b.add(bVar);
                    i++;
                } else {
                    aVar.f8606f = 1002;
                    aVar.f8607g = "waterfall " + i;
    ...
    static void a(String str, String str2, String str3) {
        com.ironsource.environment.e.c.f8074a.c(new b(str, str2, str3));
    }
    ...
    private static int b() {
        /*
            int r0 = com.ironsource.mediationsdk.C0884f.c.f8612b
        ...
        L_0x0032:
            if (r0 == 0) goto L_0x0013
        L_0x0034:
            int r0 = com.ironsource.mediationsdk.C0884f.c.f8611a
        L_0x0036:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0884f.b():int");
    }
    ...
    private JSONObject b(JSONObject jSONObject, List<String> list) {
        ...
        if (jSONObject != null) {
            ...
            while (keys.hasNext()) {
                String next = keys.next();
                try {
                    HashMap<String, String> hashMap = l.f8093b;
                    String str = hashMap.containsKey(next) ? hashMap.get(next) : next;
                    if ((list.isEmpty() && !l.f8092a.contains(str) && !str.startsWith("metadata_")) || list.contains(str)) {
    ...
    public final JSONObject a(Context context, Map<String, Object> map, List<String> list, C0887i iVar, int i, String str, com.ironsource.mediationsdk.utils.c cVar, ISBannerSize iSBannerSize, JSONObject jSONObject) {
        String str2;
        String str3;
        C0887i iVar2 = iVar;
        ...
        jSONObject7.put("deviceOS", MetricCommonTags.METRIC_COMMON_TAG_PLATFORM_ANDROID);
        ...
        jSONObject8.put("auctionData", cVar.f8896c);
    ...
    /* access modifiers changed from: package-private */
    public final JSONObject a(String str, boolean z, Map<String, Object> map, List<String> list, C0887i iVar, int i, ISBannerSize iSBannerSize, JSONObject jSONObject) {
        String str2;
        C0887i iVar2 = iVar;
        JSONObject jSONObject2 = jSONObject;
        JSONObject jSONObject3 = new JSONObject();
        ...
        JSONObject a2 = bVar.f8037b.a(bVar.f8036a);
    ...
    public final JSONObject a(JSONObject jSONObject, JSONObject jSONObject2, List<String> list) {
        ...
        a2.a(ah.c());
        a2.a(ah.b());
        JSONObject a3 = a(a2.f8562a, list.isEmpty() ? l.f8092a : list);
    ...
    public final void a(JSONObject jSONObject, boolean z) {
        if (!TextUtils.isEmpty(jSONObject.optString("tcs")) && this.f8600a.compareAndSet(false, true)) {
