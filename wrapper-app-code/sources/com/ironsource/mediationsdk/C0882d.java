...
public final class C0882d {
    ...
    private static final C0882d f8587d = new C0882d();

    /* renamed from: e  reason: collision with root package name */
    private static final Object f8588e = new Object();
    ...
    final ConcurrentHashMap<String, List<String>> f8591c = new ConcurrentHashMap<>();

    /* renamed from: f  reason: collision with root package name */
    private final ConcurrentHashMap<String, AbstractAdapter> f8592f = new ConcurrentHashMap<>();

    /* renamed from: g  reason: collision with root package name */
    private final ConcurrentHashMap<String, AdapterBaseWrapper> f8593g = new ConcurrentHashMap<>();
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8595a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8595a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0882d.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    private AdapterBaseInterface a(String str, String str2, NetworkSettings networkSettings) {
        if (!networkSettings.isCustomNetwork() || !TextUtils.isEmpty(networkSettings.getCustomNetworkPackage())) {
            ...
            try {
                ...
                this.f8593g.put(str, new AdapterBaseWrapper(baseAdapter, networkSettings));
                return baseAdapter;
    ...
    private void a(AbstractAdapter abstractAdapter) {
        try {
            if (this.f8594h != null) {
                abstractAdapter.setConsent(this.f8594h.booleanValue());
            }
        } catch (Throwable th) {
    ...
    private void a(IronSource.AD_UNIT ad_unit, JSONObject jSONObject) {
        ...
        try {
            ...
            if (!this.f8592f.isEmpty()) {
                for (AbstractAdapter next : this.f8592f.values()) {
            ...
            for (AdapterBaseWrapper next2 : this.f8593g.values()) {
    ...
    private void c(AbstractAdapter abstractAdapter) {
        for (String next : this.f8591c.keySet()) {
            try {
                List list = this.f8591c.get(next);
    ...
    public final AbstractAdapter a(NetworkSettings networkSettings) {
        ...
        return networkSettings.getProviderTypeForReflection().equalsIgnoreCase(IronSourceConstants.SUPERSONIC_CONFIG_NAME) ? this.f8592f.get(b2) : a(b2, networkSettings.getProviderTypeForReflection());
    }
    ...
    public final com.ironsource.mediationsdk.AbstractAdapter a(com.ironsource.mediationsdk.model.NetworkSettings r7, org.json.JSONObject r8, boolean r9, boolean r10) {
        ...
        L_0x000d:
            java.lang.Object r9 = f8588e
            monitor-enter(r9)
            if (r10 != 0) goto L_0x0024
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.AbstractAdapter> r1 = r6.f8592f     // Catch:{ all -> 0x0115 }
            boolean r1 = r1.containsKey(r0)     // Catch:{ all -> 0x0115 }
            if (r1 == 0) goto L_0x0024
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.AbstractAdapter> r7 = r6.f8592f     // Catch:{ all -> 0x0115 }
        ...
        L_0x00bd:
            ...
            java.lang.String r7 = r6.f8589a     // Catch:{ Exception -> 0x00e5 }
            java.lang.String r3 = r6.f8590b     // Catch:{ Exception -> 0x00e5 }
        ...
        L_0x0115:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0882d.a(com.ironsource.mediationsdk.model.NetworkSettings, org.json.JSONObject, boolean, boolean):com.ironsource.mediationsdk.AbstractAdapter");
    }

    public final AdapterBaseInterface a(NetworkSettings networkSettings, IronSource.AD_UNIT ad_unit) {
        String b2 = b(networkSettings);
        if (this.f8593g.containsKey(b2)) {
            AdapterBaseInterface adapterBaseInterface = this.f8593g.get(b2).getAdapterBaseInterface();
            if (adapterBaseInterface instanceof N) {
                ((N) adapterBaseInterface).f8266a = ad_unit;
            }
        ...
        int i2 = AnonymousClass1.f8595a[ad_unit.ordinal()];
        ...
        if (a3 != null) {
            ...
            this.f8593g.put(b2, new AdapterBaseWrapper(n, networkSettings));
            return n;
        }
    ...
    public final void a(boolean z) {
        synchronized (f8588e) {
            this.f8594h = Boolean.valueOf(z);
            for (AbstractAdapter a2 : this.f8592f.values()) {
                a(a2);
            }
            for (AdapterBaseWrapper next : this.f8593g.values()) {
    ...
    public final void b(boolean z) {
        synchronized (f8588e) {
            ...
            for (AbstractAdapter b2 : this.f8592f.values()) {
                b(b2);
            }
        }
    }
