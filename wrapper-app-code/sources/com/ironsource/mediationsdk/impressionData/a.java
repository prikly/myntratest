...
public final class a implements i {
    ...
    private String f8648b = "https://outcome-arm-ext-med-ext.sonic-us.supersonicads.com/aemData";
    ...
    public static final class C0086a implements com.ironsource.mediationsdk.server.a {
        C0086a() {
        }
    ...
    private static JSONObject a() {
        ...
        if (applicationContext != null) {
            ...
            if (ironSourceAdvId != null) {
                jSONObject.put("advId", ironSourceAdvId.f8158a);
                jSONObject.put("advIdType", ironSourceAdvId.f8159b);
            }
        }
        H a2 = H.a();
    ...
    public final void a(String str, JSONObject jSONObject) {
        ...
        try {
            ...
            HttpFunctions.sendPostRequest(this.f8648b, jSONObject2.toString(), new C0086a());
        } catch (Exception e2) {
            IronLog ironLog2 = IronLog.API;
            ironLog2.error("exception " + e2.getMessage() + " sending impression data");
            e2.printStackTrace();
        }
    }
