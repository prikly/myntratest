...
public final class c {
    ...
    public final Map<String, String> f8732a;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            return (obj instanceof c) && Intrinsics.areEqual((Object) this.f8732a, (Object) ((c) obj).f8732a);
        }
        return true;
    }

    public final int hashCode() {
        Map<String, String> map = this.f8732a;
        if (map != null) {
            return map.hashCode();
        }
        return 0;
    ...
    public final String toString() {
        return "ApplicationExternalSettings(mediationTypes=" + this.f8732a + ")";
    }
}
