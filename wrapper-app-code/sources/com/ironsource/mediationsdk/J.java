...
public final class J extends Y implements RewardedVideoSmashListener {
    ...
    public J(com.ironsource.mediationsdk.J r10, com.ironsource.mediationsdk.K r11, com.ironsource.mediationsdk.AbstractAdapter r12, int r13, java.lang.String r14, org.json.JSONObject r15, int r16, java.lang.String r17) {
        /*
            ...
            com.ironsource.mediationsdk.model.a r3 = r0.f8362d
            com.ironsource.mediationsdk.model.NetworkSettings r3 = r3.f8725a
            int r5 = r0.l
            r0 = r9
            r4 = r11
            r6 = r12
    ...
    public J(String str, String str2, NetworkSettings networkSettings, K k2, int i, AbstractAdapter abstractAdapter, int i2) {
        ...
        this.k = null;
        this.l = i;
        this.f8361c.updateRewardedVideoListener(this);
        this.f8366h = i2;
        this.f8218a = a.NO_INIT;
        this.v = 0;
        if (this.f8362d.f8727c) {
            c("initForBidding()");
    ...
    private void a(int i, Object[][] objArr, boolean z) {
        ...
        if (!TextUtils.isEmpty(this.f8219b)) {
            n2.put(IronSourceConstants.EVENTS_AUCTION_ID, this.f8219b);
        }
        ...
        if (z && (placement = this.o) != null && !TextUtils.isEmpty(placement.getPlacementName())) {
            n2.put(IronSourceConstants.EVENTS_PLACEMENT_NAME, this.o.getPlacementName());
        }
        if (b(i)) {
            h.e();
    ...
    public void a(a aVar) {
        c("current state=" + this.f8218a + ", new state=" + aVar);
        synchronized (this.t) {
            this.f8218a = aVar;
        }
    }
    ...
    public final void a(String str) {
        a aVar;
        c("loadVideo() auctionId: " + this.f8219b + " state: " + this.f8218a);
        this.i = null;
        this.f8363e = false;
        synchronized (this.t) {
            aVar = this.f8218a;
            if (!(this.f8218a == a.LOAD_IN_PROGRESS || this.f8218a == a.SHOW_IN_PROGRESS)) {
            ...
            synchronized (this.u) {
                ...
                timer.schedule(new TimerTask() {
                    public final void run() {
                        ...
                        if (J.this.f8218a == a.LOAD_IN_PROGRESS || J.this.f8218a == a.INIT_IN_PROGRESS) {
                            if (J.this.f8218a == a.LOAD_IN_PROGRESS) {
                        ...
                        J.this.b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_LOAD_FAILED_TIMEOUT)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(J.this.r())}, new Object[]{IronSourceConstants.EVENTS_EXT1, J.this.f8218a.name()}});
                    }
                }, (long) (this.l * 1000));
            }
    ...
    public final boolean b() {
        return h() ? this.f8218a == a.LOADED && f() : f();
    }
    ...
    public final LoadWhileShowSupportState c() {
        try {
            return this.f8361c.getLoadWhileShowSupportState(this.f8364f);
        } catch (Exception e2) {
    ...
    public final void onRewardedVideoAdClosed() {
        ...
        synchronized (this.t) {
            if (this.f8218a != a.SHOW_IN_PROGRESS) {
                ...
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "adClosed: " + this.f8218a}});
                return;
            }
            a(a.ENDED);
    ...
    public final void onRewardedVideoAdShowFailed(IronSourceError ironSourceError) {
        ...
        synchronized (this.t) {
            if (this.f8218a != a.SHOW_IN_PROGRESS) {
                ...
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "showFailed: " + this.f8218a}});
                return;
            }
            a(a.ENDED);
    ...
    public final void onRewardedVideoAvailabilityChanged(boolean z) {
        boolean z2;
        c("onRewardedVideoAvailabilityChanged available=" + z + " state=" + this.f8218a.name());
        synchronized (this.t) {
            if (this.f8218a == a.LOAD_IN_PROGRESS) {
        ...
        if (!z2) {
            ...
            b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_TRUE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_EXT1, this.f8218a.name()}});
        } else {
            b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_RV_LOAD_UNEXPECTED_CALLBACK)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(r())}, new Object[]{IronSourceConstants.EVENTS_EXT1, this.f8218a.name()}});
        }
    }
    ...
    public final void onRewardedVideoInitFailed(IronSourceError ironSourceError) {
        ...
        synchronized (this.t) {
            if (this.f8218a != a.INIT_IN_PROGRESS) {
                Object[] objArr = {IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceConstants.errorCode_initFailed)};
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "initFailed: " + this.f8218a}});
                return;
            }
            a(a.NO_INIT);
            this.j.b(this);
    ...
    public final void onRewardedVideoInitSuccess() {
        ...
        synchronized (this.t) {
            if (this.f8218a != a.INIT_IN_PROGRESS) {
                ...
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "initSuccess: " + this.f8218a}});
                return;
            }
            a(a.NOT_LOADED);
        }
