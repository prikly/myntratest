...
final class ab extends C0879a implements j, C0881c, l, d {
    i m;
    boolean n = false;
    int o;
    C0902x p;
    ...
    private List<C0880b.a> v = Arrays.asList(new C0880b.a[]{C0880b.a.INIT_FAILED, C0880b.a.CAPPED_PER_SESSION, C0880b.a.EXHAUSTED, C0880b.a.CAPPED_PER_DAY});
    private boolean w = false;
    private long x = new Date().getTime();
    private boolean y = false;

    ab() {
        this.f8385a = new e("rewarded_video", this);
    }
    ...
    private void a(int i, C0880b bVar, Object[][] objArr) {
        ...
        if (objArr != null) {
            try {
                ...
                this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "RewardedVideoManager logProviderEvent " + Log.getStackTraceString(e2), 3);
            }
        }
    ...
    private void a(int i, Object[][] objArr) {
        ...
        if (objArr != null) {
            try {
                ...
                this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "RewardedVideoManager logMediationEvent " + Log.getStackTraceString(e2), 3);
            }
        }
        h.e().b(new c(i, mediationAdditionalData));
    }

    private synchronized void a(C0880b bVar, int i) {
        Object[][] objArr;
        ...
        if (k.c((Context) ContextProvider.getInstance().getCurrentActiveActivity(), p())) {
            a((int) IronSourceConstants.RV_CAP_PLACEMENT, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}});
        }
        this.f8385a.a(bVar);
        if (this.t != null) {
            if (this.n) {
                ...
                int i2 = 0;
                while (i2 < i && i2 < this.f8387c.size()) {
                    if (!this.v.contains(((C0880b) this.f8387c.get(i2)).f8564a)) {
                        a(((ac) this.f8387c.get(i2)).v, false, placementId);
                    }
                    i2++;
                }
            }
            String p2 = p();
            a((int) IronSourceConstants.RV_INSTANCE_SHOW_CHANCE, bVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p2}, new Object[]{"status", "true"}});
            int i3 = 0;
            while (i3 < this.f8387c.size() && i3 < i) {
                C0880b bVar2 = (C0880b) this.f8387c.get(i3);
                if (bVar2.f8564a == C0880b.a.NOT_AVAILABLE || bVar2.f8564a == C0880b.a.NEEDS_RELOAD) {
                    a((int) IronSourceConstants.RV_INSTANCE_SHOW_CHANCE, bVar2, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p2}, new Object[]{"status", "false"}});
                }
                i3++;
            }
        } else {
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "mCurrentPlacement is null", 3);
        }
        if (this.t != null) {
            objArr = new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}};
        } else {
            objArr = null;
        }
        ...
        ((ac) bVar).w = o.a().b(1);
        ac acVar = (ac) bVar;
        if (acVar.f8565b != null) {
            IronSourceLoggerManager ironSourceLoggerManager = acVar.q;
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
            ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":showRewardedVideo()", 1);
            acVar.d();
            acVar.f8565b.showRewardedVideo(acVar.r, acVar);
        }
    }
    ...
    private synchronized void a(String str, boolean z, int i) {
        ...
        try {
            ...
            Thread thread = new Thread(new Runnable(str2, z, i) {
                ...
                private /* synthetic */ boolean f8882b;

                /* renamed from: c  reason: collision with root package name */
                private /* synthetic */ int f8883c;
                ...
                public final void run() {
                    ...
                    try {
                        new JSONObject(HttpFunctions.getStringFromURL(ServerURL.getRequestURL(str, z, this.f8883c)));
            ...
            this.f8392h.logException(IronSourceLogger.IronSourceTag.NETWORK, "reportImpression:(providerURL:" + str2 + ", hit:" + z + ")", th);
        }
    }
    ...
    private synchronized void a(java.util.Map<java.lang.String, java.lang.Object> r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            com.ironsource.mediationsdk.b r0 = r2.f8388d     // Catch:{ all -> 0x004a }
            r1 = 1
            if (r0 == 0) goto L_0x0023
            boolean r0 = r2.k     // Catch:{ all -> 0x004a }
            if (r0 != 0) goto L_0x0023
            r2.k = r1     // Catch:{ all -> 0x004a }
            com.ironsource.mediationsdk.b r3 = r2.f8388d     // Catch:{ all -> 0x004a }
    ...
    private AbstractAdapter f() {
        ...
        int i = 0;
        for (int i2 = 0; i2 < this.f8387c.size() && abstractAdapter == null; i2++) {
            if (((C0880b) this.f8387c.get(i2)).f8564a == C0880b.a.AVAILABLE || ((C0880b) this.f8387c.get(i2)).f8564a == C0880b.a.INITIATED) {
                i++;
                if (i >= this.f8386b) {
                    break;
                }
            } else if (((C0880b) this.f8387c.get(i2)).f8564a == C0880b.a.NOT_INITIATED && (abstractAdapter = h((ac) this.f8387c.get(i2))) == null) {
                ((C0880b) this.f8387c.get(i2)).a(C0880b.a.INIT_FAILED);
            }
        }
    ...
    private synchronized com.ironsource.mediationsdk.AbstractAdapter h(com.ironsource.mediationsdk.ac r10) {
        /*
            r9 = this;
            monitor-enter(r9)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r9.f8392h     // Catch:{ all -> 0x00d7 }
            ...
            r2.append(r3)     // Catch:{ all -> 0x00d7 }
            java.lang.String r3 = r10.f8567d     // Catch:{ all -> 0x00d7 }
            r2.append(r3)     // Catch:{ all -> 0x00d7 }
            java.lang.String r3 = ")"
            r2.append(r3)     // Catch:{ all -> 0x00d7 }
            ...
            com.ironsource.mediationsdk.d r0 = com.ironsource.mediationsdk.C0882d.a()     // Catch:{ all -> 0x00d7 }
            com.ironsource.mediationsdk.model.NetworkSettings r1 = r10.f8566c     // Catch:{ all -> 0x00d7 }
            com.ironsource.mediationsdk.model.NetworkSettings r2 = r10.f8566c     // Catch:{ all -> 0x00d7 }
            ...
            java.lang.String r10 = r10.f8567d     // Catch:{ all -> 0x00d7 }
            ...
            return r1
        L_0x0057:
            r10.f8565b = r0     // Catch:{ all -> 0x00d7 }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0880b.a.INITIATED     // Catch:{ all -> 0x00d7 }
            r10.a(r2)     // Catch:{ all -> 0x00d7 }
            r9.b(r10)     // Catch:{ all -> 0x00d7 }
            r2 = 1001(0x3e9, float:1.403E-42)
            r9.a((int) r2, (com.ironsource.mediationsdk.C0880b) r10, (java.lang.Object[][]) r1)     // Catch:{ all -> 0x00d7 }
            java.lang.String r2 = r9.f8391g     // Catch:{ all -> 0x00a9 }
            java.lang.String r4 = r9.f8390f     // Catch:{ all -> 0x00a9 }
            r10.h()     // Catch:{ all -> 0x00a9 }
            com.ironsource.mediationsdk.AbstractAdapter r5 = r10.f8565b     // Catch:{ all -> 0x00a9 }
            ...
            java.lang.String r8 = r10.f8567d     // Catch:{ all -> 0x00a9 }
            ...
            com.ironsource.mediationsdk.AbstractAdapter r3 = r10.f8565b     // Catch:{ all -> 0x00a9 }
        ...
        L_0x00a9:
            r0 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r2 = r9.f8392h     // Catch:{ all -> 0x00d7 }
            ...
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0880b.a.INIT_FAILED     // Catch:{ all -> 0x00d7 }
    ...
    private synchronized boolean h() {
        int i;
        Iterator it = this.f8387c.iterator();
        i = 0;
        while (it.hasNext()) {
            C0880b bVar = (C0880b) it.next();
            if (bVar.f8564a == C0880b.a.INIT_FAILED || bVar.f8564a == C0880b.a.CAPPED_PER_DAY || bVar.f8564a == C0880b.a.CAPPED_PER_SESSION || bVar.f8564a == C0880b.a.NOT_AVAILABLE || bVar.f8564a == C0880b.a.NEEDS_RELOAD || bVar.f8564a == C0880b.a.EXHAUSTED) {
                i++;
            }
        }
        return this.f8387c.size() == i;
    }
    ...
    private synchronized boolean i() {
        /*
            r4 = this;
            monitor-enter(r4)
            java.util.concurrent.CopyOnWriteArrayList r0 = r4.f8387c     // Catch:{ all -> 0x003c }
        ...
        L_0x0007:
            ...
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0880b) r1     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.NOT_AVAILABLE     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.NEEDS_RELOAD     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.AVAILABLE     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.INITIATED     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.INIT_PENDING     // Catch:{ all -> 0x003c }
            if (r2 == r3) goto L_0x0037
            com.ironsource.mediationsdk.b$a r1 = r1.f8564a     // Catch:{ all -> 0x003c }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0880b.a.LOAD_PENDING     // Catch:{ all -> 0x003c }
    ...
    private synchronized boolean j() {
        ...
        while (true) {
            if (it.hasNext()) {
                if (((C0880b) it.next()).f8564a == C0880b.a.AVAILABLE) {
                    z = true;
                    break;
                }
            } else {
    ...
    private synchronized void l() {
        ...
        L_0x0009:
            r0 = 4
            com.ironsource.mediationsdk.b$a[] r1 = new com.ironsource.mediationsdk.C0880b.a[r0]     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0880b.a.NOT_AVAILABLE     // Catch:{ all -> 0x005a }
            r3 = 0
            r1[r3] = r2     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0880b.a.NEEDS_RELOAD     // Catch:{ all -> 0x005a }
            r4 = 1
            r1[r4] = r2     // Catch:{ all -> 0x005a }
            r2 = 2
            com.ironsource.mediationsdk.b$a r4 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x005a }
            r1[r2] = r4     // Catch:{ all -> 0x005a }
            r2 = 3
            com.ironsource.mediationsdk.b$a r4 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x005a }
            r1[r2] = r4     // Catch:{ all -> 0x005a }
            java.util.concurrent.CopyOnWriteArrayList r2 = r9.f8387c     // Catch:{ all -> 0x005a }
        ...
        L_0x0027:
            ...
            com.ironsource.mediationsdk.b r5 = (com.ironsource.mediationsdk.C0880b) r5     // Catch:{ all -> 0x005a }
            r6 = 0
        L_0x0034:
            if (r6 >= r0) goto L_0x0027
            r7 = r1[r6]     // Catch:{ all -> 0x005a }
            com.ironsource.mediationsdk.b$a r8 = r5.f8564a     // Catch:{ all -> 0x005a }
        ...
        L_0x003e:
            ...
            goto L_0x0034
        L_0x0041:
            java.util.concurrent.CopyOnWriteArrayList r0 = r9.f8387c     // Catch:{ all -> 0x005a }
    ...
    private synchronized void m() {
        if (n()) {
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "Reset Iteration", 0);
            Iterator it = this.f8387c.iterator();
            boolean z = false;
            while (it.hasNext()) {
                C0880b bVar = (C0880b) it.next();
                if (bVar.f8564a == C0880b.a.EXHAUSTED) {
                    bVar.g();
                }
                if (bVar.f8564a == C0880b.a.AVAILABLE) {
                    z = true;
                }
            }
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "End of Reset Iteration", 0);
            if (a(z, false)) {
    ...
    private synchronized boolean n() {
        /*
            r4 = this;
            monitor-enter(r4)
            java.util.concurrent.CopyOnWriteArrayList r0 = r4.f8387c     // Catch:{ all -> 0x002a }
        ...
        L_0x0007:
            ...
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0880b) r1     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.NOT_INITIATED     // Catch:{ all -> 0x002a }
            if (r2 == r3) goto L_0x0025
            com.ironsource.mediationsdk.b$a r2 = r1.f8564a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r3 = com.ironsource.mediationsdk.C0880b.a.INITIATED     // Catch:{ all -> 0x002a }
            if (r2 == r3) goto L_0x0025
            com.ironsource.mediationsdk.b$a r1 = r1.f8564a     // Catch:{ all -> 0x002a }
            com.ironsource.mediationsdk.b$a r2 = com.ironsource.mediationsdk.C0880b.a.AVAILABLE     // Catch:{ all -> 0x002a }
            if (r1 != r2) goto L_0x0007
        L_0x0025:
            r0 = 0
        L_0x0026:
    ...
    private void o() {
        for (int i = 0; i < this.f8387c.size(); i++) {
            String providerTypeForReflection = ((C0880b) this.f8387c.get(i)).f8566c.getProviderTypeForReflection();
            if (providerTypeForReflection.equalsIgnoreCase(IronSourceConstants.IRONSOURCE_CONFIG_NAME) || providerTypeForReflection.equalsIgnoreCase(IronSourceConstants.SUPERSONIC_CONFIG_NAME)) {
                C0882d.a().a(((C0880b) this.f8387c.get(i)).f8566c, ((C0880b) this.f8387c.get(i)).f8566c.getRewardedVideoSettings(), false, false);
                return;
            }
        }
    }
    ...
    private void q() {
        ...
        while (it.hasNext()) {
            C0880b bVar = (C0880b) it.next();
            if (bVar.f8564a == C0880b.a.AVAILABLE && bVar.l() != null && bVar.l().longValue() < j) {
                j = bVar.l().longValue();
            }
        }
        if (j != Long.MAX_VALUE) {
    ...
    public final void a(Context context, boolean z) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
    ...
    public final void a(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdOpened()", 1);
        a(1005, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(acVar.w)}});
    ...
    public final void a(IronSourceError ironSourceError, ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdShowFailed(" + ironSourceError + ")", 1);
        this.y = false;
        int i = acVar.w;
        a((int) IronSourceConstants.RV_INSTANCE_SHOW_FAILED, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(ironSourceError.getErrorCode())}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, ironSourceError.getErrorMessage()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(i)}});
        b(false);
    ...
    public final void a(Placement placement) {
        this.t = placement;
        this.m.f8831f = placement.getPlacementName();
    }
    ...
    public final synchronized void a(java.lang.String r10) {
        /*
            r9 = this;
            monitor-enter(r9)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r9.f8392h     // Catch:{ all -> 0x01a1 }
            ...
            r0.f8831f = r10     // Catch:{ all -> 0x01a1 }
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r9.f8392h     // Catch:{ all -> 0x01a1 }
        ...
        L_0x007f:
            ...
            r0 = 0
        L_0x0085:
            java.util.concurrent.CopyOnWriteArrayList r1 = r9.f8387c     // Catch:{ all -> 0x01a1 }
            int r1 = r1.size()     // Catch:{ all -> 0x01a1 }
            if (r0 >= r1) goto L_0x0173
            java.util.concurrent.CopyOnWriteArrayList r1 = r9.f8387c     // Catch:{ all -> 0x01a1 }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ all -> 0x01a1 }
            com.ironsource.mediationsdk.b r1 = (com.ironsource.mediationsdk.C0880b) r1     // Catch:{ all -> 0x01a1 }
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r4 = r9.f8392h     // Catch:{ all -> 0x01a1 }
            ...
            java.lang.String r8 = r1.f8567d     // Catch:{ all -> 0x01a1 }
            r7.append(r8)     // Catch:{ all -> 0x01a1 }
            java.lang.String r8 = ", Status: "
            r7.append(r8)     // Catch:{ all -> 0x01a1 }
            com.ironsource.mediationsdk.b$a r8 = r1.f8564a     // Catch:{ all -> 0x01a1 }
            r7.append(r8)     // Catch:{ all -> 0x01a1 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x01a1 }
            r4.log(r5, r7, r6)     // Catch:{ all -> 0x01a1 }
            com.ironsource.mediationsdk.b$a r4 = r1.f8564a     // Catch:{ all -> 0x01a1 }
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0880b.a.AVAILABLE     // Catch:{ all -> 0x01a1 }
            ...
            r9.a((com.ironsource.mediationsdk.C0880b) r1, (int) r0)     // Catch:{ all -> 0x01a1 }
            boolean r10 = r9.l     // Catch:{ all -> 0x01a1 }
            if (r10 == 0) goto L_0x00d7
            com.ironsource.mediationsdk.b r10 = r9.f8389e     // Catch:{ all -> 0x01a1 }
        ...
        L_0x00d7:
            ...
            com.ironsource.mediationsdk.b$a r10 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x01a1 }
            r1.a(r10)     // Catch:{ all -> 0x01a1 }
            r10 = 1401(0x579, float:1.963E-42)
            r0 = 0
            r9.a((int) r10, (com.ironsource.mediationsdk.C0880b) r1, (java.lang.Object[][]) r0)     // Catch:{ all -> 0x01a1 }
            r9.l()     // Catch:{ all -> 0x01a1 }
            monitor-exit(r9)
            return
        L_0x00ed:
            com.ironsource.mediationsdk.utils.e r10 = r9.f8385a     // Catch:{ all -> 0x01a1 }
            boolean r10 = r10.c((com.ironsource.mediationsdk.C0880b) r1)     // Catch:{ all -> 0x01a1 }
            if (r10 == 0) goto L_0x0112
            com.ironsource.mediationsdk.b$a r10 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x01a1 }
            r1.a(r10)     // Catch:{ all -> 0x01a1 }
        ...
        L_0x0120:
            ...
            java.lang.String r5 = r1.f8567d     // Catch:{ all -> 0x01a1 }
        ...
        L_0x0148:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r5 = r9.f8392h     // Catch:{ all -> 0x01a1 }
            ...
            java.lang.String r1 = r1.f8567d     // Catch:{ all -> 0x01a1 }
        ...
        L_0x0173:
            ...
            com.ironsource.mediationsdk.b r10 = r9.f8388d     // Catch:{ all -> 0x01a1 }
            java.util.concurrent.CopyOnWriteArrayList r0 = r9.f8387c     // Catch:{ all -> 0x01a1 }
            int r0 = r0.size()     // Catch:{ all -> 0x01a1 }
            r9.a((com.ironsource.mediationsdk.C0880b) r10, (int) r0)     // Catch:{ all -> 0x01a1 }
            monitor-exit(r9)
            return
        L_0x0186:
    ...
    public final synchronized void a(java.lang.String r10, java.lang.String r11) {
        /*
            r9 = this;
            monitor-enter(r9)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r9.f8392h     // Catch:{ all -> 0x00df }
            ...
            r9.f8391g = r10     // Catch:{ all -> 0x00df }
            r9.f8390f = r11     // Catch:{ all -> 0x00df }
            java.util.concurrent.CopyOnWriteArrayList r10 = r9.f8387c     // Catch:{ all -> 0x00df }
        ...
        L_0x0047:
            ...
            com.ironsource.mediationsdk.b r4 = (com.ironsource.mediationsdk.C0880b) r4     // Catch:{ all -> 0x00df }
            com.ironsource.mediationsdk.utils.e r6 = r9.f8385a     // Catch:{ all -> 0x00df }
            boolean r6 = r6.b((com.ironsource.mediationsdk.C0880b) r4)     // Catch:{ all -> 0x00df }
            ...
            r9.a((int) r6, (com.ironsource.mediationsdk.C0880b) r4, (java.lang.Object[][]) r7)     // Catch:{ all -> 0x00df }
        L_0x006f:
            com.ironsource.mediationsdk.utils.e r5 = r9.f8385a     // Catch:{ all -> 0x00df }
            boolean r5 = r5.c((com.ironsource.mediationsdk.C0880b) r4)     // Catch:{ all -> 0x00df }
            if (r5 == 0) goto L_0x0047
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_DAY     // Catch:{ all -> 0x00df }
        ...
        L_0x008e:
            ...
            com.ironsource.mediationsdk.sdk.i r10 = r9.m     // Catch:{ all -> 0x00df }
            r2 = 0
            r10.f8831f = r2     // Catch:{ all -> 0x00df }
        ...
        L_0x00c8:
            int r10 = r9.f8386b     // Catch:{ all -> 0x00df }
    ...
    public final synchronized void a(boolean r9, com.ironsource.mediationsdk.ac r10) {
        /*
            r8 = this;
            monitor-enter(r8)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r8.f8392h     // Catch:{ all -> 0x0117 }
            ...
            java.lang.String r3 = r10.f8567d     // Catch:{ all -> 0x0117 }
        ...
        L_0x0058:
            com.ironsource.mediationsdk.b r1 = r8.f8388d     // Catch:{ all -> 0x00ee }
        ...
        L_0x0071:
            ...
            return
        L_0x0073:
            com.ironsource.mediationsdk.b r1 = r8.f8389e     // Catch:{ all -> 0x00ee }
            boolean r1 = r10.equals(r1)     // Catch:{ all -> 0x00ee }
            if (r1 == 0) goto L_0x00ba
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r8.f8392h     // Catch:{ all -> 0x00ee }
            ...
            java.lang.String r5 = r10.f8567d     // Catch:{ all -> 0x00ee }
            ...
            if (r1 != 0) goto L_0x00ba
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0880b.a.CAPPED_PER_SESSION     // Catch:{ all -> 0x00ee }
        ...
        L_0x00b8:
            ...
            return
        L_0x00ba:
            com.ironsource.mediationsdk.utils.e r1 = r8.f8385a     // Catch:{ all -> 0x00ee }
            boolean r1 = r1.c((com.ironsource.mediationsdk.C0880b) r10)     // Catch:{ all -> 0x00ee }
        ...
        L_0x00ee:
            r0 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r8.f8392h     // Catch:{ all -> 0x0117 }
    ...
    public final synchronized void b() {
        ...
        while (it.hasNext()) {
            C0880b bVar = (C0880b) it.next();
            if (bVar.equals(this.f8389e)) {
                bVar.a(C0880b.a.CAPPED_PER_SESSION);
                f();
                return;
            }
        }
    ...
    public final void b(ac acVar) {
        String str;
        this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, acVar.f8567d + ":onRewardedVideoAdClosed()", 1);
        this.y = false;
        ...
        try {
            ...
            while (it.hasNext()) {
                C0880b bVar = (C0880b) it.next();
                if (((ac) bVar).o()) {
                    sb.append(bVar.f8567d + ";");
                }
            }
        } catch (Throwable unused) {
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "Failed to check RV availability", 0);
        }
        ...
        a((int) IronSourceConstants.RV_INSTANCE_CLOSED, (C0880b) acVar, objArr);
        o.a().a(1);
        if (!acVar.b() && !this.f8385a.c((C0880b) acVar)) {
            a(1001, (C0880b) acVar, (Object[][]) null);
        }
        b(false);
        this.m.onRewardedVideoAdClosed();
        q();
        Iterator it2 = this.f8387c.iterator();
        while (it2.hasNext()) {
            C0880b bVar2 = (C0880b) it2.next();
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "Fetch on ad closed, iterating on: " + bVar2.f8567d + ", Status: " + bVar2.f8564a, 0);
            if (bVar2.f8564a == C0880b.a.NOT_AVAILABLE || bVar2.f8564a == C0880b.a.NEEDS_RELOAD) {
                try {
                    if (!bVar2.f8567d.equals(acVar.f8567d)) {
                        this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, bVar2.f8567d + ":reload smash", 1);
                        ((ac) bVar2).n();
                        a(1001, bVar2, (Object[][]) null);
                    }
                } catch (Throwable th) {
                    this.f8392h.log(IronSourceLogger.IronSourceTag.NATIVE, bVar2.f8567d + " Failed to call fetchVideo(), " + th.getLocalizedMessage(), 1);
                }
            }
        }
    }
    ...
    public final void c(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdStarted()", 1);
        a((int) IronSourceConstants.RV_INSTANCE_STARTED, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(acVar.w)}});
    ...
    public final void c_() {
        ...
        while (it.hasNext()) {
            C0880b bVar = (C0880b) it.next();
            if (bVar.f8564a == C0880b.a.AVAILABLE || bVar.f8564a == C0880b.a.NOT_AVAILABLE) {
                bVar.a(C0880b.a.NEEDS_RELOAD);
            }
        }
        Iterator it2 = this.f8387c.iterator();
        while (it2.hasNext()) {
            C0880b bVar2 = (C0880b) it2.next();
            if (bVar2.f8564a == C0880b.a.NEEDS_RELOAD) {
                try {
                    IronLog ironLog = IronLog.INTERNAL;
                    ironLog.info(bVar2.f8567d + ":reload smash");
                    a(1001, bVar2, (Object[][]) null);
                    ((ac) bVar2).n();
                } catch (Throwable th) {
                    IronLog ironLog2 = IronLog.INTERNAL;
                    ironLog2.error(bVar2.f8567d + " Failed to call fetchVideo(), " + th.getLocalizedMessage());
                }
            }
        }
    }
    ...
    public void d() {
        if (this.o <= 0) {
            this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "load interval is not set, ignoring", 1);
            return;
        }
        Timer timer = this.u;
        if (timer != null) {
    ...
    public final void d(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdEnded()", 1);
        a((int) IronSourceConstants.RV_INSTANCE_ENDED, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(acVar.w)}});
    ...
    public synchronized void e() {
        ...
        L_0x0015:
            ...
            java.util.concurrent.CopyOnWriteArrayList r2 = r8.f8387c     // Catch:{ all -> 0x0092 }
        ...
        L_0x0031:
            ...
            com.ironsource.mediationsdk.b r3 = (com.ironsource.mediationsdk.C0880b) r3     // Catch:{ all -> 0x0092 }
            com.ironsource.mediationsdk.b$a r4 = r3.f8564a     // Catch:{ all -> 0x0092 }
            com.ironsource.mediationsdk.b$a r5 = com.ironsource.mediationsdk.C0880b.a.NOT_AVAILABLE     // Catch:{ all -> 0x0092 }
            if (r4 != r5) goto L_0x0031
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r4 = r8.f8392h     // Catch:{ all -> 0x006b }
            ...
            java.lang.String r7 = r3.f8567d     // Catch:{ all -> 0x006b }
            ...
            r8.a((int) r4, (com.ironsource.mediationsdk.C0880b) r3, (java.lang.Object[][]) r1)     // Catch:{ all -> 0x006b }
            r4 = r3
        ...
        L_0x006b:
            r4 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r5 = r8.f8392h     // Catch:{ all -> 0x0092 }
            ...
            java.lang.String r3 = r3.f8567d     // Catch:{ all -> 0x0092 }
    ...
    public final void e(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdRewarded()", 1);
        if (this.t == null) {
            this.t = H.a().i.f8939c.f8744a.a();
        }
        JSONObject providerAdditionalData = IronSourceUtils.getProviderAdditionalData((C0880b) acVar);
        try {
    ...
    public final void f(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdClicked()", 1);
        if (this.t == null) {
            this.t = H.a().i.f8939c.f8744a.a();
        }
        if (this.t == null) {
        ...
        a(1006, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(acVar.w)}});
    ...
    public final void g(ac acVar) {
        IronSourceLoggerManager ironSourceLoggerManager = this.f8392h;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, acVar.f8567d + ":onRewardedVideoAdVisible()", 1);
        if (this.t != null) {
            a((int) IronSourceConstants.RV_INSTANCE_VISIBLE, (C0880b) acVar, new Object[][]{new Object[]{IronSourceConstants.EVENTS_PLACEMENT_NAME, p()}, new Object[]{IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(acVar.w)}});
            return;
        }
        this.f8392h.log(IronSourceLogger.IronSourceTag.INTERNAL, "mCurrentPlacement is null", 3);
    }
