...
public final class C0886h {
    ...
    private final String f8615b = "1";

    /* renamed from: c  reason: collision with root package name */
    private final String f8616c = "102";

    /* renamed from: d  reason: collision with root package name */
    private final String f8617d = "103";

    /* renamed from: e  reason: collision with root package name */
    private final String f8618e = "102";

    /* renamed from: f  reason: collision with root package name */
    private final String f8619f = "GenericNotifications";
    ...
    static class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<C0885g> f8622a;
        ...
        /* renamed from: e  reason: collision with root package name */
        private List<b> f8626e;

        /* renamed from: f  reason: collision with root package name */
        private b f8627f;

        /* renamed from: g  reason: collision with root package name */
        private JSONObject f8628g;

        /* renamed from: h  reason: collision with root package name */
        private JSONObject f8629h;
        private long i;
        private int j;
        ...
        a(C0885g gVar, URL url, JSONObject jSONObject, boolean z, int i2, long j2, boolean z2, boolean z3, int i3) {
            this.f8622a = new WeakReference<>(gVar);
            this.o = url;
            this.p = jSONObject;
            this.q = z;
            this.r = i2;
        ...
        private boolean a() {
            /*
                ...
                r1.i = r5
                r5 = 0
                int r0 = r1.n     // Catch:{ Exception -> 0x0252 }
                ...
                goto L_0x001f
            L_0x001d:
                int r0 = r1.v     // Catch:{ Exception -> 0x0252 }
            L_0x001f:
                r1.l = r0     // Catch:{ Exception -> 0x0252 }
                r1.j = r5
                r0 = 0
                r8 = r0
            L_0x0025:
                ...
                int r11 = r1.j     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                int r11 = r11 + r7
                r0.append(r11)     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                java.lang.String r11 = " out of "
                r0.append(r11)     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                int r11 = r1.r     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                r0.append(r11)     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                ...
                java.net.URL r0 = r1.o     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                long r11 = r1.s     // Catch:{ SocketTimeoutException -> 0x0231, Exception -> 0x020a }
                ...
                org.json.JSONObject r8 = r1.p     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                boolean r12 = r1.t     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                ...
                int r0 = r1.l     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                r5 = 2
            ...
            L_0x00a5:
                ...
                r1.m = r0     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                r1.n = r6     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                r1.l = r7     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            L_0x00b0:
                java.lang.String r0 = r8.toString()     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                java.lang.String r8 = r17.b()     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            ...
            L_0x00ca:
                int r6 = r1.l     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            ...
            L_0x00e7:
                ...
                r1.f8623b = r5     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                ...
                r1.f8624c = r0     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                ...
                java.lang.String r5 = r1.f8624c     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                ...
                int r0 = r1.j     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                int r5 = r1.r     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                int r5 = r5 - r7
                if (r0 >= r5) goto L_0x0139
                long r5 = r1.s     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            ...
            L_0x0139:
                ...
                goto L_0x023f
            L_0x013c:
                java.lang.String r0 = a(r11)     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            ...
            L_0x018e:
                ...
                throw r0     // Catch:{ JSONException -> 0x01c3 }
            L_0x0194:
                com.ironsource.mediationsdk.C0884f.a()     // Catch:{ JSONException -> 0x01c3 }
                com.ironsource.mediationsdk.f$a r0 = com.ironsource.mediationsdk.C0884f.a((org.json.JSONObject) r9)     // Catch:{ JSONException -> 0x01c3 }
                java.lang.String r5 = r0.f8601a     // Catch:{ JSONException -> 0x01c3 }
                r1.f8625d = r5     // Catch:{ JSONException -> 0x01c3 }
                java.util.List<com.ironsource.mediationsdk.server.b> r5 = r0.f8602b     // Catch:{ JSONException -> 0x01c3 }
                r1.f8626e = r5     // Catch:{ JSONException -> 0x01c3 }
                com.ironsource.mediationsdk.server.b r5 = r0.f8603c     // Catch:{ JSONException -> 0x01c3 }
                r1.f8627f = r5     // Catch:{ JSONException -> 0x01c3 }
                org.json.JSONObject r5 = r0.f8604d     // Catch:{ JSONException -> 0x01c3 }
                r1.f8628g = r5     // Catch:{ JSONException -> 0x01c3 }
                org.json.JSONObject r5 = r0.f8605e     // Catch:{ JSONException -> 0x01c3 }
                r1.f8629h = r5     // Catch:{ JSONException -> 0x01c3 }
                int r5 = r0.f8606f     // Catch:{ JSONException -> 0x01c3 }
                r1.f8623b = r5     // Catch:{ JSONException -> 0x01c3 }
                java.lang.String r0 = r0.f8607g     // Catch:{ JSONException -> 0x01c3 }
                r1.f8624c = r0     // Catch:{ JSONException -> 0x01c3 }
                r11.disconnect()     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                return r7
            L_0x01bb:
                org.json.JSONException r0 = new org.json.JSONException     // Catch:{ JSONException -> 0x01c3 }
            ...
            L_0x01c3:
                ...
                r1.f8624c = r5     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            L_0x01dc:
                java.lang.String r5 = r0.getMessage()     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                ...
                r1.f8623b = r0     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
            ...
            L_0x01fc:
                ...
                r1.k = r0     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                r11.disconnect()     // Catch:{ SocketTimeoutException -> 0x0208, Exception -> 0x0205 }
                r2 = 0
                return r2
            L_0x0205:
            ...
            L_0x0252:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.C0886h.a.a():boolean");
        }
        ...
        public final void run() {
            boolean a2 = a();
            C0885g gVar = (C0885g) this.f8622a.get();
            if (gVar != null) {
                long time = new Date().getTime() - this.i;
                if (a2) {
                    gVar.a(this.f8626e, this.f8625d, this.f8627f, this.f8628g, this.f8629h, this.j + 1, time, this.n, this.m);
                } else {
                    gVar.a(this.f8623b, this.f8624c, this.j + 1, this.k, time);
                }
            }
        }
    }

    public C0886h(String str, c cVar, C0885g gVar) {
        this.f8620g = str;
        this.i = cVar;
        this.j = gVar;
        this.f8621h = IronSourceUtils.getSessionId();
    }

    private JSONObject a(Context context, Map<String, Object> map, List<String> list, C0887i iVar, int i2, boolean z, IronSourceSegment ironSourceSegment) {
        new JSONObject();
        p c2 = H.a().i.f8939c.f8748e.c();
        JSONObject a2 = a(ironSourceSegment);
        boolean z2 = c2.f8963d;
        C0884f a3 = C0884f.a();
        if (z2) {
            return a3.a(this.f8620g, z, map, list, iVar, i2, this.f8614a, a2);
        }
        JSONObject a4 = a3.a(context, map, list, iVar, i2, this.f8621h, this.i, this.f8614a, a2);
        a4.put("adUnit", this.f8620g);
    ...
    public static void a(b bVar, int i2, b bVar2) {
        for (String a2 : bVar.f()) {
            String a3 = C0884f.a().a(a2, i2, bVar, "", "", "");
            C0884f.a();
            C0884f.a("reportLoadSuccess", bVar.a(), a3);
        }
        if (bVar2 != null) {
            for (String a4 : bVar2.f()) {
                String a5 = C0884f.a().a(a4, i2, bVar, "", "102", "");
                C0884f.a();
                C0884f.a("reportLoadSuccess", "GenericNotifications", a5);
            }
        }
    }
    ...
    public static void a(b bVar, int i2, b bVar2, String str) {
        for (String a2 : bVar.d()) {
            String a3 = C0884f.a().a(a2, i2, bVar, "", "", str);
            C0884f.a();
            C0884f.a("reportImpression", bVar.a(), a3);
        }
        if (bVar2 != null) {
            for (String a4 : bVar2.d()) {
                String a5 = C0884f.a().a(a4, i2, bVar, "", "102", str);
                C0884f.a();
                C0884f.a("reportImpression", "GenericNotifications", a5);
            }
        }
    }
    ...
    public static void a(ArrayList<String> arrayList, ConcurrentHashMap<String, b> concurrentHashMap, int i2, b bVar, b bVar2) {
        ...
        while (it.hasNext()) {
            ...
            if (next.equals(bVar2.a())) {
                ...
                for (String a2 : bVar3.e()) {
                    String a3 = C0884f.a().a(a2, i2, bVar2, c2, str, "");
                    C0884f.a();
                    C0884f.a("reportAuctionLose", bVar3.a(), a3);
                }
            }
        }
        int i4 = i2;
        if (bVar != null) {
            for (String a4 : bVar.e()) {
                String a5 = C0884f.a().a(a4, i2, bVar2, "", "102", "");
                C0884f.a();
                C0884f.a("reportAuctionLose", "GenericNotifications", a5);
            }
        }
    }

    public final void a(Context context, Map<String, Object> map, List<String> list, C0887i iVar, int i2, IronSourceSegment ironSourceSegment) {
        try {
            boolean z = IronSourceUtils.getSerr() == 1;
            com.ironsource.environment.e.c.f8074a.c(new a(this.j, new URL(this.i.f8897d), a(context, map, list, iVar, i2, z, ironSourceSegment), z, this.i.f8898e, this.i.f8901h, this.i.p, this.i.q, this.i.r));
        } catch (Exception e2) {
