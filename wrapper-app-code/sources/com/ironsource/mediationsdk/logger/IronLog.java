...
public enum IronLog {
    ...
    private IronSourceLogger.IronSourceTag f8689a;

    private IronLog(IronSourceLogger.IronSourceTag ironSourceTag) {
        this.f8689a = ironSourceTag;
    }
    ...
    public final void error(String str) {
        IronSourceLoggerManager.getLogger().log(this.f8689a, a(str), 3);
    }

    public final void info(String str) {
        IronSourceLoggerManager.getLogger().log(this.f8689a, a(str), 1);
    }

    public final void verbose(String str) {
        IronSourceLoggerManager.getLogger().log(this.f8689a, a(str), 0);
    }

    public final void warning(String str) {
        IronSourceLoggerManager.getLogger().log(this.f8689a, a(str), 2);
    }
}
