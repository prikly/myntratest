...
public final class H implements i {
    ...
    IronSourceLoggerManager f8165f;

    /* renamed from: g  reason: collision with root package name */
    com.ironsource.mediationsdk.sdk.i f8166g;

    /* renamed from: h  reason: collision with root package name */
    com.ironsource.mediationsdk.logger.b f8167h;
    l i;
    public String j;
    public String k;
    String l;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                f8169b = r0
                r1 = 1
                int r2 = com.ironsource.mediationsdk.utils.k.a.f8932a     // Catch:{ NoSuchFieldError -> 0x000f }
                r2 = 0
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x000f }
            L_0x000f:
                r0 = 2
                int[] r2 = f8169b     // Catch:{ NoSuchFieldError -> 0x0016 }
                int r3 = com.ironsource.mediationsdk.utils.k.a.f8933b     // Catch:{ NoSuchFieldError -> 0x0016 }
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0016 }
            L_0x0016:
                r2 = 3
                int[] r3 = f8169b     // Catch:{ NoSuchFieldError -> 0x001d }
                int r4 = com.ironsource.mediationsdk.utils.k.a.f8934c     // Catch:{ NoSuchFieldError -> 0x001d }
                r3[r0] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                r3 = 4
                int[] r4 = f8169b     // Catch:{ NoSuchFieldError -> 0x0024 }
                int r5 = com.ironsource.mediationsdk.utils.k.a.f8935d     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0035:
                int[] r1 = f8168a     // Catch:{ NoSuchFieldError -> 0x003f }
            ...
            L_0x003f:
                int[] r0 = f8168a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f8168a     // Catch:{ NoSuchFieldError -> 0x0053 }
    ...
    static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        static volatile H f8170a = new H((byte) 0);
    }

    private H() {
        this.f8160a = getClass().getName();
        ...
        this.y = null;
        this.f8165f = IronSourceLoggerManager.getLogger(0);
        com.ironsource.mediationsdk.logger.b bVar = new com.ironsource.mediationsdk.logger.b((LogListener) null, 1);
        this.f8167h = bVar;
        this.f8165f.addLogger(bVar);
        this.f8166g = new com.ironsource.mediationsdk.sdk.i();
        ab abVar = new ab();
        this.f8161b = abVar;
        abVar.m = this.f8166g;
        E e2 = new E();
        this.f8162c = e2;
        com.ironsource.mediationsdk.sdk.i iVar = this.f8166g;
        e2.m = iVar;
        e2.n.f8807a = iVar;
        O o2 = new O();
        this.f8163d = o2;
        o2.f8272b = this.f8166g;
    ...
    private void A() {
        this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, "Banner started in demand only mode", 0);
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < this.i.f8937a.f8784e.size(); i2++) {
            String str = this.i.f8937a.f8784e.get(i2);
            if (!TextUtils.isEmpty(str)) {
                arrayList.add(this.i.f8938b.a(str));
            }
        }
        if (arrayList.size() > 0) {
            synchronized (this.al) {
                this.N = new C0895q(arrayList, this.i.f8939c.f8747d, this.j, this.k);
            }
            this.al.clear();
            return;
        }
    ...
    private boolean C() {
        l lVar = this.i;
        return (lVar == null || lVar.f8939c == null || this.i.f8939c.f8747d == null) ? false : true;
    }
    ...
    private static String a(String str, int i2) {
        ...
        int i3 = AnonymousClass1.f8169b[i2 - 1];
        if (i3 != 1 && i3 != 2 && i3 != 3) {
            return null;
        }
    ...
    private void a(IronSource.AD_UNIT ad_unit) {
        ...
        this.f8165f.log(IronSourceLogger.IronSourceTag.API, str, 3);
        IronSourceUtils.sendAutomationLog(str);
    }

    private void a(IronSource.AD_UNIT ad_unit, boolean z2) {
        int i2 = AnonymousClass1.f8168a[ad_unit.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 == 4) {
                        synchronized (this.ad) {
                            if (this.ad.booleanValue()) {
                                this.ad = Boolean.FALSE;
                                C0888j.a().a(this.ae, new IronSourceError(602, "Init had failed"));
                                this.ae = null;
                                this.af = null;
                            }
                        }
                    ...
                    this.f8166g.onOfferwallAvailable(false);
                }
            } else if (this.v) {
                Iterator<String> it = this.aj.iterator();
                while (it.hasNext()) {
                    A.a().a(it.next(), ErrorBuilder.buildInitFailedError("initISDemandOnly() had failed", "Interstitial"));
                }
                this.aj.clear();
            } else if (this.J) {
                this.J = false;
                C0894p.a().a(IronSource.AD_UNIT.INTERSTITIAL, ErrorBuilder.buildInitFailedError("init() had failed", "Interstitial"));
            }
        } else if (this.u) {
            ...
            if (this.G) {
                this.G = false;
                C0894p.a().a(IronSource.AD_UNIT.REWARDED_VIDEO, ErrorBuilder.buildInitFailedError("init() had failed", IronSourceConstants.REWARDED_VIDEO_AD_UNIT));
            }
        } else if (z2 || d() || this.Y.contains(ad_unit)) {
            this.f8166g.onRewardedVideoAvailabilityChanged(false);
        }
    }

    public static void a(ISDemandOnlyInterstitialListener iSDemandOnlyInterstitialListener) {
        A.a().f8127a = iSDemandOnlyInterstitialListener;
    }

    static void a(ISDemandOnlyRewardedVideoListener iSDemandOnlyRewardedVideoListener) {
        Z.a().f8368a = iSDemandOnlyRewardedVideoListener;
    }
    ...
    public static void a(String str, JSONObject jSONObject) {
        ...
        C0882d.a().a(str, jSONObject);
    }

    private void a(ArrayList<NetworkSettings> arrayList) {
        this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, "Banner started in programmatic mode", 0);
        this.B = new P(arrayList, new com.ironsource.mediationsdk.c.b(this.j, IronSourceUtils.getUserIdForNetworks(), this.i.f8939c.f8747d), k.a().b(), this.s);
        B();
    }
    ...
    private synchronized void a(boolean r10, com.ironsource.mediationsdk.IronSource.AD_UNIT... r11) {
        ...
        L_0x002c:
            ...
            com.ironsource.mediationsdk.sdk.i r10 = r9.f8166g     // Catch:{ Exception -> 0x0051 }
        ...
        L_0x0085:
            ...
            goto L_0x00a0
        L_0x0087:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r6 = r9.f8165f     // Catch:{ all -> 0x01da }
    ...
    private static boolean a(C0880b bVar) {
    ...
    private void n() {
        /*
            r11 = this;
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r11.f8165f
            ...
            com.ironsource.mediationsdk.model.g r0 = r0.f8939c
            com.ironsource.mediationsdk.model.o r0 = r0.f8744a
            ...
            com.ironsource.mediationsdk.model.g r1 = r1.f8939c
            com.ironsource.mediationsdk.model.o r6 = r1.f8744a
        ...
        L_0x0059:
            ...
            boolean r0 = r0.booleanValue()
            if (r0 == 0) goto L_0x00a2
            com.ironsource.mediationsdk.ab r0 = r11.f8161b
    ...
    private void o() {
        this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, "Rewarded Video started in demand only mode", 0);
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < this.i.f8937a.f8780a.size(); i2++) {
            String str = this.i.f8937a.f8780a.get(i2);
            if (!TextUtils.isEmpty(str)) {
                arrayList.add(this.i.f8938b.a(str));
            }
        }
        if (arrayList.size() > 0) {
            synchronized (this.ak) {
                this.am = new C0899u(arrayList, this.i.f8939c.f8744a, this.j, this.k);
            }
    ...
    private Placement p(String str) {
        o oVar = this.i.f8939c.f8744a;
        if (oVar != null) {
            Iterator<Placement> it = oVar.f8789a.iterator();
            while (it.hasNext()) {
    ...
    private void p() {
        ...
        o oVar = this.i.f8939c.f8744a;
        int i2 = oVar.f8793e;
        for (int i3 = 0; i3 < this.i.f8937a.f8780a.size(); i3++) {
            String str = this.i.f8937a.f8780a.get(i3);
            if (!TextUtils.isEmpty(str) && (a4 = this.i.f8938b.a(str)) != null) {
        ...
        if (this.f8161b.f8387c.size() > 0) {
            this.f8161b.n = oVar.f8790b.a();
            this.f8161b.f8386b = oVar.f8791c;
            this.f8161b.o = oVar.f8796h;
            String c2 = this.i.c();
            if (!TextUtils.isEmpty(c2) && (a3 = this.i.f8938b.a(c2)) != null) {
                ac acVar2 = new ac(a3, i2);
                if (a((C0880b) acVar2)) {
                    acVar2.s = this.f8161b;
                    ab abVar = this.f8161b;
                    IronSourceLoggerManager ironSourceLoggerManager = abVar.f8392h;
                    IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
                    ironSourceLoggerManager.log(ironSourceTag, acVar2.f8567d + " is set as backfill", 0);
                    abVar.f8388d = acVar2;
                }
            }
            String d2 = this.i.d();
            if (!TextUtils.isEmpty(d2) && (a2 = this.i.f8938b.a(d2)) != null) {
                ac acVar3 = new ac(a2, i2);
                if (a((C0880b) acVar3)) {
                    acVar3.s = this.f8161b;
                    ab abVar2 = this.f8161b;
                    IronSourceLoggerManager ironSourceLoggerManager2 = abVar2.f8392h;
                    IronSourceLogger.IronSourceTag ironSourceTag2 = IronSourceLogger.IronSourceTag.INTERNAL;
                    ironSourceLoggerManager2.log(ironSourceTag2, acVar3.f8567d + " is set as premium", 0);
                    abVar2.f8389e = acVar3;
                }
            }
            ab abVar3 = this.f8161b;
            abVar3.p = new C0902x(oVar.i, abVar3);
            this.f8161b.a(this.j, IronSourceUtils.getUserIdForNetworks());
            return;
        }
    ...
    private void q() {
        ...
        o oVar = this.i.f8939c.f8744a;
        this.E = oVar.l.f8894a || this.F;
        this.ai = oVar.l.f8895b;
        int a2 = a(oVar);
        this.L = a2;
    ...
    private void q(java.lang.String r6) {
        ...
        L_0x000e:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r2 = r5.f8165f     // Catch:{ Exception -> 0x000c }
            ...
            com.ironsource.mediationsdk.sdk.i r1 = r5.f8166g     // Catch:{ Exception -> 0x000c }
        ...
        L_0x0026:
            ...
            r6 = 0
        L_0x0028:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r2 = r5.f8165f
        ...
        L_0x004b:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r5.f8165f
            ...
            r0.<init>(r1, r6)
            com.ironsource.mediationsdk.sdk.i r6 = r5.f8166g
    ...
    private Placement r(String str) {
        Placement p2 = p(str);
        if (p2 == null) {
            this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Placement is not valid, please make sure you are using the right placements, using the default placement.", 3);
            p2 = b();
            if (p2 == null) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Default placement was not found, please make sure you are using the right placements.", 3);
                return null;
            }
        }
        ...
        this.f8165f.log(IronSourceLogger.IronSourceTag.API, a2, 1);
        this.f8166g.onRewardedVideoAdShowFailed(ErrorBuilder.buildCappedPerPlacementError(a2));
        return null;
    }
    ...
    private void r() {
        ...
        if (s2.size() > 0) {
            h hVar = new h(s2, this.i.f8939c.f8744a, IronSourceUtils.getUserIdForNetworks(), this.F, k.a().b(), this.s);
            this.D = hVar;
            Boolean bool = this.r;
            if (bool != null) {
    ...
    private InterstitialPlacement s(String str) {
        com.ironsource.mediationsdk.model.h hVar = this.i.f8939c.f8745b;
        if (hVar != null) {
            Iterator<InterstitialPlacement> it = hVar.f8749a.iterator();
            while (it.hasNext()) {
    ...
    private List<NetworkSettings> t() {
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < this.i.f8937a.f8783d.size(); i2++) {
            String str = this.i.f8937a.f8783d.get(i2);
            if (!TextUtils.isEmpty(str)) {
                arrayList.add(this.i.f8938b.a(str));
            }
        }
    ...
    private void t(java.lang.String r5) {
        ...
        L_0x000d:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r4.f8165f     // Catch:{ Exception -> 0x000b }
            ...
            com.ironsource.mediationsdk.sdk.i r0 = r4.f8166g     // Catch:{ Exception -> 0x000b }
        ...
        L_0x0026:
            ...
            r5 = 0
        L_0x0028:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r4.f8165f
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r2 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API
    ...
    private InterstitialPlacement u(String str) {
        ...
        this.f8165f.log(IronSourceLogger.IronSourceTag.API, a2, 1);
        this.f8166g.f8830e = s2;
        this.f8166g.onInterstitialAdShowFailed(ErrorBuilder.buildCappedPerPlacementError(a2));
        return null;
    }
    ...
    private void u() {
        ...
        if (t2.size() > 0) {
            g gVar = new g(t2, this.i.f8939c.f8745b, IronSourceUtils.getUserIdForNetworks(), k.a().b(), this.s);
            this.C = gVar;
            Boolean bool = this.r;
            if (bool != null) {
    ...
    private void v() {
        this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, "Adunit: Interstitial is now initiated - programmatic mode", 0);
        List<NetworkSettings> t2 = t();
        if (t2.size() > 0) {
            S s2 = new S(t2, this.i.f8939c.f8745b, this.j, IronSourceUtils.getUserIdForNetworks(), this.i.f8939c.f8745b.f8754f, k.a().b(), this.s);
            this.A = s2;
            Boolean bool = this.r;
            if (bool != null) {
                s2.a(bool.booleanValue());
                if (this.r.booleanValue()) {
                    this.f8162c.a(this.q, false);
                }
            }
            if (this.J) {
                this.J = false;
    ...
    private int w(String str) {
        l lVar = this.i;
        if (lVar == null || lVar.f8939c == null || this.i.f8939c.f8745b == null) {
            return k.a.f8935d;
        }
        ...
        try {
            ...
            if (interstitialPlacement == null && (interstitialPlacement = e()) == null) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Default placement was not found", 3);
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return interstitialPlacement == null ? k.a.f8935d : k.b(ContextProvider.getInstance().getApplicationContext(), interstitialPlacement);
    }
    ...
    private void w() {
        ...
        com.ironsource.mediationsdk.model.h hVar = this.i.f8939c.f8745b;
        int i2 = hVar.f8753e;
        this.f8162c.n.a(IronSource.AD_UNIT.INTERSTITIAL, hVar.f8754f);
        for (int i3 = 0; i3 < this.i.f8937a.f8783d.size(); i3++) {
            String str = this.i.f8937a.f8783d.get(i3);
            if (!TextUtils.isEmpty(str) && (a2 = this.i.f8938b.a(str)) != null) {
                F f2 = new F(a2, i2);
                if (a((C0880b) f2)) {
                    f2.s = this.f8162c;
                    f2.n = i3 + 1;
        ...
        if (this.f8162c.f8387c.size() > 0) {
            this.f8162c.f8386b = hVar.f8751c;
            this.f8162c.a(this.j, IronSourceUtils.getUserIdForNetworks());
            if (this.J) {
                this.J = false;
                this.f8162c.c();
                return;
    ...
    private void x() {
        this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, "Interstitial started in demand only mode", 0);
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < this.i.f8937a.f8783d.size(); i2++) {
            String str = this.i.f8937a.f8783d.get(i2);
            if (!TextUtils.isEmpty(str)) {
        ...
        if (arrayList.size() > 0) {
            synchronized (this.aj) {
                this.M = new C0897s(arrayList, this.i.f8939c.f8745b, this.j, this.k);
            }
            Iterator<String> it = this.aj.iterator();
            while (it.hasNext()) {
    ...
    private void y() {
        ...
        com.ironsource.mediationsdk.model.h hVar = this.i.f8939c.f8745b;
        this.H = hVar.i.f8894a;
        this.I = hVar.i.f8895b;
    ...
    private void z() {
        ...
        L_0x0008:
            ...
            com.ironsource.mediationsdk.model.g r1 = r1.f8939c     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.e r1 = r1.f8747d     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.utils.c r1 = r1.f8742g     // Catch:{ all -> 0x00e5 }
            boolean r1 = r1.f8894a     // Catch:{ all -> 0x00e5 }
        ...
        L_0x0055:
            ...
            com.ironsource.mediationsdk.model.m r2 = r2.f8937a     // Catch:{ all -> 0x00e5 }
            java.util.ArrayList<java.lang.String> r2 = r2.f8784e     // Catch:{ all -> 0x00e5 }
            ...
            com.ironsource.mediationsdk.model.n r5 = r5.f8938b     // Catch:{ all -> 0x00e5 }
        ...
        L_0x0092:
            ...
            com.ironsource.mediationsdk.model.g r1 = r1.f8939c     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.e r1 = r1.f8747d     // Catch:{ all -> 0x00e5 }
            long r9 = r1.f8737b     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.utils.l r1 = r13.i     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.g r1 = r1.f8939c     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.e r1 = r1.f8747d     // Catch:{ all -> 0x00e5 }
            int r11 = r1.f8740e     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.utils.l r1 = r13.i     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.g r1 = r1.f8939c     // Catch:{ all -> 0x00e5 }
            com.ironsource.mediationsdk.model.e r1 = r1.f8747d     // Catch:{ all -> 0x00e5 }
            int r12 = r1.f8741f     // Catch:{ all -> 0x00e5 }
            ...
            r13.f8164e = r1     // Catch:{ all -> 0x00e5 }
    ...
    public final com.ironsource.mediationsdk.utils.l a(android.content.Context r11, java.lang.String r12, com.ironsource.mediationsdk.H.a r13) {
        ...
        L_0x001e:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r3 = r10.f8165f     // Catch:{ all -> 0x033c }
        ...
        L_0x006a:
            ...
            com.ironsource.mediationsdk.utils.l r12 = r10.i     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.logger.b r3 = r10.f8167h     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.g r4 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.f.a r4 = r4.f8748e     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.d r4 = r4.a()     // Catch:{ all -> 0x033c }
            int r4 = r4.f8733a     // Catch:{ all -> 0x033c }
            r3.setDebugLevel(r4)     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r3 = r10.f8165f     // Catch:{ all -> 0x033c }
            java.lang.String r4 = "console"
            com.ironsource.mediationsdk.model.g r5 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.f.a r5 = r5.f8748e     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.d r5 = r5.a()     // Catch:{ all -> 0x033c }
            int r5 = r5.f8734b     // Catch:{ all -> 0x033c }
            r3.setLoggerDebugLevel(r4, r5)     // Catch:{ all -> 0x033c }
            boolean r3 = r10.d()     // Catch:{ all -> 0x033c }
            if (r3 == 0) goto L_0x00a8
            com.ironsource.mediationsdk.model.g r3 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.o r3 = r3.f8744a     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r3 = r3.f8790b     // Catch:{ all -> 0x033c }
        ...
        L_0x00a9:
            ...
            com.ironsource.mediationsdk.model.g r4 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.h r4 = r4.f8745b     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r4 = r4.f8750b     // Catch:{ all -> 0x033c }
        ...
        L_0x00bb:
            ...
            com.ironsource.mediationsdk.model.g r5 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.e r5 = r5.f8747d     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r5 = r5.f8736a     // Catch:{ all -> 0x033c }
        ...
        L_0x00cd:
            ...
            com.ironsource.mediationsdk.model.g r6 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.i r6 = r6.f8746c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r6 = r6.f8759c     // Catch:{ all -> 0x033c }
            boolean r6 = r6.b()     // Catch:{ all -> 0x033c }
            goto L_0x00df
        L_0x00de:
            r6 = 0
        L_0x00df:
            com.ironsource.mediationsdk.model.g r7 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.f.a r7 = r7.f8748e     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.utils.j r7 = r7.h()     // Catch:{ all -> 0x033c }
            boolean r8 = r7.f8923a     // Catch:{ all -> 0x033c }
            ...
            com.ironsource.mediationsdk.a.h r6 = com.ironsource.mediationsdk.a.h.e()     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.g r9 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.f.a r9 = r9.f8748e     // Catch:{ all -> 0x033c }
        ...
        L_0x016b:
            r6.f8403c = r3     // Catch:{ all -> 0x033c }
            goto L_0x01f9
        L_0x016f:
            if (r6 == 0) goto L_0x01f3
            com.ironsource.mediationsdk.model.g r3 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.i r3 = r3.f8746c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r3 = r3.f8759c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.a.h r6 = com.ironsource.mediationsdk.a.h.e()     // Catch:{ all -> 0x033c }
            java.lang.String r9 = r3.e()     // Catch:{ all -> 0x033c }
            r6.b((java.lang.String) r9, (android.content.Context) r11)     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.a.h r6 = com.ironsource.mediationsdk.a.h.e()     // Catch:{ all -> 0x033c }
        ...
        L_0x01f3:
            ...
            r3.f8406f = r2     // Catch:{ all -> 0x033c }
        L_0x01f9:
            if (r4 == 0) goto L_0x027f
            com.ironsource.mediationsdk.model.g r2 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.h r2 = r2.f8745b     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r2 = r2.f8750b     // Catch:{ all -> 0x033c }
            ...
            com.ironsource.mediationsdk.a.d r3 = com.ironsource.mediationsdk.a.d.e()     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.g r12 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.f.a r12 = r12.f8748e     // Catch:{ all -> 0x033c }
        ...
        L_0x027b:
            r12.f8403c = r2     // Catch:{ all -> 0x033c }
            goto L_0x0309
        L_0x027f:
            if (r5 == 0) goto L_0x0303
            com.ironsource.mediationsdk.model.g r2 = r12.f8939c     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.model.e r2 = r2.f8747d     // Catch:{ all -> 0x033c }
            com.ironsource.sdk.g.d r2 = r2.f8736a     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.a.d r3 = com.ironsource.mediationsdk.a.d.e()     // Catch:{ all -> 0x033c }
            java.lang.String r4 = r2.e()     // Catch:{ all -> 0x033c }
            r3.b((java.lang.String) r4, (android.content.Context) r11)     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.a.d r3 = com.ironsource.mediationsdk.a.d.e()     // Catch:{ all -> 0x033c }
        ...
        L_0x0303:
            com.ironsource.mediationsdk.a.d r12 = com.ironsource.mediationsdk.a.d.e()     // Catch:{ all -> 0x033c }
            r12.f8406f = r2     // Catch:{ all -> 0x033c }
        L_0x0309:
            com.ironsource.mediationsdk.a.g r12 = com.ironsource.mediationsdk.a.g.w     // Catch:{ all -> 0x033c }
            r12.f8406f = r8     // Catch:{ all -> 0x033c }
            if (r8 == 0) goto L_0x032a
            java.lang.String r12 = r7.f8924b     // Catch:{ all -> 0x033c }
            ...
            com.ironsource.mediationsdk.a.g r12 = com.ironsource.mediationsdk.a.g.w     // Catch:{ all -> 0x033c }
            int[] r2 = r7.f8926d     // Catch:{ all -> 0x033c }
            r12.a((int[]) r2, (android.content.Context) r11)     // Catch:{ all -> 0x033c }
            com.ironsource.mediationsdk.a.g r12 = com.ironsource.mediationsdk.a.g.w     // Catch:{ all -> 0x033c }
            int[] r2 = r7.f8927e     // Catch:{ all -> 0x033c }
            ...
            boolean r12 = r7.f8925c     // Catch:{ all -> 0x033c }
            r11.f8403c = r12     // Catch:{ all -> 0x033c }
        L_0x032a:
            com.ironsource.mediationsdk.a.d r11 = com.ironsource.mediationsdk.a.d.e()     // Catch:{ all -> 0x033c }
            r11.f8401a = r1     // Catch:{ all -> 0x033c }
    ...
    public final synchronized void a(android.app.Activity r9, com.ironsource.mediationsdk.IronSourceBannerLayout r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r10 = r8.f8165f     // Catch:{ all -> 0x000f }
        ...
        L_0x0012:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r11 = r8.f8165f     // Catch:{ all -> 0x0240 }
        ...
        L_0x007b:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r9 = r8.f8165f     // Catch:{ all -> 0x0240 }
        ...
        L_0x0110:
            ...
            r9.f8818b = r10     // Catch:{ all -> 0x0240 }
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.r> r0 = r9.f8819c     // Catch:{ all -> 0x0240 }
            boolean r0 = r0.containsKey(r11)     // Catch:{ all -> 0x0240 }
            if (r0 != 0) goto L_0x0134
            r12 = 3503(0xdaf, float:4.909E-42)
            com.ironsource.mediationsdk.C0895q.a((int) r12, (java.lang.String) r11)     // Catch:{ all -> 0x0240 }
            java.lang.String r11 = "Banner"
            ...
            com.ironsource.mediationsdk.IronSourceBannerLayout r12 = r9.f8818b     // Catch:{ all -> 0x0240 }
            if (r12 == 0) goto L_0x023b
            com.ironsource.mediationsdk.IronSourceBannerLayout r9 = r9.f8818b     // Catch:{ all -> 0x0240 }
        L_0x012f:
        ...
        L_0x0138:
            com.ironsource.mediationsdk.C0895q.a((int) r0, (java.lang.String) r11)     // Catch:{ all -> 0x0240 }
            goto L_0x0144
        L_0x013c:
        ...
        L_0x0153:
            ...
            r2 = r11
            com.ironsource.mediationsdk.r r2 = (com.ironsource.mediationsdk.C0896r) r2     // Catch:{ all -> 0x0240 }
            r9.f8817a = r2     // Catch:{ all -> 0x0240 }
        ...
        L_0x0176:
            ...
            r12 = 0
            com.ironsource.mediationsdk.C0895q.a((int) r0, (com.ironsource.mediationsdk.C0896r) r2, (java.lang.Object[][]) r12)     // Catch:{ all -> 0x0240 }
            com.ironsource.mediationsdk.IronSourceBannerLayout r12 = r9.f8818b     // Catch:{ all -> 0x0240 }
            if (r12 == 0) goto L_0x023b
            com.ironsource.mediationsdk.IronSourceBannerLayout r9 = r9.f8818b     // Catch:{ all -> 0x0240 }
            goto L_0x012f
        L_0x0198:
            com.ironsource.mediationsdk.C0884f.a()     // Catch:{ all -> 0x0240 }
            org.json.JSONObject r11 = com.ironsource.mediationsdk.C0884f.a((java.lang.String) r12)     // Catch:{ all -> 0x0240 }
            com.ironsource.mediationsdk.f$a r12 = new com.ironsource.mediationsdk.f$a     // Catch:{ all -> 0x0240 }
            r12.<init>()     // Catch:{ all -> 0x0240 }
            com.ironsource.mediationsdk.C0884f.a()     // Catch:{ Exception -> 0x01ac }
            com.ironsource.mediationsdk.f$a r12 = com.ironsource.mediationsdk.C0884f.a((org.json.JSONObject) r11)     // Catch:{ Exception -> 0x01ac }
            goto L_0x01d5
        L_0x01ac:
            r11 = move-exception
            ...
            com.ironsource.mediationsdk.IronSourceBannerLayout r3 = r9.f8818b     // Catch:{ all -> 0x0240 }
        ...
        L_0x01d5:
            ...
            java.util.List<com.ironsource.mediationsdk.server.b> r3 = r12.f8602b     // Catch:{ all -> 0x0240 }
            com.ironsource.mediationsdk.server.b r11 = com.ironsource.mediationsdk.C0884f.a((java.lang.String) r11, (java.util.List<com.ironsource.mediationsdk.server.b>) r3)     // Catch:{ all -> 0x0240 }
            if (r11 == 0) goto L_0x020b
            java.lang.String r0 = r11.b()     // Catch:{ all -> 0x0240 }
            r2.a((java.lang.String) r0)     // Catch:{ all -> 0x0240 }
            java.lang.String r0 = r12.f8601a     // Catch:{ all -> 0x0240 }
            r2.b(r0)     // Catch:{ all -> 0x0240 }
            org.json.JSONObject r0 = r12.f8604d     // Catch:{ all -> 0x0240 }
            r2.a((org.json.JSONObject) r0)     // Catch:{ all -> 0x0240 }
            r0 = 3002(0xbba, float:4.207E-42)
            r9.a((int) r0, (com.ironsource.mediationsdk.C0896r) r2)     // Catch:{ all -> 0x0240 }
            java.lang.String r4 = r11.b()     // Catch:{ all -> 0x0240 }
            java.lang.String r5 = r12.f8601a     // Catch:{ all -> 0x0240 }
            org.json.JSONObject r6 = r12.f8604d     // Catch:{ all -> 0x0240 }
        ...
        L_0x0240:
            r9 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r11 = r8.f8165f     // Catch:{ all -> 0x000f }
    ...
    public final synchronized void a(Activity activity, String str, String str2) {
        if (str2 == null) {
            this.f8165f.log(IronSourceLogger.IronSourceTag.API, "adm cannot be null", 3);
    ...
    public final synchronized void a(android.content.Context r8, java.lang.String r9, com.ironsource.mediationsdk.sdk.InitializationListener r10, com.ironsource.mediationsdk.IronSource.AD_UNIT... r11) {
        ...
        L_0x0010:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r4 = r7.f8165f     // Catch:{ all -> 0x00f5 }
    ...
    public final synchronized void a(android.content.Context r9, java.lang.String r10, boolean r11, com.ironsource.mediationsdk.sdk.InitializationListener r12, com.ironsource.mediationsdk.IronSource.AD_UNIT... r13) {
        ...
        L_0x0127:
            ...
            com.ironsource.environment.g r3 = com.ironsource.environment.g.f8081a     // Catch:{ all -> 0x02ea }
            com.ironsource.mediationsdk.model.g r2 = r2.f8939c     // Catch:{ all -> 0x02ea }
            com.ironsource.sdk.f.a r2 = r2.f8748e     // Catch:{ all -> 0x02ea }
            com.ironsource.mediationsdk.utils.b r2 = r2.f()     // Catch:{ all -> 0x02ea }
            boolean r2 = r2.f8893c     // Catch:{ all -> 0x02ea }
        ...
        L_0x01a9:
            ...
            com.ironsource.mediationsdk.sdk.i r9 = r8.f8166g     // Catch:{ all -> 0x02ea }
        ...
        L_0x0298:
            ...
            com.ironsource.mediationsdk.E r12 = r8.f8162c     // Catch:{ all -> 0x02ea }
        ...
        L_0x02c6:
            ...
            return
        L_0x02de:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r9 = r8.f8165f     // Catch:{ all -> 0x02ea }
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r10 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API     // Catch:{ all -> 0x02ea }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00e5, code lost:
        r3.f8165f.log(com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API, "No banner configurations found", 3);
        com.ironsource.mediationsdk.C0888j.a().a(r4, new com.ironsource.mediationsdk.logger.IronSourceError(615, "No banner configurations found"));
     */
    ...
    public final void a(com.ironsource.mediationsdk.IronSourceBannerLayout r4, java.lang.String r5) {
        ...
        L_0x001e:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r3.f8165f
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r2 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API
            r1.log(r2, r5, r0)
            com.ironsource.mediationsdk.j r0 = com.ironsource.mediationsdk.C0888j.a()
        ...
        L_0x0037:
            ...
            if (r1 > 0) goto L_0x0072
        L_0x005b:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r5 = r3.f8165f
            ...
            r5.log(r1, r2, r0)
            com.ironsource.mediationsdk.j r5 = com.ironsource.mediationsdk.C0888j.a()
            java.lang.String r0 = ""
        ...
        L_0x00c9:
            ...
            monitor-enter(r1)
            com.ironsource.mediationsdk.k r2 = r3.f8164e     // Catch:{ all -> 0x0117 }
        ...
        L_0x00ff:
            ...
            com.ironsource.mediationsdk.k r0 = r3.f8164e
    ...
    public final void a(RewardedVideoListener rewardedVideoListener) {
        this.f8165f.log(IronSourceLogger.IronSourceTag.API, rewardedVideoListener == null ? "setRewardedVideoListener(RVListener:null)" : "setRewardedVideoListener(RVListener)", 1);
        this.f8166g.f8826a = rewardedVideoListener;
        aa.a().f8438a = rewardedVideoListener;
    }
    ...
    public final synchronized void a(RewardedVideoManualListener rewardedVideoManualListener) {
        if (this.w) {
            ...
            this.f8165f.log(IronSourceLogger.IronSourceTag.API, "setting RewardedVideo to manual mode", 1);
            this.F = true;
            C0894p.a().f8808b = rewardedVideoManualListener;
    ...
    public final void a(String str) {
        try {
            IronSourceLoggerManager ironSourceLoggerManager = this.f8165f;
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.API;
    ...
    public final void a(String str, List<String> list) {
        ...
        if (checkMetaDataKeyValidity.length() > 0) {
            ...
            if (!MetaDataUtils.isMediationOnlyKey(metaDataKey)) {
                C0882d.a().a(metaDataKey, metaDataValue);
    ...
    public final void a(List<IronSource.AD_UNIT> list, boolean z2, com.ironsource.mediationsdk.model.g gVar) {
        ...
        try {
            this.W = list;
            this.V = true;
            this.f8165f.log(IronSourceLogger.IronSourceTag.API, "onInitSuccess()", 1);
        ...
        if (b2 == M.a.NOT_INIT) {
            ...
            try {
                ...
                if (a2 == null || !a2.b()) {
                    ...
                    pVar = a2.f8939c.f8748e.c();
                    if (!pVar.f8963d) {
                        pVar.f8961b = a2.f8938b.a(IronSourceConstants.IRONSOURCE_CONFIG_NAME);
                    }
                }
                ...
                if (pVar.f8963d) {
                    ...
                    Intrinsics.checkNotNullParameter(context, "context");
                    JSONObject a3 = C0891m.a(context, bVar.f8079a);
                    ...
                    NetworkSettings networkSettings = pVar.f8961b;
                    if (networkSettings != null) {
                        ...
                        if (a5 != null) {
                            jSONObject = C0884f.a().a(a5.getPlayerBiddingData(), pVar.f8962c, (List<String>) pVar.f8960a);
                        }
                    }
                    jSONObject = null;
                }
                C0884f.a().a(jSONObject, true);
                str = pVar.f8964e ? IronSourceAES.compressAndEncrypt(jSONObject.toString()) : IronSourceAES.encrypt(jSONObject.toString());
            } catch (Throwable th) {
    ...
    public final synchronized void b(android.app.Activity r6, java.lang.String r7, java.lang.String r8) {
        /*
            r5 = this;
            monitor-enter(r5)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r5.f8165f     // Catch:{ all -> 0x0162 }
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r8 = r5.f8165f     // Catch:{ all -> 0x0144 }
        ...
        L_0x008c:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r6 = r5.f8165f     // Catch:{ all -> 0x0144 }
        ...
        L_0x0144:
            r6 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r8 = r5.f8165f     // Catch:{ all -> 0x0162 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x002a, code lost:
        if (r9.z.a_() != false) goto L_0x002c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x002c, code lost:
        r3 = true;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0041, code lost:
        if (r9.D.b() != false) goto L_0x002c;
     */
    ...
    public final boolean c() {
        /*
            ...
            r1 = 1
            r2 = 0
            boolean r3 = r9.u     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x0013
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r3 = r9.f8165f     // Catch:{ all -> 0x008f }
            ...
            return r2
        L_0x0013:
            boolean r3 = r9.F     // Catch:{ all -> 0x008f }
            if (r3 != 0) goto L_0x0037
            boolean r3 = r9.ai     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x001c
            goto L_0x0037
        L_0x001c:
            boolean r3 = r9.E     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x0030
            com.ironsource.mediationsdk.z r3 = r9.z     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x002e
            com.ironsource.mediationsdk.z r3 = r9.z     // Catch:{ all -> 0x008f }
            boolean r3 = r3.a_()     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x002e
        L_0x002c:
            r3 = 1
            goto L_0x0044
        L_0x002e:
            ...
            goto L_0x0044
        L_0x0030:
            com.ironsource.mediationsdk.ab r3 = r9.f8161b     // Catch:{ all -> 0x008f }
            boolean r3 = r3.c()     // Catch:{ all -> 0x008f }
            goto L_0x0044
        L_0x0037:
            com.ironsource.mediationsdk.adunit.c.h r3 = r9.D     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x002e
            com.ironsource.mediationsdk.adunit.c.h r3 = r9.D     // Catch:{ all -> 0x008f }
            boolean r3 = r3.b()     // Catch:{ all -> 0x008f }
            if (r3 == 0) goto L_0x002e
            goto L_0x002c
        L_0x0044:
            org.json.JSONObject r4 = com.ironsource.mediationsdk.utils.IronSourceUtils.getMediationAdditionalData(r2)     // Catch:{ all -> 0x008a }
            boolean r5 = r9.E     // Catch:{ all -> 0x008a }
        ...
        L_0x006b:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r4 = r9.f8165f     // Catch:{ all -> 0x008a }
        ...
        L_0x008f:
            ...
            r4 = 0
        L_0x0091:
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r5 = r9.f8165f
            ...
            r5.log(r6, r0, r1)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r9.f8165f
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r1 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API
    ...
    public final boolean c(String str) {
        try {
            this.f8165f.log(IronSourceLogger.IronSourceTag.API, this.f8160a + ":setDynamicUserId(dynamicUserId:" + str + ")", 1);
            ...
            IronSourceLoggerManager ironSourceLoggerManager = this.f8165f;
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.API;
            ironSourceLoggerManager.logException(ironSourceTag, this.f8160a + ":setDynamicUserId(dynamicUserId:" + str + ")", e2);
            return false;
        }
    }
    ...
    public final synchronized void d(android.app.Activity r7, java.lang.String r8, java.lang.String r9) {
        /*
            r6 = this;
            monitor-enter(r6)
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r0 = r6.f8165f     // Catch:{ all -> 0x015c }
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r9 = r6.f8165f     // Catch:{ all -> 0x0140 }
        ...
        L_0x008c:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r7 = r6.f8165f     // Catch:{ all -> 0x0140 }
        ...
        L_0x0140:
            r7 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r9 = r6.f8165f     // Catch:{ all -> 0x015c }
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r1 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API     // Catch:{ all -> 0x015c }
    ...
    public final void d(String str) {
        try {
            this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, this.f8160a + ":setMediationType(mediationType:" + str + ")", 1);
            if (!a(str, 1, 64) || !v(str)) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.INTERNAL, " mediationType value is invalid - should be alphanumeric and 1-64 chars in length", 1);
            } else {
                this.o = str;
            }
        } catch (Exception e2) {
            IronSourceLoggerManager ironSourceLoggerManager = this.f8165f;
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.API;
            ironSourceLoggerManager.logException(ironSourceTag, this.f8160a + ":setMediationType(mediationType:" + str + ")", e2);
        }
    }
    ...
    public boolean d() {
        l lVar = this.i;
        return (lVar == null || lVar.f8939c == null || this.i.f8939c.f8744a == null) ? false : true;
    }
    ...
    public final void e(String str) {
        ...
        this.f8165f.log(IronSourceLogger.IronSourceTag.API, str2, 1);
        try {
            if (this.u) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Rewarded Video was initialized in demand only mode. Use showISDemandOnlyRewardedVideo instead", 3);
                this.f8166g.onRewardedVideoAdShowFailed(ErrorBuilder.buildInitFailedError("Rewarded Video was initialized in demand only mode. Use showISDemandOnlyRewardedVideo instead", IronSourceConstants.REWARDED_VIDEO_AD_UNIT));
            } else if (!d()) {
                this.f8166g.onRewardedVideoAdShowFailed(ErrorBuilder.buildInitFailedError("showRewardedVideo can't be called before the Rewarded Video ad unit initialization completed successfully", IronSourceConstants.REWARDED_VIDEO_AD_UNIT));
            } else if (this.E) {
                q(str);
            } else {
                Placement r2 = r(str);
                if (r2 != null) {
                    this.f8161b.a(r2);
                    this.f8161b.a(r2.getPlacementName());
                }
            }
        } catch (Exception e2) {
            this.f8165f.logException(IronSourceLogger.IronSourceTag.API, str2, e2);
            this.f8166g.onRewardedVideoAdShowFailed(new IronSourceError(510, e2.getMessage()));
        }
    }
    ...
    public final void f() {
        synchronized (this.ad) {
            if (this.ad.booleanValue()) {
                this.ad = Boolean.FALSE;
                C0888j.a().a(this.ae, new IronSourceError(603, "init had failed"));
                this.ae = null;
                this.af = null;
            }
        }
    ...
    public final synchronized void f(String str) {
        ...
        try {
            if (!this.u) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Rewarded video was initialized in mediation mode. Use showRewardedVideo instead", 3);
                Z.a().b(str, new IronSourceError(508, "Rewarded video was initialized in mediation mode. Use showRewardedVideo instead"));
                return;
            } else if (this.am == null) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Rewarded video was not initiated", 3);
                Z.a().b(str, new IronSourceError(508, "Rewarded video was not initiated"));
                return;
            } else {
                C0899u uVar = this.am;
                if (!uVar.f8885a.containsKey(str)) {
                    C0899u.a(1500, str);
                    Z.a().b(str, ErrorBuilder.buildNonExistentInstanceError(IronSourceConstants.REWARDED_VIDEO_AD_UNIT));
                } else {
                    C0900v vVar = uVar.f8885a.get(str);
            ...
            this.f8165f.logException(IronSourceLogger.IronSourceTag.API, "showISDemandOnlyRewardedVideo", e2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0042, code lost:
        if (r9.f8162c.e() != false) goto L_0x0027;
     */
    ...
    public final boolean g() {
        /*
            ...
            if (r3 == 0) goto L_0x0013
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r3 = r9.f8165f     // Catch:{ all -> 0x0078 }
        ...
        L_0x002b:
            ...
            goto L_0x0027
        L_0x0038:
            com.ironsource.mediationsdk.E r3 = r9.f8162c     // Catch:{ all -> 0x0078 }
            if (r3 == 0) goto L_0x0029
            com.ironsource.mediationsdk.E r3 = r9.f8162c     // Catch:{ all -> 0x0078 }
            boolean r3 = r3.e()     // Catch:{ all -> 0x0078 }
            if (r3 == 0) goto L_0x0029
        ...
        L_0x0054:
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r4 = r9.f8165f     // Catch:{ all -> 0x0073 }
    ...
    public final synchronized boolean g(java.lang.String r5) {
        /*
            ...
            com.ironsource.mediationsdk.u r0 = r4.am     // Catch:{ all -> 0x003a }
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.v> r2 = r0.f8885a     // Catch:{ all -> 0x003a }
            boolean r2 = r2.containsKey(r5)     // Catch:{ all -> 0x003a }
            r3 = 1
            if (r2 != 0) goto L_0x0018
            r0 = 1500(0x5dc, float:2.102E-42)
            com.ironsource.mediationsdk.C0899u.a((int) r0, (java.lang.String) r5)     // Catch:{ all -> 0x003a }
        L_0x0016:
            r5 = 0
            goto L_0x0034
        L_0x0018:
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.v> r0 = r0.f8885a     // Catch:{ all -> 0x003a }
            java.lang.Object r5 = r0.get(r5)     // Catch:{ all -> 0x003a }
            com.ironsource.mediationsdk.v r5 = (com.ironsource.mediationsdk.C0900v) r5     // Catch:{ all -> 0x003a }
            boolean r0 = r5.b()     // Catch:{ all -> 0x003a }
            r2 = 0
            if (r0 == 0) goto L_0x002e
            r0 = 1210(0x4ba, float:1.696E-42)
            com.ironsource.mediationsdk.C0899u.a((int) r0, (com.ironsource.mediationsdk.C0900v) r5, (java.lang.Object[][]) r2)     // Catch:{ all -> 0x003a }
            r5 = 1
            goto L_0x0034
        L_0x002e:
    ...
    public final void h(java.lang.String r7) {
        /*
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r1 = r6.f8165f
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r2 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API
            r3 = 1
            r1.log(r2, r0, r3)
            r1 = 510(0x1fe, float:7.15E-43)
            ...
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r2 = r6.f8165f     // Catch:{ Exception -> 0x0090 }
            ...
            com.ironsource.mediationsdk.sdk.i r2 = r6.f8166g     // Catch:{ Exception -> 0x0090 }
        ...
        L_0x0036:
            ...
            com.ironsource.mediationsdk.sdk.i r7 = r6.f8166g     // Catch:{ Exception -> 0x0090 }
        ...
        L_0x0072:
            ...
            com.ironsource.mediationsdk.E r7 = r6.f8162c     // Catch:{ Exception -> 0x0090 }
        ...
        L_0x0090:
            r7 = move-exception
            com.ironsource.mediationsdk.logger.IronSourceLoggerManager r2 = r6.f8165f
            com.ironsource.mediationsdk.logger.IronSourceLogger$IronSourceTag r3 = com.ironsource.mediationsdk.logger.IronSourceLogger.IronSourceTag.API
            r2.logException(r3, r0, r7)
            com.ironsource.mediationsdk.sdk.i r0 = r6.f8166g
    ...
    public boolean h() {
        l lVar = this.i;
        return (lVar == null || lVar.f8939c == null || this.i.f8939c.f8745b == null) ? false : true;
    }

    /* access modifiers changed from: package-private */
    public boolean i() {
        l lVar = this.i;
        return (lVar == null || lVar.f8939c == null || this.i.f8939c.f8746c == null) ? false : true;
    }
    ...
    public final synchronized boolean i(java.lang.String r5) {
        /*
            ...
            if (r0 == 0) goto L_0x0038
            com.ironsource.mediationsdk.s r0 = r4.M     // Catch:{ all -> 0x003a }
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.t> r2 = r0.f8822a     // Catch:{ all -> 0x003a }
            boolean r2 = r2.containsKey(r5)     // Catch:{ all -> 0x003a }
            r3 = 1
            if (r2 != 0) goto L_0x0018
            r0 = 2500(0x9c4, float:3.503E-42)
            com.ironsource.mediationsdk.C0897s.a((int) r0, (java.lang.String) r5)     // Catch:{ all -> 0x003a }
        L_0x0016:
            r5 = 0
            goto L_0x0034
        L_0x0018:
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.t> r0 = r0.f8822a     // Catch:{ all -> 0x003a }
            java.lang.Object r5 = r0.get(r5)     // Catch:{ all -> 0x003a }
            com.ironsource.mediationsdk.t r5 = (com.ironsource.mediationsdk.C0898t) r5     // Catch:{ all -> 0x003a }
            boolean r0 = r5.b()     // Catch:{ all -> 0x003a }
            r2 = 0
            if (r0 == 0) goto L_0x002e
            r0 = 2211(0x8a3, float:3.098E-42)
            com.ironsource.mediationsdk.C0897s.a((int) r0, (com.ironsource.mediationsdk.C0898t) r5, (java.lang.Object[][]) r2)     // Catch:{ all -> 0x003a }
            r5 = 1
            goto L_0x0034
        L_0x002e:
    ...
    public final void j(String str) {
        ...
        try {
            if (!i()) {
                this.f8166g.onOfferwallShowFailed(ErrorBuilder.buildInitFailedError("showOfferwall can't be called before the Offerwall ad unit initialization completed successfully", IronSourceConstants.OFFERWALL_AD_UNIT));
                return;
            }
            j a2 = this.i.f8939c.f8746c.a(str);
            if (a2 == null) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Placement is not valid, please make sure you are using the right placements, using the default placement.", 3);
                a2 = this.i.f8939c.f8746c.a();
                if (a2 == null) {
                    this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Default placement was not found, please make sure you are using the right placements.", 3);
                    return;
                }
            }
            this.f8163d.a(a2.f8762b);
        } catch (Exception e2) {
            this.f8165f.logException(IronSourceLogger.IronSourceTag.API, str2, e2);
            this.f8166g.onOfferwallShowFailed(ErrorBuilder.buildInitFailedError("showOfferwall can't be called before the Offerwall ad unit initialization completed successfully", IronSourceConstants.OFFERWALL_AD_UNIT));
        }
    ...
    public final InterstitialPlacement k(String str) {
        try {
            ...
            if (s2 == null) {
                try {
                    this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Placement is not valid, please make sure you are using the right placements, using the default placement.", 2);
                    s2 = e();
                } catch (Exception unused) {
                    return s2;
                }
    ...
    public final java.lang.String l() {
        /*
            ...
            goto L_0x00ee
        L_0x001b:
            com.ironsource.mediationsdk.model.n r0 = r0.f8938b
            java.lang.String r2 = "IronSource"
            com.ironsource.mediationsdk.model.NetworkSettings r0 = r0.a((java.lang.String) r2)
            if (r0 == 0) goto L_0x00ee
            org.json.JSONObject r2 = new org.json.JSONObject
            r2.<init>()
            com.ironsource.mediationsdk.d r3 = com.ironsource.mediationsdk.C0882d.a()
        ...
        L_0x003e:
            com.ironsource.mediationsdk.utils.l r0 = r8.i     // Catch:{ Exception -> 0x00cd }
            com.ironsource.mediationsdk.model.g r0 = r0.f8939c     // Catch:{ Exception -> 0x00cd }
            com.ironsource.sdk.f.a r0 = r0.f8748e     // Catch:{ Exception -> 0x00cd }
            com.ironsource.mediationsdk.utils.p r0 = r0.c()     // Catch:{ Exception -> 0x00cd }
            boolean r3 = r0.f8963d     // Catch:{ Exception -> 0x00cd }
            ...
            com.ironsource.mediationsdk.f r3 = com.ironsource.mediationsdk.C0884f.a()     // Catch:{ Exception -> 0x00cd }
            r3.a((org.json.JSONObject) r2, (boolean) r6)     // Catch:{ Exception -> 0x00cd }
            goto L_0x0069
        L_0x005d:
            com.ironsource.mediationsdk.f r3 = com.ironsource.mediationsdk.C0884f.a()     // Catch:{ Exception -> 0x00cd }
            org.json.JSONObject r4 = r0.f8962c     // Catch:{ Exception -> 0x00cd }
            java.util.ArrayList<java.lang.String> r5 = r0.f8960a     // Catch:{ Exception -> 0x00cd }
        ...
        L_0x0069:
            ...
            java.lang.String r4 = r4.toString()     // Catch:{ Exception -> 0x00cd }
            r3.verbose(r4)     // Catch:{ Exception -> 0x00cd }
            boolean r0 = r0.f8964e     // Catch:{ Exception -> 0x00cd }
    ...
    public final boolean n(String str) {
        ...
        f fVar = null;
        try {
            fVar = this.i.f8939c.f8747d.a(str);
            if (fVar == null && (fVar = this.i.f8939c.f8747d.a()) == null) {
                this.f8165f.log(IronSourceLogger.IronSourceTag.API, "Banner default placement was not found", 3);
                return false;
            }
        } catch (Exception e2) {
            e2.printStackTrace();
    ...
    public int o(String str) {
        l lVar = this.i;
        if (lVar == null || lVar.f8939c == null || this.i.f8939c.f8744a == null) {
            return k.a.f8935d;
        }
        ...
        return placement == null ? k.a.f8935d : k.b(ContextProvider.getInstance().getApplicationContext(), placement);
    }
}
