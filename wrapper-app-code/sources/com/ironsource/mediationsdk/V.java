...
final class V extends C0892n implements j, W, ae, C0881c, C0885g, C0904z {
    private a A;
    private int B;
    private String C = "";
    ...
    final ConcurrentHashMap<String, X> f8336c;
    ...
    public V(List<NetworkSettings> list, o oVar, String str, String str2, HashSet<ImpressionDataListener> hashSet, IronSourceSegment ironSourceSegment) {
        ...
        this.q = cVar.f8898e > 0;
        this.r = cVar.m;
        this.s = !cVar.n;
        this.u = cVar.l;
        if (this.q) {
            this.f8338e = new C0886h("rewardedVideo", cVar, this);
        }
        this.p = new ad(cVar, this);
        this.f8336c = new ConcurrentHashMap<>();
        ArrayList arrayList = new ArrayList();
        for (NetworkSettings next : list) {
            AbstractAdapter a2 = C0882d.a().a(next, next.getRewardedVideoSettings(), false, false);
            if (a2 != null) {
                C0883e a3 = C0883e.a();
                if (a3.a(a2, a3.f8598b, "rewarded video")) {
                    X x2 = r0;
                    X x3 = new X(str, str2, next, this, oVar2.f8793e, a2);
                    String k2 = x2.k();
                    this.f8336c.put(k2, x2);
                    arrayList.add(k2);
                }
            }
        }
        this.f8339f = new C0887i(arrayList, cVar.f8899f);
        this.f8337d = new n(new ArrayList(this.f8336c.values()));
        for (X next2 : this.f8336c.values()) {
            if (next2.h()) {
                next2.b();
            }
        }
        ...
        this.F = new C0902x(oVar2.i, this);
        a(cVar.i);
    }

    private String a(b bVar) {
        X x2 = this.f8336c.get(bVar.a());
    ...
    private void a(int i2, Map<String, Object> map, boolean z2, boolean z3) {
        ...
        if (z3 && !TextUtils.isEmpty(this.f8340g)) {
            hashMap.put(IronSourceConstants.EVENTS_AUCTION_ID, this.f8340g);
        }
        JSONObject jSONObject = this.f8341h;
        if (jSONObject != null && jSONObject.length() > 0) {
            hashMap.put(IronSourceConstants.EVENTS_GENERIC_PARAMS, this.f8341h);
        }
                ...
                public final void run() {
                    ...
                    AsyncTask.execute(new Runnable() {
                        public final void run() {
                            ...
                            for (X next : V.this.f8336c.values()) {
                                if (next.h()) {
                                    next.f8352b = false;
                                }
                                if (!V.this.f8337d.b(next)) {
                                    if (next.h()) {
                            ...
                            V.this.f8338e.a(ContextProvider.getInstance().getApplicationContext(), hashMap, arrayList, V.this.f8339f, V.this.i, V.this.f8801b);
                        }
                    });
                }
            }, j2);
    ...
    private void e(X x2) {
        String b2 = this.m.get(x2.k()).b();
        C0884f.a();
        X x3 = x2;
        x3.a(b2, this.f8340g, this.f8341h, this.B, this.C, this.i, C0884f.d(b2));
    }
    ...
    private List<b> h() {
        ...
        for (X next : this.f8336c.values()) {
            if (!next.h() && !this.f8337d.b(next)) {
    ...
    public final void a(X x2) {
        synchronized (this) {
            ...
            if (this.q) {
                ...
                if (bVar != null) {
                    C0886h.a(bVar, x2.i(), this.o, this.t);
                    this.n.put(x2.k(), C0887i.a.ISAuctionPerformanceShowedSuccessfully);
                    a(bVar, this.t);
                } else {
                    String k2 = x2.k();
                    b("onRewardedVideoAdOpened showing instance " + k2 + " missing from waterfall");
                    b((int) IronSourceConstants.TROUBLESHOOTING_RV_NOTIFICATIONS_ERROR, a.AnonymousClass1.a(new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceConstants.NOTIFICATIONS_ERROR_SHOWING_NOT_FOUND)}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "Showing missing " + this.A}, new Object[]{IronSourceConstants.EVENTS_EXT1, k2}}));
                }
            }
            this.p.a();
        }
    ...
    public final synchronized void a(com.ironsource.mediationsdk.X r12, java.lang.String r13) {
        /*
            ...
            java.lang.String r0 = r11.f8340g     // Catch:{ all -> 0x0141 }
            r1 = 0
            r2 = 2
            r3 = 1
            ...
            r0.append(r13)     // Catch:{ all -> 0x0141 }
            java.lang.String r13 = r11.f8340g     // Catch:{ all -> 0x0141 }
            r0.append(r13)     // Catch:{ all -> 0x0141 }
        ...
        L_0x0062:
            ...
            com.ironsource.mediationsdk.i$a r6 = com.ironsource.mediationsdk.C0887i.a.ISAuctionPerformanceLoadedSuccessfully     // Catch:{ all -> 0x0141 }
            ...
            com.ironsource.mediationsdk.C0886h.a(r10, r13, r0)     // Catch:{ all -> 0x0141 }
            com.ironsource.mediationsdk.h r5 = r11.f8338e     // Catch:{ all -> 0x0141 }
    ...
    public final void a(IronSourceError ironSourceError, X x2) {
        synchronized (this) {
            ...
            this.y = false;
            this.n.put(x2.k(), C0887i.a.ISAuctionPerformanceFailedToShow);
    ...
    public final void b(com.ironsource.mediationsdk.X r9, java.lang.String r10) {
        /*
            ...
            java.lang.String r1 = r8.f8340g     // Catch:{ all -> 0x0170 }
            ...
            r0.append(r10)     // Catch:{ all -> 0x0170 }
            java.lang.String r10 = r8.f8340g     // Catch:{ all -> 0x0170 }
            r0.append(r10)     // Catch:{ all -> 0x0170 }
        ...
        L_0x0072:
            ...
            com.ironsource.mediationsdk.i$a r4 = com.ironsource.mediationsdk.C0887i.a.ISAuctionPerformanceFailedToLoad     // Catch:{ all -> 0x0170 }
        ...
        L_0x0093:
            ...
            boolean r6 = r5.f8363e     // Catch:{ all -> 0x0170 }
        ...
        L_0x00f8:
            ...
            goto L_0x0132
        L_0x0120:
            com.ironsource.mediationsdk.X$a r6 = r5.f8351a     // Catch:{ all -> 0x0170 }
