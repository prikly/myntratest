...
import com.ironsource.mediationsdk.C0881c;
import com.ironsource.mediationsdk.C0882d;
import com.ironsource.mediationsdk.C0885g;
import com.ironsource.mediationsdk.C0886h;
import com.ironsource.mediationsdk.C0887i;
import com.ironsource.mediationsdk.C0894p;
import com.ironsource.mediationsdk.C0902x;
...
public abstract class e<Smash extends c<?>, Adapter extends BaseAdAdapter<?, ? extends AdapterAdListener>> implements j, com.ironsource.mediationsdk.adunit.b.c, b, com.ironsource.mediationsdk.adunit.e.b, ae, C0881c, C0885g {

    /* renamed from: a  reason: collision with root package name */
    protected com.ironsource.mediationsdk.adunit.e.a<Smash> f8506a;

    /* renamed from: b  reason: collision with root package name */
    protected ConcurrentHashMap<String, com.ironsource.mediationsdk.server.b> f8507b;

    /* renamed from: c  reason: collision with root package name */
    protected ConcurrentHashMap<String, C0887i.a> f8508c;

    /* renamed from: d  reason: collision with root package name */
    protected C0886h f8509d;

    /* renamed from: e  reason: collision with root package name */
    protected C0887i f8510e;
    ...
    public e(a aVar, Set<ImpressionDataListener> set, IronSourceSegment ironSourceSegment) {
        ...
        ironLog.verbose("adUnit = " + aVar.f8485a + ", loading mode = " + aVar.f8492h.f8494a);
        f fVar = new f();
        this.s = ironSourceSegment;
        this.m = aVar;
        this.q = new d(aVar.f8485a, d.b.MEDIATION, this);
        this.r = new b(this.m.f8485a);
        this.o = new c(this.m.f8492h, this);
        a(a.NONE);
        this.z = set;
        this.f8506a = new com.ironsource.mediationsdk.adunit.e.a<>(this.m.f8488d.o, this.m.f8488d.f8900g, this);
        this.q.f8470a.a();
        this.f8507b = new ConcurrentHashMap<>();
        this.f8508c = new ConcurrentHashMap<>();
        this.j = null;
        C0894p.a().a(this.m.f8485a, this.m.f8490f);
        this.f8513h = new JSONObject();
        if (this.m.a()) {
            this.f8509d = new C0886h(this.m.f8485a.toString(), this.m.f8488d, this);
        }
        a(this.m.f8487c, this.m.f8488d.f8899f);
        k();
        l();
        this.u = new f();
        a(a.READY_TO_LOAD);
        this.q.f8470a.a(f.a(fVar));
        this.p = new C0902x(aVar.i, this);
    ...
    private String a(List<com.ironsource.mediationsdk.server.b> list, String str) {
        ...
        this.f8506a.a(this.m.f8492h.f8494a, copyOnWriteArrayList, str);
    ...
    public void a(int i2, String str, boolean z2) {
        ...
        if (this.m.f8492h.a()) {
            if (z2) {
                this.q.f8471b.a(f.a(this.v), i2, str);
            }
            C0894p.a().a(this.m.f8485a, new IronSourceError(i2, str));
        } else {
            if (z2) {
                this.q.f8474e.a(i2, str);
            }
            a(false, false);
        }
        this.o.a();
    ...
    private void a(List<NetworkSettings> list, int i2) {
        ...
        this.f8510e = new C0887i(arrayList, i2);
    }
    ...
    public boolean a(NetworkSettings networkSettings) {
        AdapterBaseInterface a2 = C0882d.a().a(networkSettings, this.m.f8485a);
        return (a2 instanceof AdapterSettingsInterface) && this.f8506a.a(this.m.f8492h.f8494a, networkSettings.getProviderInstanceName(), networkSettings.getProviderTypeForReflection(), ((AdapterSettingsInterface) a2).getLoadWhileShowSupportedState(networkSettings));
    }

    private Smash b(com.ironsource.mediationsdk.server.b bVar, String str) {
        NetworkSettings a2 = this.m.a(bVar.a());
        if (a2 != null) {
            C0882d.a().a(a2, this.m.f8485a);
            BaseAdAdapter a3 = a(a2, this.m.f8485a);
            if (a3 != null) {
                Smash a4 = a(a2, a3, o.a().b(this.m.f8485a), str);
                this.f8507b.put(a4.k(), bVar);
                this.f8508c.put(bVar.a(), C0887i.a.ISAuctionPerformanceDidntAttemptToLoad);
                return a4;
            }
            String str2 = "addSmashToWaterfall - could not load ad adapter for " + a2.getProviderInstanceName();
            IronLog.INTERNAL.error(a(str2));
            this.q.f8474e.b(str2);
        } else {
            String str3 = "could not find matching provider settings for auction response item - item = " + bVar.a();
            IronLog.INTERNAL.error(a(str3));
            this.q.f8474e.c(str3);
        }
        return null;
    }
    ...
    private void c(Smash smash) {
        ...
        String b2 = this.f8507b.get(smash.k()).b();
        smash.b(b2);
        smash.a(b2);
    }
    ...
    private void k() {
        ArrayList arrayList = new ArrayList();
        for (NetworkSettings next : this.m.f8487c) {
            arrayList.add(new m(next.getProviderInstanceName(), next.getMaxAdsPerSession(this.m.f8485a)));
        }
    ...
    private void l() {
        ...
        IronLog.INTERNAL.verbose(a(""));
        for (NetworkSettings next : this.m.f8487c) {
            if (next.isIronSource() || next.isBidder(this.m.f8485a)) {
                HashMap hashMap = new HashMap();
                hashMap.put(DataKeys.USER_ID, this.m.f8486b);
                if (this.m.f8485a == IronSource.AD_UNIT.INTERSTITIAL) {
                    jSONObject = next.getInterstitialSettings();
                } else if (this.m.f8485a == IronSource.AD_UNIT.REWARDED_VIDEO) {
                    jSONObject = next.getRewardedVideoSettings();
                } else {
                    IronLog ironLog = IronLog.INTERNAL;
                    ironLog.error("ad unit not supported - " + this.m.f8485a);
                    jSONObject = new JSONObject();
                }
                hashMap.putAll(com.ironsource.mediationsdk.c.b.a(jSONObject));
                AdData adData = new AdData((String) null, hashMap);
                AdapterBaseInterface a2 = C0882d.a().a(next, this.m.f8485a);
                if (a2 != null) {
                    try {
                        a2.init(adData, ContextProvider.getInstance().getApplicationContext(), (NetworkInitializationListener) null);
                    } catch (Exception e2) {
                        i iVar = this.q.f8474e;
                        iVar.a("initNetworks - exception while calling networkAdapter.init - " + e2);
                    }
                } else {
                    this.q.f8474e.a("initNetworks - could not load network adapter");
                }
            }
        }
    }
    ...
    private List<com.ironsource.mediationsdk.server.b> n() {
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        for (NetworkSettings next : this.m.f8487c) {
            m mVar = new m(next.getProviderInstanceName(), next.getMaxAdsPerSession(this.m.f8485a));
            if (!next.isBidder(this.m.f8485a) && !this.l.b(mVar) && a(next)) {
    ...
    private ArrayList<Smash> p() {
        StringBuilder sb;
        IronLog ironLog = IronLog.INTERNAL;
        ironLog.verbose(a("mWaterfall.size() = " + this.f8506a.a().size()));
        ArrayList<Smash> arrayList = new ArrayList<>();
        int i2 = 0;
        int i3 = 0;
        while (true) {
            if (i2 >= this.f8506a.a().size() || i3 >= this.m.f8489e) {
                break;
            }
            c cVar = (c) this.f8506a.a().get(i2);
            if (cVar.e()) {
                if (cVar.c() || cVar.d()) {
                    IronLog ironLog2 = IronLog.INTERNAL;
                    ironLog2.verbose("smash = " + cVar.l());
                } else if (!cVar.h()) {
                    arrayList.add(cVar);
                } else if (i3 == 0) {
                    sb.append(cVar.k());
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x002f, code lost:
        new java.util.Timer().schedule(new com.ironsource.mediationsdk.adunit.c.e.AnonymousClass1(r5), r2);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001c, code lost:
        r2 = r5.m.f8488d.i - com.ironsource.mediationsdk.utils.f.a(r5.u);
     */
    ...
    private void q() {
        /*
            ...
            monitor-enter(r0)
            com.ironsource.mediationsdk.adunit.c.e$a r1 = r5.n     // Catch:{ all -> 0x0041 }
        ...
        L_0x0016:
            ...
            r5.a((com.ironsource.mediationsdk.adunit.c.e.a) r1)     // Catch:{ all -> 0x0041 }
            monitor-exit(r0)     // Catch:{ all -> 0x0041 }
            com.ironsource.mediationsdk.utils.f r0 = r5.u
            long r0 = com.ironsource.mediationsdk.utils.f.a(r0)
            com.ironsource.mediationsdk.adunit.c.a r2 = r5.m
            com.ironsource.mediationsdk.utils.c r2 = r2.f8488d
            long r2 = r2.i
            long r2 = r2 - r0
            r0 = 0
    ...
    public void r() {
        ...
        AsyncTask.execute(new Runnable() {
            public final void run() {
                ...
                i iVar;
                String str;
                e.this.f8513h = new JSONObject();
                e.this.q.f8472c.a();
                HashMap hashMap = new HashMap();
                ArrayList arrayList = new ArrayList();
                StringBuilder sb = new StringBuilder();
                for (NetworkSettings next : e.this.m.f8487c) {
                    if (!e.this.l.b(new m(next.getProviderInstanceName(), next.getMaxAdsPerSession(e.this.m.f8485a))) && e.this.a(next)) {
                        if (next.isBidder(e.this.m.f8485a)) {
                            AdapterBaseInterface a2 = C0882d.a().a(next, e.this.m.f8485a);
                            if (a2 instanceof AdapterBidderInterface) {
                                try {
                                    ...
                                    if (biddingData != null) {
                                        ...
                                        sb.append(next.getInstanceType(e.this.m.f8485a) + next.getProviderInstanceName() + ",");
                                    } else {
                                        e.this.q.f8474e.d("missing bidding data for " + next.getProviderInstanceName());
                                    }
                                } catch (Exception e2) {
                                    iVar = e.this.q.f8474e;
                ...
                if (hashMap.size() == 0 && arrayList.size() == 0) {
                    ...
                    e.this.q.f8472c.a(0, 1005, "No candidates available for auctioning");
                    e eVar = e.this;
                    IronSource.AD_UNIT ad_unit = eVar.m.f8485a;
                ...
                e.this.q.f8472c.a(sb.toString());
                if (e.this.f8509d != null) {
                    e.this.f8509d.a(ContextProvider.getInstance().getApplicationContext(), hashMap, arrayList, e.this.f8510e, o.a().b(e.this.m.f8485a), e.this.s);
                } else {
    ...
    public final String a(String str) {
        String name = this.m.f8485a.name();
    ...
    public final Map<String, Object> a(com.ironsource.mediationsdk.adunit.b.b bVar) {
        ...
        if (!TextUtils.isEmpty(this.f8506a.f8550b)) {
            hashMap.put(IronSourceConstants.EVENTS_AUCTION_ID, this.f8506a.f8550b);
        }
        JSONObject jSONObject = this.f8513h;
        if (jSONObject != null && jSONObject.length() > 0) {
            hashMap.put(IronSourceConstants.EVENTS_GENERIC_PARAMS, this.f8513h);
        }
        hashMap.put(IronSourceConstants.KEY_SESSION_DEPTH, Integer.valueOf(o.a().b(this.m.f8485a)));
        ...
        if (z2) {
            hashMap.put(IronSourceConstants.AUCTION_TRIALS, Integer.valueOf(this.f8511f));
            if (!TextUtils.isEmpty(this.f8512g)) {
                hashMap.put(IronSourceConstants.AUCTION_FALLBACK, this.f8512g);
            }
        }
        return hashMap;
    }
    ...
    public final void a(int i2, String str, int i3, String str2, long j2) {
        ...
        if (j()) {
            ...
            this.f8513h = new JSONObject();
            m();
            this.q.f8472c.a(j2, i2, str);
            a(a.LOADING);
            o();
            return;
        }
        this.q.f8474e.h("unexpected auction fail - error = " + i2 + ", " + str);
    }
    ...
    public final void a(c<?> cVar) {
        ...
        if (cVar.n() != this.f8506a.f8550b) {
            String str = "onLoadSuccess was invoked with state = " + this.n + " auctionId: " + cVar.n() + " and the current id is " + this.f8506a.f8550b;
            IronLog.INTERNAL.verbose(str);
            this.q.f8474e.i(str);
            return;
        }
        this.f8508c.put(cVar.k(), C0887i.a.ISAuctionPerformanceLoadedSuccessfully);
        if (a(a.LOADING, a.READY_TO_SHOW)) {
            ...
            if (this.m.f8492h.a()) {
                ...
                if (bVar.f8493a == IronSource.AD_UNIT.INTERSTITIAL) {
                    ...
                    aa a2 = aa.a();
                    if (a2.f8438a instanceof RewardedVideoManualListener) {
                        com.ironsource.environment.e.c.f8074a.a(new Runnable() {
                            public final void run(
/*
...
*/
            ...
            long a3 = f.a(this.v);
            if (this.m.f8485a == IronSource.AD_UNIT.REWARDED_VIDEO && this.m.f8492h.f8494a == a.C0085a.MANUAL) {
                z2 = true;
            }
            this.q.f8471b.a(a3, z2);
            if (this.m.f8492h.b()) {
                this.p.a(0);
            }
            if (this.m.a()) {
                com.ironsource.mediationsdk.server.b bVar2 = this.f8507b.get(cVar.k());
                if (bVar2 != null) {
                    C0886h.a(bVar2, cVar.i(), this.i);
                    ArrayList arrayList = new ArrayList();
                    Iterator<Smash> it = this.f8506a.a().iterator();
                    while (it.hasNext()) {
                        arrayList.add(((c) it.next()).k());
                    }
                    C0886h.a((ArrayList<String>) arrayList, this.f8507b, cVar.i(), this.i, bVar2);
                    return;
                }
                String k2 = cVar.k();
                String str2 = "winner instance missing from waterfall - " + k2;
                IronLog.INTERNAL.verbose(a(str2));
                this.q.f8474e.a(1010, str2, k2);
            }
        }
    }
    ...
    public final void a(com.ironsource.mediationsdk.logger.IronSourceError r6, com.ironsource.mediationsdk.adunit.d.a.c<?> r7) {
        /*
            ...
            com.ironsource.mediationsdk.adunit.e.a<Smash> r3 = r5.f8506a     // Catch:{ all -> 0x00ce }
            java.lang.String r3 = r3.f8550b     // Catch:{ all -> 0x00ce }
            ...
            goto L_0x0098
        L_0x003a:
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.i$a> r2 = r5.f8508c     // Catch:{ all -> 0x00ce }
            java.lang.String r3 = r7.k()     // Catch:{ all -> 0x00ce }
            com.ironsource.mediationsdk.i$a r4 = com.ironsource.mediationsdk.C0887i.a.ISAuctionPerformanceFailedToLoad     // Catch:{ all -> 0x00ce }
        ...
        L_0x0052:
            ...
            com.ironsource.mediationsdk.adunit.b.i r2 = r2.f8474e     // Catch:{ all -> 0x00ce }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ce }
        ...
        L_0x0098:
            ...
            r6.append(r7)     // Catch:{ all -> 0x00ce }
            com.ironsource.mediationsdk.adunit.e.a<Smash> r7 = r5.f8506a     // Catch:{ all -> 0x00ce }
            java.lang.String r7 = r7.f8550b     // Catch:{ all -> 0x00ce }
            r6.append(r7)     // Catch:{ all -> 0x00ce }
            ...
            com.ironsource.mediationsdk.adunit.b.i r7 = r7.f8474e     // Catch:{ all -> 0x00ce }
    ...
    public final void a(List<com.ironsource.mediationsdk.server.b> list, String str, com.ironsource.mediationsdk.server.b bVar, JSONObject jSONObject, JSONObject jSONObject2, int i2, long j2, int i3, String str2) {
        ...
        if (j()) {
            ...
            this.f8511f = i2;
            this.i = bVar;
            this.f8513h = jSONObject;
            if (!TextUtils.isEmpty(str2)) {
                this.q.f8474e.b(i3, str2);
            }
            this.w.a(this.m.f8485a, jSONObject2 != null ? jSONObject2.optBoolean("isAdUnitCapped", false) : false);
            if (this.w.a(this.m.f8485a)) {
                this.q.f8472c.c(str);
    ...
    public final void a(boolean r4) {
        /*
            ...
            com.ironsource.mediationsdk.adunit.c.b.a r0 = r0.f8492h
            boolean r0 = r0.a()
    ...
    public final void e() {
        /*
            ...
            com.ironsource.mediationsdk.adunit.c.b.a r1 = r1.f8492h     // Catch:{ all -> 0x0106 }
        ...
        L_0x0034:
            com.ironsource.mediationsdk.adunit.c.a r1 = r5.m     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.b.a r1 = r1.f8492h     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.b.a$a r1 = r1.f8494a     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.b.a$a r3 = com.ironsource.mediationsdk.adunit.c.b.a.C0085a.AUTOMATIC_LOAD_WHILE_SHOW     // Catch:{ all -> 0x0106 }
            r4 = 0
            ...
            com.ironsource.mediationsdk.IronSource$AD_UNIT r3 = r3.f8485a     // Catch:{ all -> 0x0106 }
        ...
        L_0x008a:
            com.ironsource.mediationsdk.p r1 = com.ironsource.mediationsdk.C0894p.a()     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.a r3 = r5.m     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.IronSource$AD_UNIT r3 = r3.f8485a     // Catch:{ all -> 0x0106 }
        ...
        L_0x00a5:
            ...
            r5.f8513h = r1     // Catch:{ all -> 0x0106 }
            r5.s()     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.a r1 = r5.m     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.IronSource$AD_UNIT r1 = r1.f8485a     // Catch:{ all -> 0x0106 }
            ...
            com.ironsource.mediationsdk.adunit.c.b.a r1 = r1.f8492h     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.b.a$a r1 = r1.f8494a     // Catch:{ all -> 0x0106 }
            com.ironsource.mediationsdk.adunit.c.b.a$a r3 = com.ironsource.mediationsdk.adunit.c.b.a.C0085a.MANUAL     // Catch:{ all -> 0x0106 }
            if (r1 != r3) goto L_0x00c2
            goto L_0x00c3
        L_0x00c2:
            r2 = 0
        L_0x00c3:
            ...
            com.ironsource.mediationsdk.adunit.b.h r1 = r1.f8471b     // Catch:{ all -> 0x0106 }
            ...
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.i$a> r1 = r5.f8508c     // Catch:{ all -> 0x0106 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x0106 }
            if (r1 != 0) goto L_0x00ed
            com.ironsource.mediationsdk.i r1 = r5.f8510e     // Catch:{ all -> 0x0106 }
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.i$a> r2 = r5.f8508c     // Catch:{ all -> 0x0106 }
            r1.a((java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.C0887i.a>) r2)     // Catch:{ all -> 0x0106 }
            java.util.concurrent.ConcurrentHashMap<java.lang.String, com.ironsource.mediationsdk.i$a> r1 = r5.f8508c     // Catch:{ all -> 0x0106 }
