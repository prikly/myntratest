...
public final class d {
    ...
    private final int f8475f = -1;

    /* renamed from: g  reason: collision with root package name */
    private IronSource.AD_UNIT f8476g;
    ...
    class a {
        ...
        public final int a(b bVar) {
            return b.MEDIATION.equals(bVar) ? this.f8478a : this.f8479b;
        }
    }
    ...
    public d(IronSource.AD_UNIT ad_unit, b bVar, c cVar) {
        ...
        this.f8470a = new g(this);
        this.f8471b = new h(this);
        this.f8472c = new e(this);
        this.f8473d = new a(this);
        this.f8474e = new i(this);
    }

    private int a(b bVar) {
        try {
            if (IronSource.AD_UNIT.INTERSTITIAL.equals(this.f8476g) && this.k.containsKey(bVar)) {
                return this.k.get(bVar).a(this.f8477h);
            }
            if (!IronSource.AD_UNIT.REWARDED_VIDEO.equals(this.f8476g) || !this.l.containsKey(bVar)) {
                return -1;
            }
            return this.l.get(bVar).a(this.f8477h);
        } catch (Exception e2) {
            e2.printStackTrace();
            return -1;
        }
