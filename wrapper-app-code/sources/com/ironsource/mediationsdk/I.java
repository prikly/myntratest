...
final class I extends C0892n implements j, K, ae, C0881c, C0885g, C0904z {
    private Boolean A;
    private C0902x B;
    ...
    final ConcurrentHashMap<String, J> f8175g;
    ...
    private ConcurrentHashMap<String, C0887i.a> m;
    private b n;
    ...
    public I(List<NetworkSettings> list, o oVar, String str, String str2, HashSet<ImpressionDataListener> hashSet, IronSourceSegment ironSourceSegment) {
        ...
        c cVar = oVar2.l;
        this.y = false;
        this.f8171c = new L(oVar2.l.o, oVar2.l.f8900g);
        this.l = new ConcurrentHashMap<>();
        this.m = new ConcurrentHashMap<>();
        this.z = new Date().getTime();
        boolean z2 = cVar.f8898e > 0;
        this.q = z2;
        if (z2) {
            this.f8173e = new C0886h("rewardedVideo", cVar, this);
        }
        this.p = new ad(cVar, this);
        this.f8175g = new ConcurrentHashMap<>();
        ArrayList arrayList = new ArrayList();
        for (NetworkSettings next : list) {
            AbstractAdapter a2 = C0882d.a().a(next, next.getRewardedVideoSettings(), false, false);
            if (a2 != null) {
                J j2 = r0;
                J j3 = new J(str, str2, next, this, oVar2.f8793e, a2, this.i);
                String k2 = j2.k();
                this.f8175g.put(k2, j2);
                arrayList.add(k2);
            }
        }
        this.f8172d = new C0887i(arrayList, cVar.f8899f);
        this.f8176h = new n(new ArrayList(this.f8175g.values()));
        ...
        this.B = new C0902x(oVar2.i, this);
        a(cVar.i);
    }

    private String a(b bVar) {
        J j2 = this.f8175g.get(bVar.a());
    ...
    private void a(int i2, Map<String, Object> map, boolean z2, boolean z3) {
        ...
        if (z3 && !TextUtils.isEmpty(this.f8171c.f8230b)) {
            hashMap.put(IronSourceConstants.EVENTS_AUCTION_ID, this.f8171c.f8230b);
        }
                        ...
                        if (i.j != a.RV_STATE_AUCTION_IN_PROGRESS) {
                            ...
                            AsyncTask.execute(new Runnable() {
                                public final void run() {
                                    StringBuilder sb;
                                    I.a("makeAuction()");
                                    I.this.f8174f = new Date().getTime();
                                    HashMap hashMap = new HashMap();
                                    ArrayList arrayList = new ArrayList();
                                    StringBuilder sb2 = new StringBuilder();
                                    for (J next : I.this.f8175g.values()) {
                                        if (!I.this.f8176h.b(next) && I.this.f8171c.b(next)) {
                                            if (next.h()) {
                                    ...
                                    I.this.f8173e.a(ContextProvider.getInstance().getApplicationContext(), hashMap, arrayList, I.this.f8172d, I.this.i, I.this.f8801b);
                                }
                            });
                        }
                    }
    ...
    private void a(List<b> list, String str, JSONObject jSONObject) {
        ...
        for (b next : list) {
            sb.append(a(next) + ",");
            J j2 = this.f8175g.get(next.a());
            if (j2 != null) {
                AbstractAdapter a2 = C0882d.a().a(j2.f8362d.f8725a);
                if (a2 != null) {
                    J j3 = new J(j2, this, a2, this.i, str, jSONObject, this.s, this.r);
                    j3.f8363e = true;
                    copyOnWriteArrayList.add(j3);
                    this.l.put(j3.k(), next);
                    this.m.put(next.a(), C0887i.a.ISAuctionPerformanceDidntAttemptToLoad);
                }
            } else {
                a("updateWaterfall() - could not find matching smash for auction response item " + next.a());
            }
        }
        this.f8171c.a(copyOnWriteArrayList, str);
        if (this.f8171c.b()) {
            b((int) IronSourceConstants.TROUBLESHOOTING_RV_WATERFALL_OVERHEAD, a.AnonymousClass1.a(new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "waterfalls hold too many with size=" + this.f8171c.f8229a.size()}}));
        }
    ...
    private List<b> g() {
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        for (J next : this.f8175g.values()) {
            if (!next.h() && !this.f8176h.b(next) && this.f8171c.b(next)) {
    ...
    private void h() {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < this.f8171c.a().size() && i2 < this.w; i3++) {
            J j2 = this.f8171c.a().get(i3);
            if (j2.f8363e) {
                if (!this.x || !j2.h()) {
                    g(j2);
                    i2++;
    ...
    public final void a(com.ironsource.mediationsdk.J r13) {
        /*
            ...
            java.lang.String r1 = r13.f8219b     // Catch:{ all -> 0x0161 }
            com.ironsource.mediationsdk.L r2 = r12.f8171c     // Catch:{ all -> 0x0161 }
            java.lang.String r2 = r2.f8230b     // Catch:{ all -> 0x0161 }
            r3 = 0
            r4 = 2
            r5 = 1
        ...
        L_0x0029:
            ...
            com.ironsource.mediationsdk.i$a r6 = com.ironsource.mediationsdk.C0887i.a.ISAuctionPerformanceLoadedSuccessfully     // Catch:{ all -> 0x0161 }
            ...
            long r6 = r12.f8174f     // Catch:{ all -> 0x0161 }
            long r1 = r1 - r6
            ...
            com.ironsource.mediationsdk.C0886h.a(r11, r1, r2)     // Catch:{ all -> 0x0161 }
            com.ironsource.mediationsdk.h r6 = r12.f8173e     // Catch:{ all -> 0x0161 }
            com.ironsource.mediationsdk.L r1 = r12.f8171c     // Catch:{ all -> 0x0161 }
        ...
        L_0x00a2:
            ...
            java.lang.String r13 = r13.f8219b     // Catch:{ all -> 0x0161 }
            r2.append(r13)     // Catch:{ all -> 0x0161 }
            java.lang.String r13 = " and the current id is "
            r2.append(r13)     // Catch:{ all -> 0x0161 }
            com.ironsource.mediationsdk.L r13 = r12.f8171c     // Catch:{ all -> 0x0161 }
            java.lang.String r13 = r13.f8230b     // Catch:{ all -> 0x0161 }
            r2.append(r13)     // Catch:{ all -> 0x0161 }
        ...
        L_0x0110:
            ...
            r1.<init>(r2)     // Catch:{ all -> 0x0161 }
            java.lang.String r2 = r13.f8219b     // Catch:{ all -> 0x0161 }
            r1.append(r2)     // Catch:{ all -> 0x0161 }
    ...
    public final void a(IronSourceError ironSourceError, J j2) {
        ...
        this.m.put(j2.k(), C0887i.a.ISAuctionPerformanceFailedToShow);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x01e6, code lost:
        if (r9.f8176h.b(r6) == false) goto L_0x0203;
     */
    ...
    public final void a(com.ironsource.mediationsdk.model.Placement r10) {
        ...
        L_0x0136:
            ...
            com.ironsource.mediationsdk.L r5 = r9.f8171c     // Catch:{ all -> 0x0232 }
        ...
        L_0x01d3:
            ...
            com.ironsource.mediationsdk.utils.n r0 = r9.f8176h
            r0.a(r6)
            com.ironsource.mediationsdk.utils.n r0 = r9.f8176h
            boolean r0 = r0.b(r6)
    ...
    public final void a(List<b> list, String str, b bVar, JSONObject jSONObject, JSONObject jSONObject2, int i2, long j2, int i3, String str2) {
        ...
        if (this.f8800a.a(IronSource.AD_UNIT.REWARDED_VIDEO)) {
    ...
    public final boolean a_() {
        if ((!this.u || IronSourceUtils.isNetworkConnected(ContextProvider.getInstance().getApplicationContext())) && this.j == a.RV_STATE_READY_TO_SHOW && !this.y) {
            Iterator<J> it = this.f8171c.a().iterator();
            while (it.hasNext()) {
                if (it.next().b()) {
                    return true;
                }
    ...
    public final void b(com.ironsource.mediationsdk.J r11) {
        /*
            ...
            java.lang.String r2 = r11.f8219b     // Catch:{ all -> 0x0187 }
            com.ironsource.mediationsdk.L r3 = r10.f8171c     // Catch:{ all -> 0x0187 }
            java.lang.String r3 = r3.f8230b     // Catch:{ all -> 0x0187 }
            r4 = 1
            r5 = 0
        ...
        L_0x002d:
            ...
            com.ironsource.mediationsdk.i$a r6 = com.ironsource.mediationsdk.C0887i.a.ISAuctionPerformanceFailedToLoad     // Catch:{ all -> 0x0187 }
            ...
            return
        L_0x0046:
            com.ironsource.mediationsdk.L r2 = r10.f8171c     // Catch:{ all -> 0x0187 }
        ...
        L_0x0052:
            ...
            boolean r8 = r7.f8363e     // Catch:{ all -> 0x0187 }
        ...
        L_0x00b7:
            ...
            goto L_0x00f1
        L_0x00df:
            com.ironsource.mediationsdk.J$a r8 = r7.f8218a     // Catch:{ all -> 0x0187 }
        ...
        L_0x0134:
            ...
            r0.append(r2)     // Catch:{ all -> 0x0187 }
            com.ironsource.mediationsdk.L r2 = r10.f8171c     // Catch:{ all -> 0x0187 }
            java.lang.String r2 = r2.f8230b     // Catch:{ all -> 0x0187 }
            r0.append(r2)     // Catch:{ all -> 0x0187 }
    ...
    public final void c(J j2) {
        ...
        if (this.q) {
            ...
            if (bVar != null) {
                C0886h.a(bVar, j2.i(), this.n, this.v);
                this.m.put(j2.k(), C0887i.a.ISAuctionPerformanceShowedSuccessfully);
                a(bVar, this.v);
            } else {
                String k2 = j2.k();
                b("onRewardedVideoAdOpened showing instance " + k2 + " missing from waterfall");
                b((int) IronSourceConstants.TROUBLESHOOTING_RV_NOTIFICATIONS_ERROR, a.AnonymousClass1.a(new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceConstants.NOTIFICATIONS_ERROR_SHOWING_NOT_FOUND)}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "Showing missing " + this.j}, new Object[]{IronSourceConstants.EVENTS_EXT1, k2}}));
            }
        }
        this.p.a();
    }
    ...
    public final void d(J j2) {
        ...
        if (j2.equals(this.f8171c.f8231c)) {
            this.f8171c.a((J) null);
            if (this.j != a.RV_STATE_READY_TO_SHOW) {
                a(false, (Map<String, Object>) null);
            }
        }
