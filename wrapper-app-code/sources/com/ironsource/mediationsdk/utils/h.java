...
public final class h implements Runnable {
    ...
    private final String f8915a = getClass().getSimpleName();

    /* renamed from: b  reason: collision with root package name */
    private final String f8916b = "bundleId";

    /* renamed from: c  reason: collision with root package name */
    private final String f8917c = "advertisingId";

    /* renamed from: d  reason: collision with root package name */
    private final String f8918d = "isLimitAdTrackingEnabled";

    /* renamed from: e  reason: collision with root package name */
    private final String f8919e = Constants.APP_KEY;

    /* renamed from: f  reason: collision with root package name */
    private final String f8920f = "deviceOS";

    /* renamed from: g  reason: collision with root package name */
    private final String f8921g = "osVersion";

    /* renamed from: h  reason: collision with root package name */
    private final String f8922h = "connectionType";
    ...
    private String i() {
        try {
            ...
            logger.logException(ironSourceTag, this.f8915a + ":getMobileCarrier()", e2);
            return "";
        }
    }
    ...
    private static long k() {
        try {
            ...
            return (((long) statFs.getAvailableBlocks()) * ((long) statFs.getBlockSize())) / d.fc;
        } catch (Exception unused) {
            return -1;
        }
    }
    ...
    private int l() {
        try {
            ...
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, this.f8915a + ":getBatteryLevel()", e2);
            return -1;
        }
    }
    ...
    private int m() {
        try {
            ...
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, this.f8915a + ":getGmtMinutesOffset()", e2);
            return 0;
        }
    }
    ...
    public final void run() {
        /*
            ...
            java.lang.String r1 = r9.d()     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x002e
            java.lang.String r2 = "bundleId"
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
            android.content.Context r2 = r9.E     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = com.ironsource.environment.c.c(r2, r1)     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x002e
        ...
        L_0x002e:
            ...
            com.ironsource.mediationsdk.H r2 = com.ironsource.mediationsdk.H.a()     // Catch:{ Exception -> 0x0245 }
            java.lang.String r2 = r2.j     // Catch:{ Exception -> 0x0245 }
            r0.put(r1, r2)     // Catch:{ Exception -> 0x0245 }
            android.content.Context r1 = r9.E     // Catch:{ Exception -> 0x0245 }
            java.lang.String[] r1 = com.ironsource.environment.h.C(r1)     // Catch:{ Exception -> 0x0245 }
            r2 = 1
            java.lang.String r3 = ""
            r4 = 0
        ...
        L_0x0062:
            ...
            goto L_0x0079
        L_0x006b:
            android.content.Context r5 = r9.E     // Catch:{ Exception -> 0x0245 }
            java.lang.String r5 = com.ironsource.environment.h.x(r5)     // Catch:{ Exception -> 0x0245 }
            boolean r6 = android.text.TextUtils.isEmpty(r5)     // Catch:{ Exception -> 0x0245 }
        ...
        L_0x00bd:
            ...
            r0.put(r1, r3)     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = f()     // Catch:{ Exception -> 0x0245 }
            boolean r3 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r3 != 0) goto L_0x00d5
            java.lang.String r3 = "language"
            r0.put(r3, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x00d5:
            java.lang.String r1 = g()     // Catch:{ Exception -> 0x0245 }
            boolean r3 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r3 != 0) goto L_0x00e4
            java.lang.String r3 = "deviceOEM"
            r0.put(r3, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x00e4:
            java.lang.String r1 = h()     // Catch:{ Exception -> 0x0245 }
            boolean r3 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r3 != 0) goto L_0x00f3
            java.lang.String r3 = "deviceModel"
            r0.put(r3, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x00f3:
            java.lang.String r1 = r9.i()     // Catch:{ Exception -> 0x0245 }
            boolean r3 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r3 != 0) goto L_0x0102
            java.lang.String r3 = "mobileCarrier"
            r0.put(r3, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x0102:
            long r5 = k()     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = "internalFreeMemory"
            java.lang.Long r3 = java.lang.Long.valueOf(r5)     // Catch:{ Exception -> 0x0245 }
            r0.put(r1, r3)     // Catch:{ Exception -> 0x0245 }
            boolean r1 = j()     // Catch:{ Exception -> 0x0245 }
        ...
        L_0x015d:
            ...
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x0168:
            java.lang.String r1 = a()     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x0177
            java.lang.String r2 = "pluginType"
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x0177:
            java.lang.String r1 = b()     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x0186
            java.lang.String r2 = "pluginVersion"
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x0186:
            java.lang.String r1 = c()     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x0195
            java.lang.String r2 = "plugin_fw_v"
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x0195:
            boolean r1 = com.ironsource.environment.h.j()     // Catch:{ Exception -> 0x0245 }
            ...
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x01a8:
            com.ironsource.mediationsdk.H r1 = com.ironsource.mediationsdk.H.a()     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = r1.o     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
        ...
        L_0x01ce:
            android.content.Context r1 = r9.E     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = com.ironsource.environment.h.y(r1)     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
        ...
        L_0x01df:
            ...
            android.content.Context r2 = r9.E     // Catch:{ Exception -> 0x0245 }
            int r2 = com.ironsource.environment.a.AnonymousClass1.c((android.content.Context) r2)     // Catch:{ Exception -> 0x0245 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ Exception -> 0x0245 }
            r0.put(r1, r2)     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = "mnc"
            android.content.Context r2 = r9.E     // Catch:{ Exception -> 0x0245 }
            int r2 = com.ironsource.environment.a.AnonymousClass1.d(r2)     // Catch:{ Exception -> 0x0245 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ Exception -> 0x0245 }
            r0.put(r1, r2)     // Catch:{ Exception -> 0x0245 }
            android.content.Context r1 = r9.E     // Catch:{ Exception -> 0x0245 }
            java.lang.String r1 = com.ironsource.environment.h.j(r1)     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
            if (r2 != 0) goto L_0x020e
            java.lang.String r2 = "icc"
            r0.put(r2, r1)     // Catch:{ Exception -> 0x0245 }
        L_0x020e:
            java.lang.String r1 = com.ironsource.environment.h.c()     // Catch:{ Exception -> 0x0245 }
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0245 }
        ...
        L_0x021d:
            ...
            com.ironsource.mediationsdk.sdk.e r1 = com.ironsource.mediationsdk.sdk.e.a()     // Catch:{ Exception -> 0x0245 }
            r1.a((java.util.Map<java.lang.String, java.lang.Object>) r0)     // Catch:{ Exception -> 0x0245 }
            android.content.Context r0 = r9.E     // Catch:{ Exception -> 0x0245 }
            com.ironsource.mediationsdk.sdk.e r1 = com.ironsource.mediationsdk.sdk.e.a()     // Catch:{ Exception -> 0x0245 }
            org.json.JSONObject r1 = r1.b()     // Catch:{ Exception -> 0x0245 }
