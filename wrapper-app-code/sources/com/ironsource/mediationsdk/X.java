...
public final class X extends Y implements RewardedVideoSmashListener {
    ...
    public X(String str, String str2, NetworkSettings networkSettings, W w2, int i, AbstractAdapter abstractAdapter) {
        ...
        this.k = null;
        this.l = i;
        this.f8361c.addRewardedVideoListener(this);
        this.p = false;
        this.q = false;
        this.f8352b = false;
        this.r = null;
    ...
    public void a(a aVar) {
        a("current state=" + this.f8351a + ", new state=" + aVar);
        synchronized (this.D) {
            this.f8351a = aVar;
        }
    }
    ...
    private boolean q() {
        try {
            return this.f8361c.isRewardedVideoAvailable(this.f8364f);
        } catch (Exception e2) {
    ...
    public final Map<String, Object> a() {
        try {
            if (h()) {
                return this.f8361c.getRewardedVideoBiddingData(this.f8364f);
            }
            return null;
        } catch (Throwable th) {
    ...
    public final void a(Placement placement, int i) {
        ...
        try {
            this.f8361c.showRewardedVideo(this.f8364f, this);
        } catch (Throwable th) {
    ...
    public final void a(String str, String str2, JSONObject jSONObject, int i, String str3, int i2, String str4) {
        a aVar;
        a("loadVideo() auctionId: " + str2 + " state: " + this.f8351a);
        this.i = null;
        this.f8363e = false;
        this.f8352b = true;
        synchronized (this.D) {
            aVar = this.f8351a;
            if (!(this.f8351a == a.LOAD_IN_PROGRESS || this.f8351a == a.SHOW_IN_PROGRESS)) {
        ...
        if (aVar == a.LOAD_IN_PROGRESS) {
                ...
                timer.schedule(new TimerTask() {
                    public final void run() {
                        ...
                        synchronized (X.this.D) {
                            if (X.this.f8351a != a.LOAD_IN_PROGRESS) {
                                if (X.this.f8351a != a.INIT_IN_PROGRESS) {
                                    i = 0;
                                    z = false;
                                }
                            }
                        ...
                        if (z) {
                            ...
                            X.this.b(IronSourceConstants.RV_INSTANCE_LOAD_FAILED_REASON, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(i)}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, str2}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(X.this.t())}});
                            W e2 = X.this.j;
                            X x = X.this;
                            e2.b(x, x.t);
                            return;
                        }
                        X.this.b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_LOAD_FAILED_TIMEOUT)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(X.this.t())}, new Object[]{IronSourceConstants.EVENTS_EXT1, X.this.f8351a.name()}});
                    }
                }, (long) (this.l * 1000));
            }
            ...
            try {
                if (h()) {
                    this.f8361c.loadRewardedVideoForBidding(this.f8364f, this, str);
                } else if (aVar == a.NO_INIT) {
                    r();
                    this.f8361c.initRewardedVideo(this.m, this.n, this.f8364f, this);
                } else {
                    this.f8361c.fetchRewardedVideoForAutomaticLoad(this.f8364f, this);
                }
            } catch (Throwable th) {
    ...
    public final void b() {
        ...
        r();
        try {
            this.f8361c.initRewardedVideoForBidding(this.m, this.n, this.f8364f, this);
        } catch (Throwable th) {
    ...
    public final boolean c() {
        return h() ? this.f8352b && this.f8351a == a.LOADED && q() : q();
    }

    public final void f() {
        this.f8361c.setMediationState(C0880b.a.CAPPED_PER_SESSION, IronSourceConstants.AD_UNIT_RV_MEDIATION_STATE);
    ...
    public final void onRewardedVideoAdClosed() {
        /*
            ...
            monitor-enter(r0)
            com.ironsource.mediationsdk.X$a r1 = r12.f8351a     // Catch:{ all -> 0x0077 }
            ...
            com.ironsource.mediationsdk.X$a r5 = r12.f8351a     // Catch:{ all -> 0x0077 }
    ...
    public final void onRewardedVideoAdShowFailed(IronSourceError ironSourceError) {
        ...
        synchronized (this.D) {
            if (this.f8351a != a.SHOW_IN_PROGRESS) {
                Object[] objArr = {IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceConstants.errorCode_showFailed)};
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "showFailed: " + this.f8351a}});
                return;
            }
            a(a.NOT_LOADED);
    ...
    public final void onRewardedVideoAvailabilityChanged(boolean z2) {
        boolean z3;
        a("onRewardedVideoAvailabilityChanged available=" + z2 + " state=" + this.f8351a.name());
        synchronized (this.D) {
            if (this.f8351a == a.LOAD_IN_PROGRESS) {
        ...
        if (!z3) {
            ...
            b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_TRUE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_EXT1, this.f8351a.name()}});
        } else {
            b(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_RV_LOAD_UNEXPECTED_CALLBACK)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(t())}, new Object[]{IronSourceConstants.EVENTS_EXT1, this.f8351a.name()}});
        }
    }
    ...
    public final void onRewardedVideoInitFailed(IronSourceError ironSourceError) {
        ...
        synchronized (this.D) {
            if (this.f8351a != a.INIT_IN_PROGRESS) {
                Object[] objArr = {IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceConstants.errorCode_initFailed)};
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "initFailed: " + this.f8351a}});
                return;
            }
            a(a.NO_INIT);
            this.j.b(this, this.t);
    ...
    public final void onRewardedVideoInitSuccess() {
        ...
        synchronized (this.D) {
            if (this.f8351a != a.INIT_IN_PROGRESS) {
                ...
                b(IronSourceConstants.RV_SMASH_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "initSuccess: " + this.f8351a}});
                return;
            }
            a(a.NOT_LOADED);
        }
