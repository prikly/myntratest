...
public final class P extends C0892n implements Q, b.a, C0885g {

    /* renamed from: c  reason: collision with root package name */
    com.ironsource.mediationsdk.c.b f8279c;

    /* renamed from: d  reason: collision with root package name */
    b f8280d;

    /* renamed from: e  reason: collision with root package name */
    IronSourceBannerLayout f8281e;
    ...
    C0886h j;
    C0887i k;
    ConcurrentHashMap<String, C0887i.a> l;
    long m;
    private a n = a.NONE;
    private int o;
    ...
    public P(List<NetworkSettings> list, com.ironsource.mediationsdk.c.b bVar, HashSet<ImpressionDataListener> hashSet, IronSourceSegment ironSourceSegment) {
        ...
        this.f8279c = bVar;
        this.f8280d = new b(bVar.g());
        this.i = new ConcurrentHashMap<>();
        this.p = new CopyOnWriteArrayList<>();
        this.v = new ConcurrentHashMap<>();
        this.l = new ConcurrentHashMap<>();
        this.f8284h = o.a().b(3);
        C0888j.a().f8651a = this.f8279c.e();
        if (this.f8279c.c()) {
            this.j = new C0886h("banner", this.f8279c.h(), this);
        }
        a(list);
        b(list);
    ...
    static /* synthetic */ ISBannerSize a(P p2) {
        IronSourceBannerLayout ironSourceBannerLayout = p2.f8281e;
        if (ironSourceBannerLayout == null || ironSourceBannerLayout.getSize() == null) {
            return null;
        }
        return p2.f8281e.getSize().isSmart() ? AdapterUtils.isLargeScreen(ContextProvider.getInstance().getCurrentActiveActivity()) ? ISBannerSize.f8185a : ISBannerSize.BANNER : p2.f8281e.getSize();
    }

    /* access modifiers changed from: private */
    public void a(int i2, Object[][] objArr) {
        a(i2, objArr, this.f8284h);
    }

    private void a(R r2, com.ironsource.mediationsdk.server.b bVar) {
        C0886h.a(bVar, r2.i(), this.u, e());
        a(this.v.get(r2.k()), e());
    }
    ...
    private void a(List<NetworkSettings> list) {
        ...
        this.k = new C0887i(arrayList, this.f8279c.h().f8899f);
    }
    ...
    public void a(boolean z) {
        ...
        if (a(a.STARTED_LOADING, this.f8279c.c() ? z ? a.AUCTION : a.FIRST_AUCTION : z ? a.RELOADING : a.LOADING)) {
    ...
    private void b(List<NetworkSettings> list) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            if (a2 != null) {
                R r2 = new R(this.f8279c, this, networkSettings, a2, this.f8284h, n());
                this.i.put(r2.k(), r2);
            } else {
                IronLog ironLog = IronLog.INTERNAL;
    ...
    private String c(List<com.ironsource.mediationsdk.server.b> list) {
        ...
        while (i4 < list.size()) {
            ...
            if (r2 != null) {
                AbstractAdapter a2 = C0882d.a().a(r2.f8362d.f8725a);
                if (a2 != null) {
                    com.ironsource.mediationsdk.c.b bVar2 = this.f8279c;
                    NetworkSettings networkSettings = r2.f8362d.f8725a;
                    int i5 = this.f8284h;
                    String str = this.q;
                    ...
                    i2 = i4;
                    i3 = 1;
                    R r4 = new R(bVar2, this, networkSettings, a2, i5, str, jSONObject, i6, str2, n());
                    r3.f8363e = true;
                    this.p.add(r3);
                    this.v.put(r3.k(), bVar);
                    this.l.put(bVar.a(), C0887i.a.ISAuctionPerformanceDidntAttemptToLoad);
                } else {
                    i2 = i4;
                    i3 = 1;
                }
                ...
                i3 = 1;
                IronLog ironLog2 = IronLog.INTERNAL;
                ironLog2.error("could not find matching smash for auction response item - item = " + bVar.a());
            }
        ...
        while (true) {
            ...
            if (i2 < this.p.size()) {
                ...
                if (r2.f8363e) {
                    ...
                    this.o = i2 + 1;
                    IronSourceBannerLayout ironSourceBannerLayout = this.f8281e;
                    if (ironSourceBannerLayout != null && !ironSourceBannerLayout.isDestroyed()) {
                        if (r2.h()) {
                            str = this.v.get(r2.k()).b();
                            r2.b(str);
                        }
                        r2.a(this.f8281e.a(), this.f8282f, str);
                        return;
                    }
                    return;
                }
                ...
                if (a(a.LOADING, a.READY_TO_LOAD)) {
                    a((int) IronSourceConstants.BN_CALLBACK_LOAD_ERROR, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, 606}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, str2}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(com.ironsource.mediationsdk.utils.f.a(this.x))}});
                    C0888j.a().a(this.f8281e, new IronSourceError(606, str2));
                    return;
    ...
    public final void a() {
        /*
            ...
            com.ironsource.mediationsdk.IronSourceBannerLayout r0 = r6.f8281e
        ...
        L_0x0038:
            ...
            r0.<init>()
            com.ironsource.mediationsdk.IronSourceBannerLayout r3 = r6.f8281e
        ...
        L_0x008b:
            ...
            com.ironsource.mediationsdk.b.b r0 = r6.f8280d
            r0.a(r6)
        L_0x00af:
            return
        */
    ...
    public final void a(final IronSourceBannerLayout ironSourceBannerLayout, final f fVar) {
        ...
        if (!a(a.READY_TO_LOAD, a.STARTED_LOADING)) {
            ...
            AnonymousClass1 r0 = new C0891m.b() {
                public final void a() {
                    IronLog ironLog = IronLog.INTERNAL;
                    ironLog.verbose("placement = " + fVar.getPlacementName());
                    P.this.f8281e = ironSourceBannerLayout;
                    P.this.f8282f = fVar;
    ...
    public final void a(R r2, View view, FrameLayout.LayoutParams layoutParams) {
        ...
        if (r3.f8301a != this.q) {
            IronLog ironLog2 = IronLog.INTERNAL;
            ironLog2.error("invoked with auctionId: " + r3.f8301a + " and the current id is " + this.q);
            Object[] objArr2 = {IronSourceConstants.EVENTS_ERROR_CODE, 2};
            r3.a((int) IronSourceConstants.TROUBLESHOOTING_BN_MANAGER_UNEXPECTED_STATE, new Object[][]{objArr2, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "Wrong auction id " + r3.f8301a + " State - " + this.n}, new Object[]{IronSourceConstants.EVENTS_EXT1, r2.k()}});
        } else if (k()) {
            R r4 = this.f8283g;
            if (r4 != null) {
                r4.d();
            ...
            this.l.put(r2.k(), C0887i.a.ISAuctionPerformanceShowedSuccessfully);
            if (this.f8279c.c()) {
                com.ironsource.mediationsdk.server.b bVar = this.v.get(r2.k());
                if (bVar != null) {
                    C0886h.a(bVar, r2.i(), this.u);
    ...
    public final void a(IronSourceError ironSourceError, R r2) {
        ...
        if (r2.f8301a != this.q) {
            IronLog ironLog2 = IronLog.INTERNAL;
            ironLog2.error("invoked with auctionId: " + r2.f8301a + " and the current id is " + this.q);
            Object[] objArr = {IronSourceConstants.EVENTS_ERROR_CODE, 3};
            r2.a((int) IronSourceConstants.TROUBLESHOOTING_BN_MANAGER_UNEXPECTED_STATE, new Object[][]{objArr, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, "Wrong auction " + r2.f8301a + " State - " + this.n}, new Object[]{IronSourceConstants.EVENTS_EXT1, r2.k()}});
        } else if (k()) {
            this.l.put(r2.k(), C0887i.a.ISAuctionPerformanceFailedToLoad);
            f();
        } else {
            IronLog ironLog3 = IronLog.INTERNAL;
    ...
    public final void a(List<com.ironsource.mediationsdk.server.b> list, String str, com.ironsource.mediationsdk.server.b bVar, JSONObject jSONObject, JSONObject jSONObject2, int i2, long j2, int i3, String str2) {
        ...
        if (l()) {
            ...
            if (this.f8800a.a(IronSource.AD_UNIT.BANNER)) {
                a((int) IronSourceConstants.BN_AD_UNIT_CAPPED, new Object[][]{new Object[]{IronSourceConstants.EVENTS_AUCTION_ID, str}});
                a(a.READY_TO_LOAD);
                C0888j.a().a(this.f8281e, new IronSourceError(IronSourceError.ERROR_AD_UNIT_CAPPED, "Ad unit is capped"));
                return;
            }
    ...
    public void d() {
        ...
        AsyncTask.execute(new Runnable() {
            public final void run() {
                ...
                P p2 = P.this;
                long d2 = p2.f8279c.d() - (new Date().getTime() - p2.m);
                if (d2 > 0) {
                    IronLog ironLog = IronLog.INTERNAL;
                    ironLog.verbose("waiting before auction - timeToWaitBeforeAuction = " + d2);
                ...
                if (!z) {
                    ...
                    C0891m.a(P.this.e(), P.this.i, new C0891m.a() {
                        public final void a(Map<String, Object> map, List<String> list, StringBuilder sb) {
                            ...
                            if (map.size() == 0 && list.size() == 0) {
                                ...
                                if (P.this.a(a.AUCTION, a.LOADED)) {
                                    P.this.f8280d.a(P.this);
                                    return;
                                }
                                C0888j.a().a(P.this.f8281e, new IronSourceError(1005, "No candidates available for auctioning"));
                            ...
                            if (P.this.j != null) {
                                C0886h hVar = P.this.j;
                                Context applicationContext = ContextProvider.getInstance().getApplicationContext();
                                C0887i iVar = P.this.k;
                                int i = P.this.f8284h;
                                IronSourceSegment ironSourceSegment = P.this.f8801b;
                                hVar.f8614a = P.a(P.this);
    ...
    public final void e(R r2) {
        ...
        IronLog.INTERNAL.verbose(r2.p());
        if (m()) {
            if (this.f8279c.c() && this.f8279c.h().s && (bVar = this.v.get(r2.k())) != null) {
                a(r2, bVar);
            }
