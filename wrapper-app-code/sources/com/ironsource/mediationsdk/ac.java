...
public final class ac extends C0880b implements RewardedVideoSmashListener {
    JSONObject r;
    ...
    public void a(int i, Object[][] objArr) {
        JSONObject providerAdditionalData = IronSourceUtils.getProviderAdditionalData((C0880b) this);
        if (objArr != null) {
            try {
    ...
    public final void g() {
        this.f8571h = 0;
        a(o() ? C0880b.a.AVAILABLE : C0880b.a.NOT_AVAILABLE);
    }
            ...
            this.i.schedule(new TimerTask() {
                public final void run() {
                    synchronized (ac.this) {
                        cancel();
                        if (ac.this.s != null) {
                            String str = "Timeout for " + ac.this.f8567d;
                            ac.this.q.log(IronSourceLogger.IronSourceTag.INTERNAL, str, 0);
                            ac.this.a(C0880b.a.NOT_AVAILABLE);
                            long time = new Date().getTime() - ac.this.u;
                            if (ac.this.t.compareAndSet(true, false)) {
                                ac.this.a(IronSourceConstants.RV_INSTANCE_LOAD_FAILED, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_LOAD_FAILED_TIMEOUT)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(time)}});
                                ac.this.a(IronSourceConstants.RV_INSTANCE_LOAD_FAILED_REASON, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_LOAD_FAILED_TIMEOUT)}, new Object[]{IronSourceConstants.EVENTS_ERROR_REASON, str}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(time)}});
                            } else {
                                ac.this.a(IronSourceConstants.RV_INSTANCE_AVAILABILITY_FALSE, new Object[][]{new Object[]{IronSourceConstants.EVENTS_ERROR_CODE, Integer.valueOf(IronSourceError.ERROR_LOAD_FAILED_TIMEOUT)}, new Object[]{IronSourceConstants.EVENTS_DURATION, Long.valueOf(time)}});
                            }
    ...
    public final void n() {
        this.p = null;
        if (this.f8565b != null) {
            if (!(this.f8564a == C0880b.a.CAPPED_PER_DAY || this.f8564a == C0880b.a.CAPPED_PER_SESSION)) {
                this.t.set(true);
                this.u = new Date().getTime();
            }
            IronSourceLoggerManager ironSourceLoggerManager = this.q;
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
            ironSourceLoggerManager.log(ironSourceTag, this.f8567d + ":fetchRewardedVideoForAutomaticLoad()", 1);
            this.f8565b.fetchRewardedVideoForAutomaticLoad(this.r, this);
        }
    }
    ...
    public final boolean o() {
        ...
        IronSourceLoggerManager ironSourceLoggerManager = this.q;
        IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.INTERNAL;
        ironSourceLoggerManager.log(ironSourceTag, this.f8567d + ":isRewardedVideoAvailable()", 1);
        return this.f8565b.isRewardedVideoAvailable(this.r);
    }
    ...
    public final synchronized void onRewardedVideoAvailabilityChanged(boolean r9) {
        ...
        L_0x0041:
            ...
            com.ironsource.mediationsdk.b$a r0 = r8.f8564a     // Catch:{ all -> 0x00b4 }
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0880b.a.AVAILABLE     // Catch:{ all -> 0x00b4 }
            if (r0 != r1) goto L_0x0057
        L_0x004f:
            if (r9 != 0) goto L_0x0078
            com.ironsource.mediationsdk.b$a r0 = r8.f8564a     // Catch:{ all -> 0x00b4 }
            com.ironsource.mediationsdk.b$a r1 = com.ironsource.mediationsdk.C0880b.a.NOT_AVAILABLE     // Catch:{ all -> 0x00b4 }
            if (r0 == r1) goto L_0x0078
        L_0x0057:
            if (r9 == 0) goto L_0x005c
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0880b.a.AVAILABLE     // Catch:{ all -> 0x00b4 }
            goto L_0x005e
        L_0x005c:
            com.ironsource.mediationsdk.b$a r0 = com.ironsource.mediationsdk.C0880b.a.NOT_AVAILABLE     // Catch:{ all -> 0x00b4 }
        L_0x005e:
        ...
        L_0x0078:
            ...
            java.lang.String r2 = r8.f8567d     // Catch:{ all -> 0x00b4 }
        ...
        L_0x009a:
            ...
            r0.<init>()     // Catch:{ all -> 0x00b4 }
            java.lang.String r1 = r8.f8567d     // Catch:{ all -> 0x00b4 }
