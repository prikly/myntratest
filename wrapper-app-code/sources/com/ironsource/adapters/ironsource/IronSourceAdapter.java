...
public class IronSourceAdapter extends AbstractAdapter implements ContextProvider.a, j, e {
        ...
        if (mDidInitSdk.compareAndSet(false, true)) {
            ...
            IronSourceNetwork.setInitListener(new d() {
                public void onFail(com.ironsource.sdk.g.e eVar) {
                    IronLog ironLog = IronLog.ADAPTER_API;
                    ironLog.verbose("OnNetworkSDKInitListener fail - code:" + eVar.f9556b + " message:" + eVar.f9555a);
                }
    ...
    private void loadAdInternal(String str, String str2, boolean z, boolean z2, boolean z3) {
        ...
        if (str2 != null) {
            C0884f.a();
            hashMap.put("adm", C0884f.c(str2));
            C0884f.a();
            hashMap.putAll(C0884f.b(str2));
        }
        b adInstance = getAdInstance(str, z, z2, z3);
        printInstanceExtraParams(hashMap);
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + adInstance.f9011c);
    ...
    private void showAdInternal(b bVar, int i) {
        ...
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + bVar.f9011c + " showParams=" + hashMap);
    ...
    public void destroyBanner(JSONObject jSONObject) {
        ...
        if (aVar != null) {
            try {
                if (aVar.f9039a == null || aVar.f9039a.f9048c == null) {
                ...
                IronLog ironLog2 = IronLog.ADAPTER_API;
                ironLog2.verbose("destroyBanner failed: " + e2.getMessage());
            }
        }
    }
        ...
        postOnUIThread(new Runnable() {
            public void run() {
                try {
                    ...
                    access$100.a(false, ErrorBuilder.buildInitFailedError("Adapter initialization failure - " + IronSourceAdapter.this.getProviderName() + " - " + e2.getMessage(), IronSourceConstants.OFFERWALL_AD_UNIT));
                }
            }
        });
    }
    ...
    public void loadBannerForBidding(IronSourceBannerLayout ironSourceBannerLayout, JSONObject jSONObject, BannerSmashListener bannerSmashListener, String str) {
        ...
        try {
            ...
            if (str != null) {
                C0884f.a();
                hashMap.put("adm", C0884f.c(str));
                C0884f.a();
                hashMap.putAll(C0884f.b(str));
                printInstanceExtraParams(hashMap);
            }
