...
public final class c {
    ...
    private static final Handler f8075b = new Handler(Looper.getMainLooper());

    /* renamed from: c  reason: collision with root package name */
    private static final b f8076c;
    ...
    public static void a(Runnable runnable, long j) {
        ...
        f8075b.postDelayed(runnable, j);
    }

    public static void b(Runnable runnable) {
        Intrinsics.checkNotNullParameter(runnable, "action");
        f8075b.removeCallbacks(runnable);
    }
