...
public class k {
    ...
    private static final String f8089a = k.class.getSimpleName();

    /* renamed from: b  reason: collision with root package name */
    private static final ArrayList<String> f8090b = new ArrayList<String>() {
        {
    ...
    private static JSONObject a(Context context, ArrayList<String> arrayList) {
        ...
        try {
            ...
            Log.d(f8089a, "Error while extracting packages installation data");
        }
        return jSONObject;
    }

    public static boolean a(Context context) {
        JSONObject a2 = a(context, f8090b);
