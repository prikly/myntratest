...
public final class d {
    ...
    private static void c() {
        ...
        hashMap.put("omidVersion", a.f9475a);
        hashMap.put("omidPartnerVersion", "7");
        f9603b.a((Map<String, String>) hashMap);
    }
    ...
    private static void d() {
        if (IronSourceQaProperties.isInitialized()) {
            f9603b.a(IronSourceQaProperties.getInstance().getParameters());
        }
    }
    ...
    public final JSONObject b(Context context) {
        ...
        d(context);
        try {
            return new JSONObject(this.f9604a.toString());
        } catch (Exception e2) {
            e2.printStackTrace();
