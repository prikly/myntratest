...
public final class a {
    ...
    private static final HashMap<String, Long> f9600b = new HashMap<>();
    ...
    public static boolean a(String str, long j) {
        Intrinsics.checkNotNullParameter(str, "instance");
        if ((str.length() == 0) || f9600b.containsKey(str)) {
            return false;
        }
        f9600b.put(str, Long.valueOf(j));
        return true;
    }

    public static boolean b(String str) {
        Intrinsics.checkNotNullParameter(str, "instance");
        if (f9600b.get(str) == null) {
            return false;
        }
        f9600b.remove(str);
        return true;
