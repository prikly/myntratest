...
public class d implements c {
    ...
    public void a(long j, Thread thread, Throwable th, String str, File file, String str2, boolean z) {
        ...
        final File file2 = new File(o.a(this.f10610a), str3);
        a.a().a(file2.getName());
        file2.mkdirs();
        i.f(file2);
        final boolean c2 = v.c(th);
        ...
        a a2 = f.a().a(CrashType.JAVA, (a) null, new c.a() {
            ...
            public a a(int i2, a aVar) {
                ...
                Object b2;
                String str2;
                this.f10611a = SystemClock.uptimeMillis();
                if (i2 != 0) {
                    if (i2 == 1) {
                        ...
                        if (i2 == 3) {
                            ...
                            com.apm.insight.l.a.a(d.this.f10610a, aVar.h());
                        }
                        aVar.a(str2, b2);
                    } else {
                        if (c2) {
                ...
                aVar.a("isOOM", (Object) Boolean.valueOf(c2));
