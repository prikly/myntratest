...
public class a {
    ...
    protected JSONObject f10560a;

    /* renamed from: b  reason: collision with root package name */
    protected Header f10561b;

    public a() {
        this.f10560a = new JSONObject();
    }

    public a(JSONObject jSONObject) {
        this.f10560a = jSONObject;
    }
    ...
    public static void a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        String str = "1M - 64M";
        String str2 = optLong <= 1024 ? "0 - 1K" : optLong <= 65536 ? "1K - 64K" : optLong <= 524288 ? "64K - 512K" : optLong <= d.fc ? "512K - 1M" : optLong <= 67108864 ? str : "64M - ";
        String str3 = optLong3 <= 1024 ? "0 - 1K" : optLong3 <= 65536 ? "1K - 64K" : optLong3 <= 524288 ? "64K - 512K" : optLong3 <= d.fc ? "512K - 1M" : optLong3 <= 67108864 ? str : "64M - ";
        if (optLong2 <= 1024) {
            str = "0 - 1K";
    ...
    public a a(int i, String str) {
        try {
            this.f10560a.put("miniapp_id", i);
            this.f10560a.put("miniapp_version", str);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
        return this;
    ...
    public a a(Map<String, Integer> map) {
        ...
        if (map == null) {
            try {
                this.f10560a.put("plugin_info", jSONArray);
                return this;
    ...
    public boolean a() {
        Object opt = h().opt("data");
        return opt instanceof JSONArray ? !l.a(((JSONArray) opt).optJSONObject(0), "logcat") : !l.a(this.f10560a, "logcat");
    }
    ...
    public a b(Map<Integer, String> map) {
        if (map != null && map.size() > 0) {
            ...
            try {
                this.f10560a.put("sdk_info", jSONObject);
    ...
    public a c(Map<? extends String, ? extends String> map) {
        if (map != null) {
            ...
            for (Map.Entry next : map.entrySet()) {
                try {
                    e2.put((String) next.getKey(), next.getValue());
                } catch (JSONException unused) {
                }
            }
            a("filters", (Object) e2);
