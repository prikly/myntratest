...
public final class Header {
    ...
    private static final String[] f10554a = {"version_code", "manifest_version_code", "aid", "update_version_code"};

    /* renamed from: d  reason: collision with root package name */
    private static String f10555d = null;
    ...
    private JSONObject f10559c = new JSONObject();
        ...
        if (f10555d == null) {
            try {
                ...
                if (TextUtils.isEmpty(sb.toString())) {
                    f10555d = DtbDeviceDataRetriever.ORIENTATION_UNKNOWN;
                }
                f10555d = sb.toString();
            } catch (Exception e2) {
                q.b((Throwable) e2);
    ...
    public org.json.JSONObject a(java.util.Map<java.lang.String, java.lang.Object> r11) {
        /*
            ...
            org.json.JSONObject r11 = r10.f10559c     // Catch:{ all -> 0x00b4 }
            return r11
        L_0x000d:
        ...
        L_0x0015:
            ...
            org.json.JSONObject r6 = r10.f10559c     // Catch:{ all -> 0x00b4 }
            ...
            goto L_0x0015
        L_0x003f:
            java.lang.String[] r4 = f10554a     // Catch:{ all -> 0x00b4 }
        ...
        L_0x0043:
            ...
            org.json.JSONObject r9 = r10.f10559c     // Catch:{ all -> 0x005f }
            r9.put(r7, r8)     // Catch:{ all -> 0x005f }
            goto L_0x0068
        L_0x005f:
            org.json.JSONObject r8 = r10.f10559c     // Catch:{ all -> 0x00b4 }
        ...
        L_0x006b:
            ...
            org.json.JSONObject r4 = r10.f10559c     // Catch:{ all -> 0x0088 }
            r4.put(r0, r1)     // Catch:{ all -> 0x0088 }
        L_0x0088:
            boolean r0 = r11.containsKey(r3)     // Catch:{ all -> 0x00b4 }
            if (r0 == 0) goto L_0x009e
            org.json.JSONObject r0 = r10.f10559c     // Catch:{ all -> 0x00b4 }
        ...
        L_0x00b4:
            org.json.JSONObject r11 = r10.f10559c
            return r11
        */
    ...
    public JSONObject a(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                this.f10559c.put(next, jSONObject.opt(next));
            } catch (JSONException e2) {
                e2.printStackTrace();
            }
        }
    ...
    public JSONObject d() {
        try {
            this.f10559c.put("device_id", h.c().a());
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
        return this.f10559c;
