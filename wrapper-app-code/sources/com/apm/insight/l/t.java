...
public class t {
    ...
    private static final CharSequence f10763a = "sony";

    /* renamed from: b  reason: collision with root package name */
    private static final CharSequence f10764b = "amigo";

    /* renamed from: c  reason: collision with root package name */
    private static final CharSequence f10765c = "funtouch";
    ...
    public static boolean e() {
        ...
        return !TextUtils.isEmpty(a2) && a2.toLowerCase(Locale.getDefault()).contains(f10765c);
    }

    public static boolean f() {
        return !TextUtils.isEmpty(Build.DISPLAY) && Build.DISPLAY.toLowerCase(Locale.getDefault()).contains(f10764b);
    }
