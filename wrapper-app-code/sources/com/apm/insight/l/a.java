...
public final class a {
    ...
    private static String f10732a = null;

    /* renamed from: b  reason: collision with root package name */
    private static Class<?> f10733b = null;

    /* renamed from: c  reason: collision with root package name */
    private static Field f10734c = null;

    /* renamed from: d  reason: collision with root package name */
    private static Field f10735d = null;

    /* renamed from: e  reason: collision with root package name */
    private static boolean f10736e = false;
    ...
    public static String d(Context context) {
        Class<?> g2 = g(context);
        if (f10734c == null && g2 != null) {
            try {
                f10734c = g2.getDeclaredField("VERSION_NAME");
    ...
    public static int e(Context context) {
        Class<?> g2 = g(context);
        if (f10735d == null && g2 != null) {
            try {
                f10735d = g2.getDeclaredField("VERSION_CODE");
            } catch (NoSuchFieldException unused) {
            }
        }
        Field field = f10735d;
    ...
    private static Class<?> g(Context context) {
        if (f10733b == null && !f10736e) {
            try {
                f10733b = Class.forName(context.getPackageName() + ".BuildConfig");
