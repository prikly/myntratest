...
public class b {
    ...
    public static HashMap<String, String> f10630a;
        ...
        p.b().a((Runnable) new Runnable() {
            ...
            public void run() {
                ...
                if (!b.f(str)) {
                    ...
                    if (str3 == null) {
                        b.f10630a.put(file.getName(), "1.3.8.nourl-alpha.0");
                        try {
            ...
            if (list != null) {
                for (String str : list) {
                    if (str.endsWith(".ver")) {
                        ...
                        try {
                            f10630a.put(substring, i.c(file.getAbsolutePath() + "/" + str));
                        } catch (Throwable th) {
                            com.apm.insight.b.a().a("NPTH_CATCH", th);
                        }
    ...
    public static boolean f(String str) {
        return "1.3.8.nourl-alpha.0".equals(f10630a.get(str)) && new File(a(str)).exists();
    }
}
