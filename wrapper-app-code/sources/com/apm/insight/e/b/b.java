...
public class b extends a<a> {
    ...
    public ContentValues a(a aVar) {
        ...
        contentValues.put("path", aVar.f10550a);
        contentValues.put("insert_time", Long.valueOf(aVar.f10551b));
    ...
    public void a(SQLiteDatabase sQLiteDatabase, a aVar) {
        if (aVar != null && !a(sQLiteDatabase, aVar.f10550a)) {
            super.a(sQLiteDatabase, aVar);
            try {
                sQLiteDatabase.execSQL("delete from " + this.f10553b + " where " + "_id" + " in (select " + "_id" + " from " + this.f10553b + " order by " + "insert_time" + " desc limit 1000 offset " + 500 + ")");
            } catch (Exception e2) {
                q.b((Throwable) e2);
            }
        }
    ...
    public boolean a(android.database.sqlite.SQLiteDatabase r11, java.lang.String r12) {
        ...
        L_0x000a:
            r1 = 1
            java.lang.String r3 = r10.f10553b     // Catch:{ all -> 0x0026 }
            r4 = 0
