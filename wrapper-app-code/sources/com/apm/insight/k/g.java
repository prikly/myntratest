...
public final class g {
    ...
    private static final ConcurrentHashMap<Object, ConcurrentLinkedQueue<c>> f10706a = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public static final HashMap<Object, HashMap<String, ConcurrentLinkedQueue<c>>> f10707b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private static volatile g f10708c;
    /* access modifiers changed from: private */

    /* renamed from: d  reason: collision with root package name */
    public final u f10709d = p.b();

    /* renamed from: e  reason: collision with root package name */
    private volatile boolean f10710e = false;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public Runnable f10711f = new Runnable() {
        public void run() {
            if (!Npth.isStopUpload()) {
                if (!g.f10707b.isEmpty() && o.e()) {
                    g.f();
                }
                g.this.c();
                g.this.f10709d.a(g.this.f10711f, 30000);
            }
        }
    };
    ...
    private static void b(Object obj, c cVar) {
        ...
        synchronized (obj) {
            concurrentLinkedQueue = f10706a.get(obj);
            if (concurrentLinkedQueue == null) {
                concurrentLinkedQueue = new ConcurrentLinkedQueue();
                f10706a.put(obj, concurrentLinkedQueue);
            }
        }
        concurrentLinkedQueue.add(cVar);
        int size = f10706a.size();
        boolean z = size >= 30;
    ...
    private static void c(Object obj, c cVar) {
        ...
        try {
            ...
            synchronized (f10707b) {
                HashMap hashMap = f10707b.get(string);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    f10707b.put(obj, hashMap);
                }
    ...
    public void b() {
        if (f10706a.isEmpty()) {
            this.f10709d.a(this.f10711f, 30000);
        } else {
            this.f10709d.a(this.f10711f);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x000d, code lost:
        ...
        r1 = f10706a.entrySet().iterator();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void c() {
        /*
            r7 = this;
            com.apm.insight.runtime.u r0 = r7.f10709d
            monitor-enter(r0)
            boolean r1 = r7.f10710e     // Catch:{ all -> 0x0080 }
            if (r1 == 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0080 }
            return
        L_0x0009:
            r1 = 1
            r7.f10710e = r1     // Catch:{ all -> 0x0080 }
            monitor-exit(r0)     // Catch:{ all -> 0x0080 }
            java.util.LinkedList r0 = new java.util.LinkedList
            r0.<init>()
            java.util.concurrent.ConcurrentHashMap<java.lang.Object, java.util.concurrent.ConcurrentLinkedQueue<com.apm.insight.entity.c>> r1 = f10706a
