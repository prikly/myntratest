...
public class a {
    ...
    public static Runnable f10651a = new Runnable() {
        public void run() {
            long j;
            Runnable runnable;
            u uVar;
    ...
    public static void a() {
        f10652b = 40;
        com.apm.insight.runtime.p.b().a(f10651a);
    }
    ...
    public static synchronized void i() {
        /*
            ...
            monitor-enter(r0)
            int r1 = f10652b     // Catch:{ all -> 0x006a }
            r2 = 1
            if (r1 <= 0) goto L_0x000d
            int r1 = f10652b     // Catch:{ all -> 0x006a }
            int r1 = r1 - r2
            f10652b = r1     // Catch:{ all -> 0x006a }
        L_0x000d:
