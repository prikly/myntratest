...
public class b {
    ...
    public static boolean f10811b = false;
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static boolean f10812c = false;
    /* access modifiers changed from: private */
    ...
    private static boolean f10814e = false;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public static long f10815f = -1;
    ...
    private Application f10816g;

    /* renamed from: h  reason: collision with root package name */
    private Context f10817h;
    /* access modifiers changed from: private */
    ...
    private static class a {
        ...
        public String toString() {
            return com.apm.insight.l.b.a().format(new Date(this.f10821c)) + " : " + this.f10819a + ' ' + this.f10820b;
        }
    }

    private b(Application application) {
        this.f10817h = application;
        this.f10816g = application;
        try {
            m();
    ...
    private void m() {
        if (Build.VERSION.SDK_INT >= 14 && this.f10816g != null) {
            this.f10816g.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                public void onActivityCreated(Activity activity, Bundle bundle) {
                    String unused = b.this.n = activity.getClass().getName();
                    long unused2 = b.this.o = System.currentTimeMillis();
                    boolean unused3 = b.f10811b = bundle != null;
                    boolean unused4 = b.f10812c = true;
                ...
                public void onActivityPaused(Activity activity) {
                    ...
                    boolean unused5 = b.f10812c = false;
                ...
                public void onActivityResumed(Activity activity) {
                    ...
                    if (!b.this.x) {
                        if (b.f10810a) {
                            boolean unused3 = b.f10810a = false;
                            int unused4 = b.f10813d = 1;
                            long unused5 = b.f10815f = b.this.s;
                        }
                        if (b.this.r.equals(b.this.t)) {
                            if (b.f10812c && !b.f10811b) {
                                int unused6 = b.f10813d = 4;
                                long unused7 = b.f10815f = b.this.s;
                                return;
                            } else if (!b.f10812c) {
                                int unused8 = b.f10813d = 3;
                                long unused9 = b.f10815f = b.this.s;
                                return;
                            }
                        } else {
                            return;
