...
public class AdOperationMetric {
    ...
    public static Metric newAdLoadSuccess(Long l, boolean z) {
        return new Metric(AD_LOAD_SUCCESS, l, getTags((AdOperationError) null, false, z));
    }
    ...
    private static HashMap<String, String> getTags(AdOperationError adOperationError, final boolean z, boolean z2) {
        final String adOperationError2 = adOperationError == null ? "unknown" : adOperationError.toString();
        final String str = z2 ? "banner" : "video";
        return new HashMap<String, String>() {
            {
                if (z) {
                    put("reason", adOperationError2);
                }
