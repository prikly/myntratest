...
public class CoreModuleConfiguration implements IModuleConfiguration {
    ...
    private void collectMetrics() {
        ...
        arrayList.add(new Metric("native_device_decoder_x264", Integer.valueOf(hasX264Decoder ? 1 : 0), (Map<String, String>) null));
        arrayList.add(new Metric("native_device_decoder_x265", Integer.valueOf(hasX265Decoder ? 1 : 0), (Map<String, String>) null));
