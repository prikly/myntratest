...
public final class InitializeStateConfigWithLoader implements BaseTask<Params, Result<? extends Configuration>> {
    ...
    public InitializeStateConfigWithLoader(ISDKDispatchers iSDKDispatchers, InitializeStateNetworkError initializeStateNetworkError2) {
    ...
    public Object doWork(Params params, Continuation<? super Result<? extends Configuration>> continuation) {
        return BuildersKt.withContext(this.dispatchers.getDefault(), new InitializeStateConfigWithLoader$doWork$2(this, params, (Continuation) null), continuation);
    }
