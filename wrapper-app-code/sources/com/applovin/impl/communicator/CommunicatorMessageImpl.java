...
public abstract class CommunicatorMessageImpl extends Intent {
    ...
    private final String f14345a = UUID.randomUUID().toString();
    ...
    public String toString() {
        return "AppLovinCommunicatorMessage{publisherId=" + getPublisherId() + ", topic=" + getTopic() + '\'' + ", uniqueId='" + this.f14345a + '\'' + ", data=" + this.data + '}';
    }
}
