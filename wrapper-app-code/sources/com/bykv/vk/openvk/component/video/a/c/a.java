...
public final class a {
    ...
    public static final Charset f18103a = Charset.forName("UTF-8");

    /* renamed from: b  reason: collision with root package name */
    private static final Handler f18104b = new Handler(Looper.getMainLooper());
    ...
    public static String a(com.bykv.vk.openvk.component.video.a.b.e.a aVar, int i) {
        ...
        if (a3 != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                i.b bVar = a3.get(i2);
                if (bVar != null) {
                    String str = bVar.f18084a;
                    String str2 = bVar.f18085b;
                    sb.append(str);
                    sb.append(": ");
                    sb.append(str2);
                    sb.append("\r\n");
    ...
    public static String a(com.bykv.vk.openvk.component.video.a.b.b.a aVar, int i) {
        ...
        sb.append(aVar.f17976b);
        sb.append("\r\n");
        if (i <= 0) {
            sb.append("Content-Length: ");
            sb.append(aVar.f17977c);
            sb.append("\r\n");
        } else {
            sb.append("Content-Range: bytes ");
            sb.append(i);
            sb.append("-");
            sb.append(aVar.f17977c - 1);
            sb.append("/");
            sb.append(aVar.f17977c);
            sb.append("\r\n");
            sb.append("Content-Length: ");
            sb.append(aVar.f17977c - i);
            sb.append("\r\n");
        }
        sb.append("Connection: close");
        sb.append("\r\n");
    ...
    public static int a() {
        ...
        try {
            ...
            if (!file.exists() || (listFiles = file.listFiles(new FilenameFilter() {
                ...
                /* renamed from: a  reason: collision with root package name */
                private Pattern f18105a = Pattern.compile("^cpu[0-9]+$");

                public boolean accept(File file, String str) {
                    return this.f18105a.matcher(str).matches();
                }
            })) == null) {
                return 1;
            }
    ...
    public static int a(com.bykv.vk.openvk.component.video.a.b.e.a aVar) {
        ...
        if (aVar.a() == 200) {
            return a(aVar.a("Content-Length", (String) null), -1);
        }
        if (aVar.a() == 206) {
    ...
    public static String a(com.bykv.vk.openvk.component.video.a.b.e.a aVar, boolean z, boolean z2) {
        ...
        if (aVar == null) {
            ...
            String a3 = aVar.a("Content-Type", (String) null);
            if (!c(a3)) {
                if (e.f18017c) {
    ...
    public static List<i.b> a(List<i.b> list) {
        ...
        if (e.f18017c) {
            ...
            for (int i = 0; i < size; i++) {
                i.b bVar = list.get(i);
                if (bVar != null) {
                    Log.i("TAG_PROXY_PRE_FILTER", bVar.f18084a + ": " + bVar.f18084a);
                }
            }
        }
        ArrayList arrayList = new ArrayList();
        for (i.b next : list) {
            if ("Host".equals(next.f18084a) || "Keep-Alive".equals(next.f18084a) || "Connection".equals(next.f18084a) || "Proxy-Connection".equals(next.f18084a)) {
                arrayList.add(next);
            }
        }
        ...
        if (e.f18017c) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (bVar2 != null) {
                    Log.i("TAG_PROXY_POST_FILTER", bVar2.f18084a + ": " + bVar2.f18085b);
                }
            }
        }
        return list;
    ...
    public static com.bykv.vk.openvk.component.video.a.b.b.a a(com.bykv.vk.openvk.component.video.a.b.e.a aVar, c cVar, String str, int i) {
        ...
        int a3 = a(aVar);
        String a4 = aVar.a("Content-Type", (String) null);
        if (a3 <= 0 || TextUtils.isEmpty(a4)) {
            return a2;
        }
        com.bykv.vk.openvk.component.video.a.b.e.e g2 = aVar.g();
        if (g2 != null) {
            str2 = g2.f18028b;
            str3 = b(g2.f18031e);
        } else {
    ...
    public static String b(List<i.b> list) {
        ...
        for (int i = 0; i < size; i++) {
            i.b bVar = list.get(0);
            if (bVar != null) {
                sb.append(bVar.f18084a);
                sb.append(": ");
                sb.append(bVar.f18085b);
                sb.append("\r\n");
            }
        }
        return sb.toString();
