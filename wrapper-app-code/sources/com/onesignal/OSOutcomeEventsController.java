...
class OSOutcomeEventsController {
    ...
    private void sendAndCreateOutcomeEvent(String str, float f2, List<OSInfluence> list, OneSignal.OutcomeCallback outcomeCallback) {
        ...
        for (OSInfluence next : list) {
            int i = AnonymousClass6.$SwitchMap$com$onesignal$influence$domain$OSInfluenceType[next.getInfluenceType().ordinal()];
            if (i == 1) {
        ...
        OSOutcomeEventParams oSOutcomeEventParams = new OSOutcomeEventParams(str, new OSOutcomeSource(oSOutcomeSourceBody, oSOutcomeSourceBody2), f2, 0);
    ...
    static /* synthetic */ class AnonymousClass6 {
        ...
        static {
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.OSOutcomeEventsController.AnonymousClass6.<clinit>():void");
        }
    }
