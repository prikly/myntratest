        ...
        this.mDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            public void onViewReleased(View view, float f2, float f3) {
                ...
                if (!DraggableRelativeLayout.this.dismissing) {
                    if (DraggableRelativeLayout.this.params.dragDirection == 1) {
                        if (this.lastYPos > DraggableRelativeLayout.this.params.dismissingYPos || f3 > ((float) DraggableRelativeLayout.this.params.dismissingYVelocity)) {
                    ...
                    } else if (this.lastYPos < DraggableRelativeLayout.this.params.dismissingYPos || f3 < ((float) DraggableRelativeLayout.this.params.dismissingYVelocity)) {
                        i = DraggableRelativeLayout.this.params.offScreenYPos;
