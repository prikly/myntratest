...
import com.wMyntraHackathonPrototype_18142852.R;
import java.io.File;
...
public class MainNavigationActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    private boolean _isMenuItemId(int i) {
        return i == R.id.webapp_exit || i == R.id.webapp_refresh || i == R.id.webapp_disable_ads || i == R.id.webapp_about || i == R.id.webapp_share || i == R.id.webapp_back || i == R.id.webapp_forward || i == R.id.webapp_request_desktop || i == R.id.webapp_add_to_home || i == R.id.webapp_home || i == R.id.webapp_downloads_list || i == R.id.webapp_settings || i == R.id.webapp_theming;
    }
    ...
    private void initAppsgeyserSDK() {
        AppsgeyserSDK.setAfterConsentRequestCompletedListener(new InternalEntryPoint.AfterConsentRequestListener() {
            public final void onConsentRequestCompleted() {
                MainNavigationActivity.this.lambda$initAppsgeyserSDK$0$MainNavigationActivity();
            }
        });
        ...
        AppsgeyserSDK.getUpdateManager().checkForUpdate(this, findViewById(R.id.frame_layout));
    }
    ...
    public void createNotice() {
        ...
        ((NotificationManager) getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME)).notify(120778953, ongoing.build());
    }
    ...
    public void deleteNotice() {
        ((NotificationManager) getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME)).cancel(120778953);
    }
    ...
    public void onResume() {
        ...
        AppsgeyserSDK.getUpdateManager().registerOnSuccessListener(1494823057);
    ...
    public boolean onOptionsItemSelected(int i, MenuItem menuItem) {
        ...
        switch (i) {
            ...
            case R.id.webapp_back:
                ...
                return true;
            case R.id.webapp_disable_ads:
                AppsgeyserSDK.launchDisableAdsDialog(this, R.color.colorPrimaryDark);
                return true;
    ...
    public void showHttpAuthentication(WebView webView, HttpAuthHandler httpAuthHandler, String str, String str2, String str3, String str4, String str5, int i) {
        ...
        }).setNegativeButton(LogConstants.EVENT_CANCEL, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (this.navigationDrawerWidget != null) {
                ...
                AppsgeyserSDK.isAboutDialogEnabled(this, new AppsgeyserSDK.OnAboutDialogEnableListener() {
                    public void onDialogEnableReceived(boolean z) {
                        if (!z) {
                            MainNavigationActivity.this.navigationDrawerWidget.hideMenuItem(2131362848);
                        }
                    }
                });
                this.navigationDrawerWidget.hideMenuItem(2131362851);
                AppsgeyserSDK.getPurchaseController().subscribeDisableAdsStatus(new Action1() {
                    public final void call(Object obj) {
                        MainNavigationActivity.this.lambda$onPostCreate$2$MainNavigationActivity((Status) obj);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void lambda$onPostCreate$2$MainNavigationActivity(Status status) {
        runOnUiThread(new Runnable(status) {
            ...
            public final void run() {
                MainNavigationActivity.this.lambda$onPostCreate$1$MainNavigationActivity(this.f$1);
            }
        });
    }
