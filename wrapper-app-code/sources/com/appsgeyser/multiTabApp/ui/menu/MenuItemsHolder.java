...
public class MenuItemsHolder {
            ...
            public final void call(Object obj) {
                Factory.getInstance().getMainNavigationActivity().runOnUiThread(new Runnable(this.f$0) {
                    ...
                    public final void run() {
                        MenuItemsHolder.lambda$_applyItemsVisibility$1(Status.this, this.f$1);
                    }
                });
            }
        });
    ...
    static /* synthetic */ void lambda$_applyItemsVisibility$1(Status status, MenuItem menuItem) {
