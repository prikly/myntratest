...
public abstract class NavigationWidget implements SuggestionsListener, INavigationWidget {
    ...
    public void attachAutocomplete() {
        ...
        int[] iArr = {R.id.titleItem, R.id.urlItem};
        SimpleCursorAdapter simpleCursorAdapter = new SimpleCursorAdapter(this._parent.getContext(), R.layout.history_autocomplete_layout, (Cursor) null, new String[]{"title", "url"}, iArr);
