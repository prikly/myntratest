        ...
        if (this._visible || z) {
            ...
            AnonymousClass8 r0 = new Animation() {
                ...
                public void applyTransformation(float f2, Transformation transformation) {
                    float f3;
                    if (z) {
                        f3 = ((float) TopNavigationWidget.this._defaultTopBrowserMargin) * f2;
                    } else {
                        f3 = ((float) TopNavigationWidget.this._defaultTopBrowserMargin) - (((float) TopNavigationWidget.this._defaultTopBrowserMargin) * f2);
                    }
                    int i = (int) f3;
