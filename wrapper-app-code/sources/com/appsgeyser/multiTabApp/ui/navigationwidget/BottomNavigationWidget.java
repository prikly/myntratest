        ...
        if (this._visible || z) {
            ...
            AnonymousClass6 r0 = new Animation() {
                ...
                public void applyTransformation(float f2, Transformation transformation) {
                    float f3;
                    if (z) {
                        f3 = ((float) BottomNavigationWidget.this._defaultTopBrowserMargin) * f2;
                    } else {
                        f3 = ((float) BottomNavigationWidget.this._defaultTopBrowserMargin) - (((float) BottomNavigationWidget.this._defaultTopBrowserMargin) * f2);
                    }
                    int i = (int) f3;
