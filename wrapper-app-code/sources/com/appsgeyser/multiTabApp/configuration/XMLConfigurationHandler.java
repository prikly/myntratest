...
public class XMLConfigurationHandler extends DefaultHandler {
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SAXException {
        ...
        if (str2.equalsIgnoreCase("fullScreenMode")) {
            ...
            this.currentParentTag = str2;
        } else if (str2.equalsIgnoreCase(AppLovinEventTypes.USER_VIEWED_CONTENT)) {
            this.currentParentTag = str2;
            ...
            if (value5.equalsIgnoreCase("back")) {
                ...
                this.webWidgetConfiguration.addUrlBarMenuButton(new UrlBarIcon(attributes.getValue("title"), attributes.getValue("url"), attributes.getValue("icon")));
            }
    ...
    public void endElement(String str, String str2, String str3) throws SAXException {
        ...
        if (str2.equalsIgnoreCase("fullScreenMode")) {
        ...
        } else if (str2.equalsIgnoreCase("registeredUrl") || str2.equalsIgnoreCase("usage") || str2.equalsIgnoreCase("locationUrl") || str2.equalsIgnoreCase(AppLovinEventTypes.USER_VIEWED_CONTENT) || str2.equalsIgnoreCase("contentProtection") || str2.equalsIgnoreCase("affiliate") || str2.equalsIgnoreCase("urlBarMenuItems")) {
            ...
            if (this.currentParentTag.equalsIgnoreCase(AppLovinEventTypes.USER_VIEWED_CONTENT)) {
                if (str2.equalsIgnoreCase(OSOutcomeConstants.OUTCOME_ID)) {
                ...
                } else if (str2.equalsIgnoreCase(IabUtils.KEY_WIDTH)) {
                ...
                } else if (str2.equalsIgnoreCase(IabUtils.KEY_HEIGHT)) {
                    ...
                    if (this._currentWidgetEntity != null) {
                        ...
                        } else if (sb.compareToIgnoreCase(OSNotificationFormatHelper.PAYLOAD_OS_ROOT_CUSTOM) == 0) {
        ...
        } else if (str2.equalsIgnoreCase(OSOutcomeConstants.OUTCOME_ID)) {
            ...
            if (str2.equalsIgnoreCase(AppLovinEventTypes.USER_LOGGED_IN)) {
            ...
            } else if (sb3.equals(OSNotificationFormatHelper.PAYLOAD_OS_ROOT_CUSTOM)) {
