...
public class BrowsingHistoryStorage {
    ...
    public Cursor loadHistory(Date date, Date date2) {
        ...
        Cursor query = sQLiteQueryBuilder.query(this._dbHelper.getReadableDatabase(), new String[]{"rowId _id", "title", "url", "visitTime"}, str, strArr, (String) null, (String) null, (String) null);
        if (query == null) {
            return null;
        }
