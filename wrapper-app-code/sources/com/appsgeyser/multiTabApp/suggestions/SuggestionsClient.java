...
public class SuggestionsClient extends BaseServerClient {
    ...
    public void getSuggestionsAsync(final String str) {
        if (str != null && str != "") {
            sendRequestAsync("http://google.com/complete/search?output=toolbar&q=" + URLEncoder.encode(str), Integer.valueOf(c.COLLECT_MODE_DEFAULT), new BaseServerClient.OnRequestDoneListener() {
