...
public class FastTrackFacebookAdapter extends FastTrackBaseAdapter {
    ...
    public Runnable bannerViewRefreshRunnable = new Runnable() {
        public void run() {
            if (FastTrackFacebookAdapter.this.adView != null) {
                ...
                FastTrackFacebookAdapter.this.handler.postDelayed(FastTrackFacebookAdapter.this.bannerViewRepeatRequestRunnable, 60000);
                return;
            }
    ...
    public Runnable bannerViewRepeatRequestRunnable = new Runnable() {
        public void run() {
            if (FastTrackFacebookAdapter.this.adView != null) {
                Log.d("fastTrackTag", "facebook banner repeat attempt to load");
                HashMap hashMap = FastTrackFacebookAdapter.this.bannerDetails;
                hashMap.put("details", "banner id: " + FastTrackFacebookAdapter.this.bannerPlacementId);
    ...
    public void init() {
        ...
        AudienceNetworkAds.buildInitSettings(this.context).withInitListener(new AudienceNetworkAds.InitListener() {
            public void onInitialized(AudienceNetworkAds.InitResult initResult) {
                Log.d("fastTrackTag", "facebook init complete: " + initResult.getMessage());
        ...
        if (str == null || str.isEmpty()) {
            ...
            if (this.fastTrackSdkModel.isCustomFullscreenActivated()) {
                this.interstitialDetails.put(FullscreenAdService.DATA_KEY_AD_SOURCE, "ft_facebook_custom");
                ...
                this.interstitialDetails.put(FullscreenAdService.DATA_KEY_AD_SOURCE, "ft_facebook");
        ...
        if (this.fastTrackSdkModel.isCustomBannerActivated()) {
            this.bannerDetails.put(FullscreenAdService.DATA_KEY_AD_SOURCE, "ft_facebook_custom");
        ...
        this.bannerDetails.put(FullscreenAdService.DATA_KEY_AD_SOURCE, "ft_facebook");
    ...
    public void initBannerView(final ViewGroup viewGroup, String str, Activity activity) {
        ...
        if (str2 != null && !str2.isEmpty() && bannerViewRefreshRate.intValue() != 0) {
            ...
            Log.d("fastTrackTag", "facebook banner attempt to attach bannerView to container");
    ...
    public void loadFullscreen() {
        ...
        if (str != null && !str.isEmpty()) {
            ...
            AnonymousClass5 r0 = new InterstitialAdListener() {
                ...
                public void onError(Ad ad, AdError adError) {
                    ...
                    FastTrackFacebookAdapter.this.handler.postDelayed(new Runnable() {
                        public final void run() {
                            FastTrackFacebookAdapter.AnonymousClass5.this.lambda$onError$0$FastTrackFacebookAdapter$5();
                        }
                    }, 60000);
                    Log.d("fastTrackTag", "facebook fs onError " + adError.getErrorCode() + " " + adError.getErrorMessage());
                }

                public /* synthetic */ void lambda$onError$0$FastTrackFacebookAdapter$5() {
                    FastTrackFacebookAdapter.this.loadFullscreen();
                }
                ...
                public void onAdLoaded(Ad ad) {
                    if (FastTrackFacebookAdapter.this.pendingFullscreenRequest && FastTrackFacebookAdapter.this.isInForeground) {
                        ...
                        FastTrackFacebookAdapter.this.handler.postDelayed(new Runnable(appsgeyserProgressDialog) {
                            ...
                            public final void run() {
                                FastTrackFacebookAdapter.AnonymousClass5.this.lambda$onAdLoaded$1$FastTrackFacebookAdapter$5(this.f$1);
                            }
                        }, 2000);
                    }
                ...
                public /* synthetic */ void lambda$onAdLoaded$1$FastTrackFacebookAdapter$5(AppsgeyserProgressDialog appsgeyserProgressDialog) {
                    try {
