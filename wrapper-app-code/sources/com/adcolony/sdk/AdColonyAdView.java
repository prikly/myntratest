...
public class AdColonyAdView extends FrameLayout {
    ...
    private AdColonyAdViewListener f9813b;

    /* renamed from: c  reason: collision with root package name */
    private AdColonyAdSize f9814c;
    /* access modifiers changed from: private */
    ...
    class a implements Runnable {
        ...
        public void run() {
            ...
            d c2 = a.b().c();
            c2.a(AdColonyAdView.this.f9815d);
            c2.a(AdColonyAdView.this.f9812a);
            f1 b2 = c0.b();
            c0.a(b2, OSOutcomeConstants.OUTCOME_ID, AdColonyAdView.this.f9815d);
    ...
    AdColonyAdView(Context context, h0 h0Var, AdColonyAdViewListener adColonyAdViewListener) throws RuntimeException {
        super(context);
        this.f9813b = adColonyAdViewListener;
        this.f9816e = adColonyAdViewListener.c();
        f1 a2 = h0Var.a();
        this.f9815d = c0.h(a2, OSOutcomeConstants.OUTCOME_ID);
        this.f9817f = c0.h(a2, "close_button_filepath");
        ...
        c cVar = a.b().c().c().get(this.f9815d);
        this.f9812a = cVar;
        if (cVar != null) {
            this.f9814c = adColonyAdViewListener.a();
            setLayoutParams(new FrameLayout.LayoutParams(this.f9812a.d(), this.f9812a.b()));
    ...
    public boolean destroy() {
        if (this.l) {
            new e0.a().a("Ignoring duplicate call to destroy().").a(e0.f10043f);
            return false;
        }
        this.l = true;
        p0 p0Var = this.i;
    ...
    public void onAttachedToWindow() {
        ...
        if (this.p && !this.l) {
            this.p = false;
            AdColonyAdViewListener adColonyAdViewListener = this.f9813b;
    ...
    public void a() {
        if (this.k || this.n) {
            float s2 = a.b().n().s();
            this.f9812a.setLayoutParams(new FrameLayout.LayoutParams((int) (((float) this.f9814c.getWidth()) * s2), (int) (((float) this.f9814c.getHeight()) * s2)));
            b1 webView = getWebView();
            if (webView != null) {
                ...
                webView.a(h0Var);
                f1 b3 = c0.b();
                c0.a(b3, "ad_session_id", this.f9815d);
                new h0("MRAID.on_close", this.f9812a.k(), b3).c();
            }
            ImageView imageView = this.f9819h;
            if (imageView != null) {
                this.f9812a.removeView(imageView);
                this.f9812a.a((View) this.f9819h);
            }
            addView(this.f9812a);
            AdColonyAdViewListener adColonyAdViewListener = this.f9813b;
            if (adColonyAdViewListener != null) {
    ...
    public boolean b() {
        ...
        if (this.k || this.n) {
            ...
            this.f9812a.setLayoutParams(new FrameLayout.LayoutParams(w.width(), w.height()));
            b1 webView = getWebView();
            if (webView != null) {
                h0 h0Var = new h0("WebView.set_bounds", 0);
                f1 b2 = c0.b();
                c0.b(b2, "x", width);
                c0.b(b2, "y", height);
                c0.b(b2, IabUtils.KEY_WIDTH, i3);
                c0.b(b2, IabUtils.KEY_HEIGHT, i4);
                h0Var.b(b2);
                webView.a(h0Var);
                float s2 = n2.s();
                f1 b3 = c0.b();
                c0.b(b3, "app_orientation", z0.d(z0.f()));
                c0.b(b3, IabUtils.KEY_WIDTH, (int) (((float) i3) / s2));
                c0.b(b3, IabUtils.KEY_HEIGHT, (int) (((float) i4) / s2));
                c0.b(b3, "x", z0.a((View) webView));
                c0.b(b3, "y", z0.b((View) webView));
                c0.a(b3, "ad_session_id", this.f9815d);
                new h0("MRAID.on_size_change", this.f9812a.k(), b3).c();
            }
            ImageView imageView = this.f9819h;
            if (imageView != null) {
                this.f9812a.removeView(imageView);
            ...
            if (!(a2 == null || this.m || webView == null)) {
                ...
                this.f9819h = imageView2;
                imageView2.setImageURI(Uri.fromFile(new File(this.f9817f)));
                FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(i5, i6);
                layoutParams.setMargins(i2 - i5, currentY, 0, 0);
                this.f9819h.setOnClickListener(new b(this, a2));
                this.f9812a.addView(this.f9819h, layoutParams);
                this.f9812a.a((View) this.f9819h, FriendlyObstructionPurpose.CLOSE_AD);
            }
            if (this.j != null) {
                f1 b4 = c0.b();
