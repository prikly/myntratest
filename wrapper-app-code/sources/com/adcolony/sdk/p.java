...
class p {
    static void a(String str, ContentValues contentValues, SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            try {
                e0.a aVar = new e0.a();
                e0.a a2 = aVar.a("Exception on insert to " + str + ", db version:").a(sQLiteDatabase.getVersion());
                a2.a(". Values: " + contentValues.toString() + " caused: ").a(e2.toString()).a(e0.f10044g);
            } catch (Throwable th) {
                e0.a aVar2 = new e0.a();
                e0.a a3 = aVar2.a("Error on insert to " + str + ", db version:").a(sQLiteDatabase.getVersion());
                a3.a(". Values: " + contentValues.toString() + " caused: ").a(th.toString()).a(e0.i);
                return;
            }
        }
    ...
    static void a(int i, long j, String str, String str2, SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            try {
                new e0.a().a("Exception on deleting excessive rows:").a(e2.toString()).a(e0.f10044g);
            } catch (Throwable th) {
