...
class g1 {
    ...
    private static int f10085a;

    /* renamed from: b  reason: collision with root package name */
    private static int f10086b;

    /* renamed from: c  reason: collision with root package name */
    private static int f10087c;

    /* renamed from: d  reason: collision with root package name */
    private static int f10088d;
    ...
    static float a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        ...
        L_0x0092:
            ...
            float r9 = a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b3 }
        ...
        L_0x011c:
            ...
            float r9 = a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0138 }
    ...
    private static int b(Context context) {
        ...
        if (i4 == 2 && (i3 = f10086b) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f10088d) > 0) {
            return i2;
        }
        try {
    ...
    private static int a(Context context) {
        ...
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i4 == 2 && (i3 = f10085a) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f10087c) > 0) {
            return i2;
        }
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
