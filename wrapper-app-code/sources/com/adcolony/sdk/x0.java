...
class x0 {
    ...
    class g implements Runnable {
        ...
        public void run() {
            f1 b2 = c0.b();
            c0.a(b2, "type", "open_hook");
            c0.a(b2, OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, this.f10390a);
    ...
    public boolean l(h0 h0Var) {
        ...
        Intent putExtra = type.putExtra("android.intent.extra.TEXT", c0.h(a2, "text") + " " + c0.h(a2, "url"));
        String h2 = c0.h(a2, "ad_session_id");
    ...
    public boolean o(h0 h0Var) {
        ...
        if (!z) {
            new e0.a().a("No vibrate permission detected.").a(e0.f10043f);
            c0.b(b2, "success", false);
            h0Var.a(b2).c();
            return false;
    ...
    public boolean a(h0 h0Var) {
        ...
        new h0("AdSession.on_request_close", ((b) activity).f9909c, b2).c();
        return true;
    }
