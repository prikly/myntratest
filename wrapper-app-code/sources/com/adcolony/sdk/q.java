...
class q {
    ...
    public final f f10234a = new f();
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public final f f10235b = new f();
    ...
    class a implements j0 {
        ...
        class C0096a implements Runnable {
            ...
            class C0097a implements Runnable {
                ...
                public void run() {
                    C0096a.this.f10241a.a(this.f10242a).c();
                }
            }

            C0096a(a aVar, h0 h0Var) {
                this.f10241a = h0Var;
            }

            public void run() {
                z0.b((Runnable) new C0097a(a.b().n().c(2000)));
            }
        }
        ...
        public void a(h0 h0Var) {
            if (!z0.a((Runnable) new C0096a(this, h0Var))) {
    ...
    class b implements Callable<f1> {
        ...
        /* renamed from: b */
        public f1 call() {
            if (!q.this.N() && this.f10244a > 0) {
                q.this.f10234a.a(this.f10244a);
            }
            return q.this.b();
        }
    }
    ...
    class c implements Runnable {
        ...
        public void run() {
            ...
            if (a.f9876e) {
                ...
                z = false;
                try {
                    AdvertisingIdClient.Info advertisingIdInfo = AdvertisingIdClient.getAdvertisingIdInfo(this.f10246a);
                    str = advertisingIdInfo.getId();
                    z = advertisingIdInfo.isLimitAdTrackingEnabled();
                } catch (NoClassDefFoundError unused) {
                    new e0.a().a("Google Play Services Ads dependencies are missing.").a(e0.f10043f);
                } catch (NoSuchMethodError unused2) {
                    new e0.a().a("Google Play Services is out of date, please update to GPS 4.0+.").a(e0.f10043f);
                } catch (Exception e2) {
                    new e0.a().a("Query Advertising ID failed with: ").a(Log.getStackTraceString(e2)).a(e0.f10044g);
                }
            ...
            if (str == null) {
                new e0.a().a("Advertising ID is not available. ").a("Collecting Android ID instead of Advertising ID.").a(e0.f10043f);
                y yVar = this.f10247b;
                if (yVar != null) {
                ...
                s0 a2 = a.b().q().a();
                if (a2 != null) {
                    a2.f10281d.put("advertisingId", q.this.f());
                }
                q.this.c(z);
    ...
    class d implements Callable<f1> {
        ...
        /* renamed from: b */
        public f1 call() {
            if (!q.this.O() && this.f10249a > 0) {
                q.this.f10235b.a(this.f10249a);
            }
            return q.this.c();
        }
    }
    ...
    class e implements OnCompleteListener<AppSetIdInfo> {
        ...
        public void onComplete(Task<AppSetIdInfo> task) {
            ...
            if (task.isSuccessful()) {
                ...
                new e0.a().a("App Set ID is not available. Unexpected exception occurred: ").a(Log.getStackTraceString(th)).a(e0.f10044g);
                y yVar2 = this.f10251a;
                if (yVar2 != null) {
                    yVar2.a(th);
                }
            }
    ...
    public void b(android.content.Context r3, com.adcolony.sdk.y<java.lang.String> r4) {
        ...
        L_0x0056:
            ...
            com.adcolony.sdk.e0 r0 = com.adcolony.sdk.e0.f10043f
            r3.a((com.adcolony.sdk.e0) r0)
        L_0x0066:
            com.adcolony.sdk.e0$a r3 = new com.adcolony.sdk.e0$a
            r3.<init>()
            ...
            com.adcolony.sdk.e0$a r3 = r3.a((java.lang.String) r0)
            com.adcolony.sdk.e0 r1 = com.adcolony.sdk.e0.f10043f
