...
class k {
    ...
    class c implements j0 {
        ...
        class a implements y<String> {
            ...
            public void a(Throwable th) {
                new e0.a().a("Device.query_advertiser_info").a(" failed with error: ").a(Log.getStackTraceString(th)).a(e0.f10044g);
            }
        }
    ...
    class i implements Runnable {
        ...
        public void run() {
            ...
            if (k.this.L && k.this.P == null) {
                try {
                    Partner unused4 = k.this.P = Partner.createPartner("AdColony", BuildConfig.ADAPTER_SDK_VERSION_NAME);
    ...
    class j implements Runnable {
        ...
        public void run() {
            f1 b2 = c0.b();
            c0.a(b2, "url", k.Z);
            c0.a(b2, "content_type", "application/json");
            c0.a(b2, AppLovinEventTypes.USER_VIEWED_CONTENT, k.this.n().t().toString());
            c0.a(b2, "url", k.Z);
            if (k.this.Y) {
                f1 b3 = c0.b();
            ...
            k.this.f10116b.a(new s(new h0("WebServices.post", 0, b2), new a()));
        }
    }

    /* renamed from: com.adcolony.sdk.k$k  reason: collision with other inner class name */
    class C0095k implements v.c {
        C0095k(k kVar) {
        }
    ...
    class l implements Runnable {
        ...
        public void run() {
            j a2 = j.a(this.f10135a.getApplicationContext(), this.f10136b);
    ...
    class s implements Runnable {
        ...
        public void run() {
            k.this.p.onReward(new AdColonyReward(this.f10143a));
        }
    }
    ...
    class t implements Application.ActivityLifecycleCallbacks {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Set<Integer> f10145a = new HashSet();
        ...
        public void onActivityPaused(Activity activity) {
            a.f9875d = false;
            k.this.f10117c.d(false);
        }

        public void onActivityResumed(Activity activity) {
            ScheduledExecutorService scheduledExecutorService;
            this.f10145a.add(Integer.valueOf(activity.hashCode()));
            a.f9875d = true;
            a.a((Context) activity);
            s0 a2 = k.this.q().a();
            Context a3 = a.a();
            if (a3 == null || !k.this.f10117c.e() || !(a3 instanceof b) || ((b) a3).f9910d) {
                a.a((Context) activity);
                if (k.this.s != null) {
                ...
                k.this.f10117c.g(false);
                if (k.this.E && !k.this.f10117c.f()) {
                    k.this.f10117c.c(true);
                }
                k.this.f10117c.d(true);
                k.this.f10119e.c();
                if (a2 == null || (scheduledExecutorService = a2.f10279b) == null || scheduledExecutorService.isShutdown() || a2.f10279b.isTerminated()) {
        ...
        public void onActivityStarted(Activity activity) {
            k.this.f10117c.e(true);
        }

        public void onActivityStopped(Activity activity) {
            this.f10145a.remove(Integer.valueOf(activity.hashCode()));
            if (this.f10145a.isEmpty()) {
                k.this.f10117c.e(false);
            }
        }
    }
    ...
    class w implements j0 {
        ...
        public void a(h0 h0Var) {
            ...
            if (i != null) {
                k.this.f10116b.a(i.intValue());
            }
            Integer i2 = a3.i("concurrent_requests");
            if (i2 != null) {
                k.this.f10116b.b(i2.intValue());
            }
            Integer i3 = a3.i("threads_keep_alive_time");
            if (i3 != null) {
                k.this.f10116b.c(i3.intValue());
            }
    ...
    public void M() {
        ...
        f1 b4 = c0.b();
        c0.a(b4, "zone_ids", e1Var);
        c0.a(b2, OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, b4);
    ...
    public void N() {
        ...
        new e0.a().a("Downloaded controller sha1 does not match, retrying.").a(e0.f10043f);
        S();
    }
    ...
    private void S() {
        ...
        new e0.a().a("Max launch server download attempts hit, or AdColony is no longer").a(" active.").a(e0.f10044g);
    }
    ...
    public void Q() {
        this.X = 0;
        for (AdColonyInterstitial next : this.f10118d.f().values()) {
            if (next.m()) {
                this.X++;
                next.a((AdColonyInterstitial.f) new p());
            }
        }
        for (AdColonyAdView onDestroyListenerOrCall : this.f10118d.d().values()) {
            this.X++;
    ...
    /* access modifiers changed from: package-private */
    public void R() {
        synchronized (this.f10118d.f()) {
            for (AdColonyInterstitial p2 : this.f10118d.f().values()) {
                p2.p();
            }
            this.f10118d.f().clear();
        }
    }
    ...
    public boolean c(h0 h0Var) {
        ...
        try {
            int j2 = h0Var.a().j(OSOutcomeConstants.OUTCOME_ID);
            if (j2 > 0) {
                a(j2);
            }
    ...
    public void a(com.adcolony.sdk.AdColonyAppOptions r5, boolean r6) {
        /*
            ...
            r1.<init>()
            com.adcolony.sdk.v0 r2 = r4.f10122h
            ...
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
            r1.<init>()
            com.adcolony.sdk.v0 r3 = r4.f10122h
            ...
            r6.<init>()
            com.adcolony.sdk.v0 r1 = r4.f10122h
        ...
        L_0x0135:
            ...
            com.adcolony.sdk.a.a((java.lang.String) r1, (com.adcolony.sdk.j0) r6)
            com.adcolony.sdk.v0 r6 = r4.f10122h
    ...
    private void b(f1 f1Var) {
        if (!l.H) {
            ...
            g0.f10066h = c0.a(f2, "send_level", 1);
            g0.f10064f = c0.b(f2, "log_private");
            g0.f10065g = c0.a(f2, "print_level", 3);
            this.i.b(c0.a(f2, "modules"));
            this.i.c(c0.e(f2, "included_fields"));
        }
        f1 f3 = c0.f(f1Var, "metadata");
        n().a(f3);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:?, code lost:
        new java.io.File(r3.f10122h.a() + "026ae9c9824b3e483fa6c71fa88f57ae27816141").delete();
     */
    ...
    private boolean c(com.adcolony.sdk.f1 r4) {
        ...
        L_0x002f:
            ...
            com.adcolony.sdk.v0 r2 = r3.f10122h     // Catch:{ Exception -> 0x004f }
            java.lang.String r2 = r2.a()     // Catch:{ Exception -> 0x004f }
        ...
        L_0x0050:
            ...
            com.adcolony.sdk.v0 r2 = r3.f10122h     // Catch:{ Exception -> 0x007d }
            java.lang.String r2 = r2.a()     // Catch:{ Exception -> 0x007d }
        ...
        L_0x007d:
            ...
            com.adcolony.sdk.e0$a r4 = r4.a((java.lang.String) r1)
            com.adcolony.sdk.e0 r1 = com.adcolony.sdk.e0.f10044g
    ...
    private boolean a(f1 f1Var) {
        ...
        new e0.a().a("Controller sha1 does not match, downloading new controller.").a(e0.f10044g);
        return true;
    }

    /* access modifiers changed from: private */
    public void a(h0 h0Var) {
        a(c0.d(h0Var.a(), OSOutcomeConstants.OUTCOME_ID));
    }
    ...
    public void a(s sVar) {
        if (sVar.n) {
            ...
            c0.j(a2, this.f10122h.a() + "026ae9c9824b3e483fa6c71fa88f57ae27816141");
            if (c(a2)) {
                if (a(a2)) {
                    f1 b2 = c0.b();
                    c0.a(b2, "url", this.w);
                    c0.a(b2, "filepath", this.f10122h.a() + "7bf3a1e7bbd31e612eda3310c2cdb8075c43c6b5");
                    this.f10116b.a(new s(new h0("WebServices.download", 0, b2), new n()));
                }
                this.t = a2;
            } else if (!this.F) {
                new e0.a().a("Incomplete or disabled launch server response. ").a("Disabling AdColony until next launch.").a(e0.f10045h);
                b(true);
            }
        } else {
            S();
    ...
    public boolean a(k0 k0Var) {
        ...
        return this.f10115a.b(k0Var);
    }

    /* access modifiers changed from: package-private */
    public boolean a(int i2) {
        this.v.remove(Integer.valueOf(i2));
        return this.f10115a.b(i2);
    }
