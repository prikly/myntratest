...
public class b1 extends WebView {
    ...
    private final class a extends WebChromeClient {
        ...
        public boolean onConsoleMessage(android.webkit.ConsoleMessage r9) {
            ...
            L_0x0094:
                ...
                goto L_0x00bd
            L_0x00bb:
                com.adcolony.sdk.e0 r0 = com.adcolony.sdk.e0.f10044g
            L_0x00bd:
    ...
    protected class b extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            Unit unit;
            f1 b2 = c0.b();
            c0.b(b2, OSOutcomeConstants.OUTCOME_ID, b1.this.f9921c);
            c0.a(b2, "url", str);
        ...
        public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
            ...
            String a2 = b1.this.f9923e;
            Charset charset = h.f10089a;
            if (a2 != null) {
    ...
    public static final class g {
        ...
        public final b1 a(Context context, h0 h0Var, int i, c cVar) {
            ...
            if (c0.b(a2, "use_mraid_module")) {
                b1Var = new l0(context, e2, h0Var, a.b().r().e());
    ...
    public static final class h implements j0 {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b1 f9932a;

        static final class a extends Lambda implements Function0<Unit> {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ b1 f9933a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ h0 f9934b;
            ...
            public final void a() {
                this.f9933a.a(c0.h(this.f9934b.a(), "custom_js"));
            }
    ...
    public static final class i implements j0 {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b1 f9935a;

        static final class a extends Lambda implements Function0<Unit> {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ b1 f9936a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ h0 f9937b;
            ...
            public final void a() {
                this.f9936a.setVisible(this.f9937b);
            }
    ...
    public static final class j implements j0 {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b1 f9938a;

        static final class a extends Lambda implements Function0<Unit> {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ b1 f9939a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ h0 f9940b;
            ...
            public final void a() {
                this.f9939a.setBounds(this.f9940b);
            }
    ...
    public static final class k implements j0 {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b1 f9941a;

        static final class a extends Lambda implements Function0<Unit> {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ b1 f9942a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ h0 f9943b;
            ...
            public final void a() {
                this.f9942a.setTransparent(c0.b(this.f9943b.a(), "transparent"));
            }
    ...
    static final class l implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ Function0 f9944a;

        l(Function0 function0) {
            this.f9944a = function0;
        }
    ...
    static final class m implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b1 f9945a;

        public static final class a extends WebViewClient {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ b1 f9946a;
        ...
        public final void run() {
            this.f9945a.setWebChromeClient((WebChromeClient) null);
            this.f9945a.setWebViewClient(new a(this.f9945a));
            this.f9945a.clearCache(true);
            this.f9945a.removeAllViews();
            this.f9945a.loadUrl("about:blank");
        }
    }
    ...
    public final void f() {
        a.b().c().a(this, this.f9926h, this.l);
    }
    ...
    public final /* synthetic */ AdColonyAdView getAdView() {
        return a.b().c().d().get(this.f9926h);
    }
    ...
    public final /* synthetic */ AdColonyInterstitial getInterstitial() {
        return a.b().c().f().get(this.f9926h);
    }
    ...
    public /* synthetic */ void j() {
        if (!StringsKt.startsWith$default(this.f9924f, "http", false, 2, (Object) null) && !StringsKt.startsWith$default(this.f9924f, "file", false, 2, (Object) null)) {
            loadDataWithBaseURL(this.f9925g, this.f9924f, "text/html", (String) null, (String) null);
        } else if (StringsKt.contains$default((CharSequence) this.f9924f, (CharSequence) ".html", false, 2, (Object) null) || !StringsKt.startsWith$default(this.f9924f, "file", false, 2, (Object) null)) {
            loadUrl(this.f9924f);
        } else {
            String str = this.f9924f;
            loadDataWithBaseURL(str, "<html><script src=\"" + this.f9924f + "\"></script></html>", "text/html", (String) null, (String) null);
        }
    }
    ...
    public /* synthetic */ void k() {
        if (this.i.length() > 0) {
            try {
                this.f9923e = a.b().p().a(this.i, false).toString();
                Regex regex = new Regex("bridge.os_name\\s*=\\s*\"\"\\s*;");
                this.f9923e = regex.replaceFirst(this.f9923e, "bridge.os_name = \"\";\nvar ADC_DEVICE_INFO = " + this.j + ";\n");
    ...
    public /* synthetic */ void a(h0 h0Var, int i2, c cVar) {
        ...
        this.f9924f = i3;
        this.f9925g = c0.h(a2, "base_url");
        this.f9922d = c0.h(a2, "custom_js");
        this.f9926h = c0.h(a2, "ad_session_id");
        this.j = c0.f(a2, "info");
    ...
    public final /* synthetic */ void a(String str) {
        if (this.k) {
            new e0.a().a("Ignoring call to execute_js as WebView has been destroyed.").a(e0.f10040c);
        } else if (Build.VERSION.SDK_INT >= 19) {
            try {
                evaluateJavascript(str, (ValueCallback) null);
            } catch (IllegalStateException unused) {
                new e0.a().a("Device reporting incorrect OS version, evaluateJavascript ").a("is not available. Disabling AdColony.").a(e0.f10045h);
                AdColony.disable();
            }
        } else {
    ...
    private final void a(Exception exc) {
        new e0.a().a(exc.getClass().toString()).a(" during metadata injection w/ metadata = ").a(c0.h(this.j, "metadata")).a(e0.i);
        c cVar = this.l;
        if (cVar != null) {
            f1 b2 = c0.b();
            c0.a(b2, OSOutcomeConstants.OUTCOME_ID, getAdSessionId());
    ...
    public final void a(int i2, String str, String str2) {
        ...
        if (cVar != null) {
            f1 b2 = c0.b();
            c0.b(b2, OSOutcomeConstants.OUTCOME_ID, this.f9921c);
            c0.a(b2, "ad_session_id", getAdSessionId());
    ...
    public final void a(h0 h0Var, Function0<Unit> function0) {
        f1 a2 = h0Var.a();
        if (c0.d(a2, OSOutcomeConstants.OUTCOME_ID) == this.f9921c) {
