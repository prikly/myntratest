...
public class AdColonyEventTracker {
    ...
    private static final List<f1> f9831a = Collections.synchronizedList(new ArrayList());
    ...
    public static void logCreditsSpent(String str, Integer num, Double d2, String str2) {
        ...
        new e0.a().a("Event logCreditsSpentWithName currency code is specified, but a three-letter ISO 4217 code, (e.g.: 'USD'). Event will not be sent.").a(e0.f10045h);
    }
    ...
    public static void logSearch(String str) {
        ...
        new e0.a().a("logSearch searchString cannot exceed 512 characters. Event will ").a("not be sent.").a(e0.f10045h);
    }
    ...
    public static void logTransaction(String str, Integer num, Double d2, String str2, String str3, String str4, String str5) {
        if (!a(str5, "logTransaction")) {
            if (str2 == null || str2.length() == 3) {
                ...
                hashMap.put("item_id", str);
                hashMap.put("quantity", String.valueOf(num));
                hashMap.put(InAppPurchaseMetaData.KEY_PRICE, String.valueOf(d2));
                hashMap.put("currency_code", str2);
        ...
        if (hashMap != null) {
            for (Map.Entry next : hashMap.entrySet()) {
                if (next.getValue() != null && !((String) next.getValue()).equals("null")) {
                    c0.a(b3, (String) next.getKey(), (String) next.getValue());
                }
            }
        }
        d(b3);
    ...
    private static boolean a(String str, String str2) {
        ...
        new e0.a().a("Description of event ").a(str2).a(" must be less").a(" than 512 characters").a(e0.f10045h);
        return true;
    }
}
