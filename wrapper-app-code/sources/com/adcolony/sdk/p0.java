...
class p0 {
    ...
    private AdSession f10219a;

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f10220b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f10221c;

    /* renamed from: d  reason: collision with root package name */
    private List<VerificationScriptResource> f10222d = new ArrayList();
    ...
    class a implements Runnable {
        ...
        public void run() {
            f1 b2 = c0.b();
            f1 b3 = c0.b();
            c0.b(b3, "session_type", p0.this.f10223e);
            c0.a(b3, "session_id", p0.this.f10224f);
            c0.a(b3, "event", this.f10227a);
            c0.a(b2, "type", "iab_hook");
            c0.a(b2, OneSignalDbContract.NotificationTable.COLUMN_NAME_MESSAGE, b3.toString());
    ...
    class b implements AdColonyCustomMessageListener {
        ...
        class a implements Runnable {
            ...
            public void run() {
                if (this.f10230a.equals(p0.this.o)) {
                    p0.this.a(this.f10231b, this.f10232c);
                    return;
                }
                AdColonyAdView adColonyAdView = a.b().c().d().get(this.f10230a);
                p0 omidManager = adColonyAdView != null ? adColonyAdView.getOmidManager() : null;
                if (omidManager != null) {
                    omidManager.a(this.f10231b, this.f10232c);
                }
            }
        }
        ...
        public void onAdColonyCustomMessage(AdColonyCustomMessage adColonyCustomMessage) {
            ...
            float floatValue = BigDecimal.valueOf(c0.c(b2, IronSourceConstants.EVENTS_DURATION)).floatValue();
            ...
            } else if (!b3 || (!h2.equals("start") && !h2.equals("first_quartile") && !h2.equals("midpoint") && !h2.equals("third_quartile") && !h2.equals("complete"))) {
                z0.b((Runnable) new a(h3, h2, floatValue));
            }
        }
    }
    ...
    p0(f1 f1Var, String str) {
        ...
        for (int i2 = 0; i2 < a2.b(); i2++) {
            try {
                ...
                this.f10222d.add(verificationScriptResource);
    ...
    private int a(f1 f1Var) {
        if (this.f10223e == -1) {
            ...
            if (d2 == 1) {
                ...
                if (h2.equals(BidMachineFetcher.AD_TYPE_DISPLAY)) {
                    return 1;
                }
    ...
    public void a(c cVar) {
        ...
        if (!this.i && this.f10223e >= 0 && this.f10219a != null) {
            b(cVar);
            e();
            if (this.f10223e != 0) {
                mediaEvents = null;
            } else {
                mediaEvents = MediaEvents.createMediaEvents(this.f10219a);
            }
            this.f10221c = mediaEvents;
            try {
                this.f10219a.start();
                this.f10220b = AdEvents.createAdEvents(this.f10219a);
                b("start_session");
                if (this.f10221c != null) {
                    ...
                    this.f10220b.loaded(vastProperties);
                } else {
                    this.f10220b.loaded();
                }
                this.i = true;
            } catch (NullPointerException e2) {
                AdSession adSession = this.f10219a;
    ...
    public void a(WebView webView) throws IllegalArgumentException {
        ...
        if (this.f10223e >= 0 && (str = this.n) != null && !str.equals("") && (list = this.f10222d) != null) {
            if (!list.isEmpty() || d() == 2) {
                k b2 = a.b();
                ...
                if (d2 == 0) {
                    ...
                    AdSession createAdSession = AdSession.createAdSession(AdSessionConfiguration.createAdSessionConfiguration(creativeType, impressionType, owner, owner, false), AdSessionContext.createNativeAdSessionContext(b2.t(), this.n, this.f10222d, (String) null, (String) null));
                    this.f10219a = createAdSession;
                    this.f10224f = createAdSession.getAdSessionId();
                    b("inject_javascript");
                } else if (d2 == 1) {
                    CreativeType creativeType2 = CreativeType.NATIVE_DISPLAY;
                    AdSession createAdSession2 = AdSession.createAdSession(AdSessionConfiguration.createAdSessionConfiguration(creativeType2, impressionType, owner, (Owner) null, false), AdSessionContext.createNativeAdSessionContext(b2.t(), this.n, this.f10222d, (String) null, (String) null));
                    this.f10219a = createAdSession2;
                    this.f10224f = createAdSession2.getAdSessionId();
                    b("inject_javascript");
                } else if (d2 == 2) {
                    ...
                    this.f10219a = createAdSession3;
                    this.f10224f = createAdSession3.getAdSessionId();
                }
            }
        }
    }
    ...
    public void a(String str, float f2) {
        if (a.c() && this.f10219a != null) {
            if (this.f10221c != null || str.equals("start") || str.equals("skip") || str.equals("continue") || str.equals("cancel")) {
                char c2 = 65535;
                try {
                    switch (str.hashCode()) {
                        case -1941887438:
                    ...
                    switch (c2) {
                        case 0:
                            this.f10220b.impressionOccurred();
                            MediaEvents mediaEvents = this.f10221c;
                            if (mediaEvents != null) {
                                if (f2 <= 0.0f) {
                                    f2 = (float) this.m;
                                }
                            ...
                            return;
                        case 1:
                            this.f10221c.firstQuartile();
                            b(str);
                            return;
                        case 2:
                            this.f10221c.midpoint();
                            b(str);
                            return;
                        case 3:
                            this.f10221c.thirdQuartile();
                            b(str);
                            return;
                        case 4:
                            this.k = true;
                            this.f10221c.complete();
                            b(str);
                            return;
                        case 5:
                            b(str);
                        ...
                        case 6:
                        case 7:
                            MediaEvents mediaEvents2 = this.f10221c;
                            ...
                            return;
                        case 8:
                            this.f10221c.volumeChange(0.0f);
                            b(str);
                            return;
                        case 9:
                            this.f10221c.volumeChange(1.0f);
                            b(str);
                            return;
                        case 10:
                            if (!this.f10225g && !this.f10226h && !this.k) {
                                this.f10221c.pause();
                                b(str);
                                this.f10225g = true;
                                this.f10226h = false;
                        ...
                        case 11:
                            ...
                            return;
                        case 12:
                            this.f10221c.bufferStart();
                            b(str);
                            return;
                        case 13:
                            this.f10221c.bufferFinish();
                            b(str);
                            return;
                        case 14:
                        case 15:
                            this.f10221c.adUserInteraction(InteractionType.CLICK);
                            b(str);
                            if (this.f10226h && !this.f10225g && !this.k) {
                                this.f10221c.pause();
                                b("pause");
                                this.f10225g = true;
                                this.f10226h = false;
                    ...
                    e0.a a2 = new e0.a().a("Recording IAB event for ").a(str);
                    a2.a(" caused " + e2.getClass()).a(e0.f10044g);
                }
            }
        }
    }
