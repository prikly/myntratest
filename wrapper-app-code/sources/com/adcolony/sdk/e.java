...
public final class e extends j {
    ...
    public /* synthetic */ void j() {
        try {
            ...
            String h2 = c0.h(c0.f(a2, "info"), "metadata");
            String a3 = a(p(), c0.h(c0.b(h2), "iab_filepath"));
            Regex regex = new Regex("var\\s*ADC_DEVICE_INFO\\s*=\\s*null\\s*;");
            String replaceFirst = regex.replaceFirst(a3, Matcher.quoteReplacement("var ADC_DEVICE_INFO = " + h2 + ';'));
            String mUrl = getMUrl();
            if (mUrl.length() == 0) {
                mUrl = getBaseUrl();
            }
