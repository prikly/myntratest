...
public final class l0 extends c1 {
    ...
    private final class f {
        ...
        public final void a() {
            if (!l0.this.getModuleInitialized()) {
                ...
                c0.b(info, IabUtils.KEY_WIDTH, (int) (((float) l0Var.getCurrentWidth()) / s));
                c0.b(info, IabUtils.KEY_HEIGHT, (int) (((float) l0Var.getCurrentHeight()) / s));
    ...
    static final class g implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            z0.a(new Intent("android.intent.action.VIEW", Uri.parse(this.f10165a.I)));
            a.b().A().c(this.f10165a.getAdSessionId());
        }
    }
    ...
    public /* synthetic */ void k() {
        if (getMraidFilepath().length() > 0) {
            ...
            setMUrl(a(regex.replaceFirst(getMUrl(), "script src=\"file://" + getMraidFilepath() + '\"'), c0.h(c0.f(getInfo(), "device_info"), "iab_filepath")));
        }
    }
