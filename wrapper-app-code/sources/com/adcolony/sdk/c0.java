...
class c0 {
    ...
    static boolean b(f1 f1Var, String str, int i) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putInteger(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + i).a(e0.i);
            return false;
        }
    }
    ...
    static boolean b(f1 f1Var, String str, long j) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putLong(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + j).a(e0.i);
            return false;
        }
    }
    ...
    static boolean b(f1 f1Var, String str, boolean z) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putBoolean(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + z).a(e0.i);
            return false;
        }
    }
    ...
    static boolean a(f1 f1Var, String str, String str2) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putString(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + str2).a(e0.i);
            return false;
        }
    }
    ...
    static boolean a(f1 f1Var, String str, e1 e1Var) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putArray(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + e1Var).a(e0.i);
            return false;
        }
    }
    ...
    static boolean a(f1 f1Var, String str, f1 f1Var2) {
        try {
            ...
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putObject(): ").a(e2.toString());
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + f1Var2).a(e0.i);
            return false;
        }
    }

    static boolean a(f1 f1Var, String str, double d2) {
        try {
            f1Var.b(str, d2);
            return true;
        } catch (JSONException unused) {
            e0.a a2 = new e0.a().a("JSON error in ADCJSON putDouble(): ");
            e0.a a3 = a2.a(" with key: " + str);
            a3.a(" and value: " + d2).a(e0.i);
            return false;
        }
    }
