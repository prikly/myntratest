...
class a1 extends TextureView implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener {
    private boolean A;
    ...
    class g implements Runnable {
        ...
        public void run() {
            ...
            if (a1.this.R != null) {
                f1 b2 = c0.b();
                c0.b(b2, OSOutcomeConstants.OUTCOME_ID, a1.this.o);
            ...
            while (!a1.this.u && !a1.this.x && a.c()) {
                ...
                if (!a1.this.u && !a1.this.z && a2 != null && (a2 instanceof Activity)) {
                    if (a1.this.O.isPlaying()) {
                        ...
                        if (System.currentTimeMillis() - a1.this.t > 1000 && !a1.this.C && a.f9875d) {
                            if (a1.this.r == 0.0d) {
                    ...
                    if (a1.this.w && !a1.this.u && !a1.this.x) {
                        c0.b(a1.this.P, OSOutcomeConstants.OUTCOME_ID, a1.this.o);
                    ...
                    try {
                        ...
                        a1.this.g();
                        new e0.a().a("InterruptedException in ADCVideoView's update thread.").a(e0.f10045h);
                    }
                } else {
                    return;
                }
    ...
    class i implements Runnable {
        ...
        public void run() {
            j unused = a1.this.M = new j(this.f9904a);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) (a1.this.f9890c * 4.0f), (int) (a1.this.f9890c * 4.0f));
            layoutParams.setMargins(0, a1.this.I.b() - ((int) (a1.this.f9890c * 4.0f)), 0, 0);
    ...
    private class j extends View {
        ...
        public void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            canvas.drawArc(a1.this.L, 270.0f, a1.this.f9891d, false, a1.this.i);
            canvas.drawText("" + a1.this.f9894g, a1.this.L.centerX(), (float) (((double) a1.this.L.centerY()) + (((double) a1.this.j.getFontMetrics().bottom) * 1.35d)), a1.this.j);
            invalidate();
        }
    }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        this.u = true;
        this.r = this.s;
        c0.b(this.P, OSOutcomeConstants.OUTCOME_ID, this.o);
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i2, int i3) {
        g();
        e0.a aVar = new e0.a();
        aVar.a("MediaPlayer error: " + i2 + "," + i3).a(e0.f10045h);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (this.A) {
            ...
            l();
            new e0.a().a("MediaPlayer getVideoWidth = ").a(mediaPlayer.getVideoWidth()).a(e0.f10042e);
            new e0.a().a("MediaPlayer getVideoHeight = ").a(mediaPlayer.getVideoHeight()).a(e0.f10042e);
        }
        f1 b2 = c0.b();
        c0.b(b2, OSOutcomeConstants.OUTCOME_ID, this.o);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i3) {
        ...
        try {
            ...
            new e0.a().a("IllegalStateException thrown when calling MediaPlayer.setSurface()").a(e0.f10045h);
            g();
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        c0.b(b3, "view_x", x2);
        c0.b(b3, "view_y", y2);
        c0.b(b3, OSOutcomeConstants.OUTCOME_ID, this.I.c());
        if (action == 0) {
    ...
    public void g() {
        f1 b2 = c0.b();
        c0.a(b2, OSOutcomeConstants.OUTCOME_ID, this.F);
    ...
    private void l() {
        ...
        new e0.a().a("setMeasuredDimension to ").a(i2).a(" by ").a(i3).a(e0.f10042e);
    ...
    public boolean h() {
        if (!this.y) {
            new e0.a().a("ADCVideoView pause() called while MediaPlayer is not prepared.").a(e0.f10044g);
            return false;
        } else if (!this.w) {
            return false;
        } else {
    ...
    /* access modifiers changed from: package-private */
    public void j() {
        new e0.a().a("MediaPlayer stopped and released.").a(e0.f10042e);
        try {
            if (!this.u && this.y && this.O.isPlaying()) {
                this.O.stop();
            }
        } catch (IllegalStateException unused) {
            new e0.a().a("Caught IllegalStateException when calling stop on MediaPlayer").a(e0.f10044g);
        }
    ...
    public void d() {
        ...
        this.f9893f = a.b().n().s();
        new e0.a().a("Original video dimensions = ").a(this.p).a("x").a(this.q).a(e0.f10040c);
        setVisibility(4);
        ...
        try {
            ...
            new e0.a().a("Failed to create/prepare MediaPlayer: ").a(e2.toString()).a(e0.f10045h);
            g();
        }
    ...
    public void e() {
        if (this.f9895h) {
            this.f9892e = (float) (360.0d / this.s);
            this.j.setColor(-3355444);
            this.j.setShadowLayer((float) ((int) (this.f9893f * 2.0f)), 0.0f, 0.0f, -16777216);
            this.j.setTextAlign(Paint.Align.CENTER);
            this.j.setLinearText(true);
            this.j.setTextSize(this.f9893f * 12.0f);
            this.i.setStyle(Paint.Style.STROKE);
            float f2 = this.f9893f * 2.0f;
            if (f2 > 6.0f) {
                f2 = 6.0f;
            }
            if (f2 < 4.0f) {
            ...
            this.i.setShadowLayer((float) ((int) (this.f9893f * 3.0f)), 0.0f, 0.0f, -16777216);
            this.i.setColor(-3355444);
            Rect rect = new Rect();
            this.j.getTextBounds("0123456789", 0, 9, rect);
            this.f9890c = (float) rect.height();
            Context a2 = a.a();
            if (a2 != null) {
        ...
        this.f9894g = (int) (this.s - this.r);
        float f3 = this.f9890c;
        ...
        this.f9891d = (float) (((double) this.f9892e) * (this.s - this.r));
    }
    ...
    public void c(h0 h0Var) {
        ...
        if (this.B && this.M != null) {
            int i2 = (int) (this.f9890c * 4.0f);
            FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(i2, i2);
            layoutParams2.setMargins(0, this.I.b() - ((int) (this.f9890c * 4.0f)), 0, 0);
    ...
    public boolean a(h0 h0Var) {
        f1 a2 = h0Var.a();
        return c0.d(a2, OSOutcomeConstants.OUTCOME_ID) == this.o && c0.d(a2, "container_id") == this.I.c() && c0.h(a2, "ad_session_id").equals(this.I.a());
    }
