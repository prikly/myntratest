...
public final class CollapsingTextHelper {
    ...
    private void calculateOffsets(float f2) {
        ...
        this.textPaint.setShadowLayer(lerp(this.expandedShadowRadius, this.collapsedShadowRadius, f2, (TimeInterpolator) null), lerp(this.expandedShadowDx, this.collapsedShadowDx, f2, (TimeInterpolator) null), lerp(this.expandedShadowDy, this.collapsedShadowDy, f2, (TimeInterpolator) null), blendColors(getCurrentColor(this.expandedShadowColor), getCurrentColor(this.collapsedShadowColor), f2));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.textToDraw != null && this.drawTitle) {
            ...
            if (z) {
                ...
                CharSequence charSequence = this.textToDraw;
                canvas.drawText(charSequence, 0, charSequence.length(), f3, f5, this.textPaint);
            }
        }
