...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            this.tabIndicatorAnimationDuration = obtainStyledAttributes.getInt(R.styleable.TabLayout_tabIndicatorAnimationDuration, c.COLLECT_MODE_FINANCE);
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (this.textView != null) {
                ...
                if (i4 != 0 || (maxLines >= 0 && i3 != maxLines)) {
                    if (TabLayout.this.mode == 1 && i4 > 0 && lineCount == 1 && ((layout = this.textView.getLayout()) == null || approximateLineWidth(layout, 0, f2) > ((float) ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight())))) {
                        z = false;
                    }
                    if (z) {
        ...
        private void updateIndicatorPosition() {
            ...
            if (childAt == null || childAt.getWidth() <= 0) {
                ...
                if (this.selectionOffset > 0.0f && this.selectedPosition < getChildCount() - 1) {
                    ...
                    i = (int) ((((float) right) * f2) + ((1.0f - f2) * ((float) i)));
                }
            }
