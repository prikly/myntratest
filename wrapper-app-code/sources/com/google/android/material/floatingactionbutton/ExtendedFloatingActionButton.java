...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, IabUtils.KEY_HEIGHT) {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, IabUtils.KEY_WIDTH) {
        public void set(View view, Float f2) {
