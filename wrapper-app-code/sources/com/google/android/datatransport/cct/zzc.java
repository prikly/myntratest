...
final class zzc implements TransportBackend {
    ...
    public EventInternal decorate(EventInternal eventInternal) {
        ...
        EventInternal.Builder addMetadata = eventInternal.toBuilder().addMetadata("sdk-version", Build.VERSION.SDK_INT).addMetadata("model", Build.MODEL).addMetadata("hardware", Build.HARDWARE).addMetadata("device", Build.DEVICE).addMetadata(AppLovinEventTypes.USER_VIEWED_PRODUCT, Build.PRODUCT).addMetadata("os-uild", Build.ID).addMetadata("manufacturer", Build.MANUFACTURER).addMetadata("fingerprint", Build.FINGERPRINT);
    ...
    public zzb zza(zza zza2) throws IOException {
        ...
        try {
            ...
            try {
                ...
                zzb zzb4 = new zzb(responseCode, new URL(httpURLConnection.getHeaderField(LogConstants.EVENT_LOCATION)), 0);
                newChannel.close();
                return zzb4;
