...
public final class zzdra extends zzbmu implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, zzdsc {
    ...
    public final synchronized void onClick(View view) {
        zzdqb zzdqb = this.zze;
        if (zzdqb != null) {
            zzdqb.zzz(view, zzf(), zzl(), zzm(), true);
        }
    }
    ...
    public final synchronized void onGlobalLayout() {
        zzdqb zzdqb = this.zze;
        if (zzdqb != null) {
            zzdqb.zzx(zzf(), zzl(), zzm(), zzdqb.zzT(zzf()));
        }
    }
    ...
    public final synchronized boolean onTouch(View view, MotionEvent motionEvent) {
        zzdqb zzdqb = this.zze;
        if (zzdqb != null) {
            zzdqb.zzG(view, motionEvent, zzf());
        }
        return false;
    }
    ...
    public final synchronized void zzq(java.lang.String r2, android.view.View r3, boolean r4) {
        ...
        L_0x0034:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdra.zzq(java.lang.String, android.view.View, boolean):void");
    }
}
