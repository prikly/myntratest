...
final class zzgye extends zzgwf implements zzgyi, zzgzu, RandomAccess {
    private static final zzgye zza;
    private int[] zzb;
    private int zzc;

    static {
        zzgye zzgye = new zzgye(new int[0], 0);
        zza = zzgye;
        zzgye.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgye.zzb, 0, this.zzb, this.zzc, zzgye.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgye zzgye = (zzgye) obj;
        if (this.zzc != zzgye.zzc) {
            return false;
        }
        int[] iArr = zzgye.zzb;
