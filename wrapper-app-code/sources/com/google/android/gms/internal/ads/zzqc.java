...
final class zzqc extends MediaCodec.Callback {
    ...
    zzqc(HandlerThread handlerThread) {
    ...
    public static /* synthetic */ void zzd(zzqc zzqc) {
        synchronized (zzqc.zza) {
            if (!zzqc.zzl) {
                long j = zzqc.zzk - 1;
                zzqc.zzk = j;
                int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
                if (i <= 0) {
                    if (i < 0) {
                        ...
                        synchronized (zzqc.zza) {
                            zzqc.zzm = illegalStateException;
                        }
                        return;
                    }
                    zzqc.zzi();
    ...
    public final int zza() {
        ...
        L_0x000c:
            ...
            com.google.android.gms.internal.ads.zzqg r1 = r3.zzd     // Catch:{ all -> 0x0023 }
        ...
        L_0x0023:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzqc.zza():int");
    }
    ...
    public final int zzb(android.media.MediaCodec.BufferInfo r10) {
        ...
        L_0x000c:
            ...
            com.google.android.gms.internal.ads.zzqg r1 = r9.zze     // Catch:{ all -> 0x004e }
        ...
        L_0x004e:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzqc.zzb(android.media.MediaCodec$BufferInfo):int");
    }
