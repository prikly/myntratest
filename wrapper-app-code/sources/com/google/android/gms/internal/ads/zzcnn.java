...
public final class zzcnn extends WebChromeClient {
    ...
    private static final Context zzb(WebView webView) {
        ...
        Activity zzk = zzcno.zzk();
        if (zzk != null) {
            return zzk;
        }
        return zzcno.getContext();
    }
    ...
    public final void onExceededDatabaseQuota(String str, String str2, long j, long j2, long j3, WebStorage.QuotaUpdater quotaUpdater) {
        ...
        if (j == 0) {
            ...
            j2 = Math.min(j + Math.min(131072, j4), d.fc);
        } else {
            if (j2 <= Math.min(d.fc - j, j4)) {
                j += j2;
            }
            j2 = j;
        }
    ...
    public final boolean zza(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        ...
        try {
            ...
            if (zzcno == null || zzcno.zzP() == null || this.zza.zzP().zzd() == null || (zzd = this.zza.zzP().zzd()) == null || zzd.zzc()) {
                zzt.zzp();
            ...
            zze.zzk("Fail to display Dialog.", e2);
        }
    }
