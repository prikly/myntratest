...
final class zzpw implements zzqj {
    ...
    /* synthetic */ zzpw(MediaCodec mediaCodec, HandlerThread handlerThread, HandlerThread handlerThread2, boolean z, zzpv zzpv) {
        this.zza = mediaCodec;
        this.zzb = new zzqc(handlerThread);
        this.zzc = new zzqa(mediaCodec, handlerThread2);
    }

    static /* synthetic */ void zzh(zzpw zzpw, MediaFormat mediaFormat, Surface surface, MediaCrypto mediaCrypto, int i) {
        zzpw.zzb.zzf(zzpw.zza);
        int i2 = zzen.zza;
        Trace.beginSection("configureCodec");
        zzpw.zza.configure(mediaFormat, surface, (MediaCrypto) null, 0);
        Trace.endSection();
        zzpw.zzc.zzf();
