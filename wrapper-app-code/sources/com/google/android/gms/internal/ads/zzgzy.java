...
interface zzgzy {
    ...
    @Deprecated
    void zzC(List list, zzhag zzhag, zzgxp zzgxp) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhag zzhag, zzgxp zzgxp) throws IOException;
    ...
    void zzt(Object obj, zzhag zzhag, zzgxp zzgxp) throws IOException;

    void zzu(Object obj, zzhag zzhag, zzgxp zzgxp) throws IOException;
