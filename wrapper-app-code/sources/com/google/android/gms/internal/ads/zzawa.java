...
final class zzawa {
    ...
    public final long zze(zzavf zzavf, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzavf.zzh(this.zzb, 0, 1, z)) {
                return -1;
            }
        ...
        if (i2 != 1) {
            zzavf.zzh(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
