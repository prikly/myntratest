...
public final class zzbcr {
    ...
    public final Activity zza() {
        synchronized (this.zza) {
            zzbcp zzbcp = this.zzb;
            if (zzbcp == null) {
                return null;
            }
            Activity zza2 = zzbcp.zza();
            return zza2;
        }
    }
    ...
    public final Context zzb() {
        synchronized (this.zza) {
            ...
            Context zzb2 = zzbcp.zzb();
            return zzb2;
        }
    }

    public final void zzc(zzbcq zzbcq) {
        synchronized (this.zza) {
            if (this.zzb == null) {
                this.zzb = new zzbcp();
            }
    ...
    public final void zzd(android.content.Context r4) {
        ...
        L_0x0016:
            ...
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzbcp r2 = r3.zzb     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x002a
            com.google.android.gms.internal.ads.zzbcp r2 = new com.google.android.gms.internal.ads.zzbcp     // Catch:{ all -> 0x0034 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbcr.zzd(android.content.Context):void");
    }

    public final void zze(zzbcq zzbcq) {
        synchronized (this.zza) {
            zzbcp zzbcp = this.zzb;
            if (zzbcp != null) {
                zzbcp.zzh(zzbcq);
