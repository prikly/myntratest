...
public final class zzqo extends Exception {
    ...
    static /* bridge */ /* synthetic */ zzqo zza(zzqo zzqo, zzqo zzqo2) {
        return new zzqo(zzqo.getMessage(), zzqo.getCause(), zzqo.zza, false, zzqo.zzc, zzqo.zzd, zzqo2);
    }
    ...
    private zzqo(String str, Throwable th, String str2, boolean z, zzqm zzqm, String str3, zzqo zzqo) {
        super(str, th);
        this.zza = str2;
        this.zzb = false;
        this.zzc = zzqm;
