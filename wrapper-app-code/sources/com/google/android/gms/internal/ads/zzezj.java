...
public final class zzezj implements zzezm {
    ...
    zzezj(zzgfc zzgfc, Context context) {
        this.zza = zzgfc;
        this.zzb = context;
    }
    ...
    public final zzgfb zzb() {
        return this.zza.zzb(new zzezh(this));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzezl zzd() throws Exception {
        String str = (String) zzba.zzc().zzb(zzbjj.zzfA);
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            return new zzezi(zzc(this.zzb, new JSONArray(str)));
        } catch (JSONException e2) {
            zze.zzf("JSON parsing error", e2);
            return null;
        }
    }
}
