...
public final class zzvf extends zzcu {
                                    ...
                                    if (indexOfKey >= 0) {
                                        ...
                                        if (map2.size() == map.size()) {
                                            for (Map.Entry entry : map.entrySet()) {
                                                zzug zzug = (zzug) entry.getKey();
                                                if (map2.containsKey(zzug)) {
                                                    if (!zzen.zzT(entry.getValue(), map2.get(zzug))) {
                                                    }
                                                }
                                            }
                                            i2++;
    ...
    @Deprecated
    public final zzvh zze(int i, zzug zzug) {
        Map map = (Map) this.zzT.get(i);
        if (map != null) {
            return (zzvh) map.get(zzug);
        }
        return null;
    }
    ...
    @Deprecated
    public final boolean zzg(int i, zzug zzug) {
        Map map = (Map) this.zzT.get(i);
        return map != null && map.containsKey(zzug);
    }
}
