...
public final class zzaqr implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzaqr(Context context, zzaqc zzaqc) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzaqq zzaqq = new zzaqq(this);
            this.zzf = zzaqq;
            this.zzb.registerReceiver(zzaqq, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0038:
            ...
            com.google.android.gms.internal.ads.zzapz r0 = r3.zzj     // Catch:{ Exception -> 0x0041 }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x0041 }
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaqr.zzi(android.view.View):void");
    }
