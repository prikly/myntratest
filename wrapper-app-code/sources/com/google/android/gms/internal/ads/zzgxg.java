...
final class zzgxg extends zzgxk {
    ...
    public final void zzi(int i) throws IOException {
        try {
            ...
            throw new zzgxh(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), 1}), e2);
        }
    }
    ...
    public final void zze(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgxh(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), Integer.valueOf(i2)}), e2);
        }
    }
