...
public final class zzdpr extends zzbmh {
    ...
    public final float zze() throws RemoteException {
        ...
        if (this.zza.zzj() != null) {
            try {
                ...
                zze.zzh("Remote exception getting video controller aspect ratio.", e2);
                return 0.0f;
            }
        } else {
    ...
    public final float zzf() throws RemoteException {
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzfI)).booleanValue() && this.zza.zzj() != null) {
    ...
    public final void zzl(zzbnt zzbnt) {
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzfI)).booleanValue() && (this.zza.zzj() instanceof zzcok)) {
            ((zzcok) this.zza.zzj()).zzv(zzbnt);
        }
    }
}
