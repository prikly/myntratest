...
public final class zzaaw {
    ...
    public static zzaat zzc(zzef zzef, boolean z, boolean z2) throws zzbu {
        if (z) {
            zzd(3, zzef, false);
        }
        String zzx = zzef.zzx((int) zzef.zzq(), zzfxr.zzc);
        long zzq = zzef.zzq();
        String[] strArr = new String[((int) zzq)];
        int length = zzx.length() + 15;
        for (int i = 0; ((long) i) < zzq; i++) {
            String zzx2 = zzef.zzx((int) zzef.zzq(), zzfxr.zzc);
            strArr[i] = zzx2;
