...
public final class zzchn {
    ...
    private final void zzo(String str, zzchm zzchm) {
    ...
    private final void zzp(String str) {
        zzo("onNetworkRequestError", new zzchj(str));
    }

    private final void zzq(String str, String str2, Map map, byte[] bArr) {
        zzo("onNetworkRequest", new zzchk(str, str2, map, bArr));
    }

    private final void zzr(Map map, int i) {
        zzo("onNetworkResponse", new zzchi(i, map));
    }
    ...
    public final void zzh(byte[] bArr) {
        zzo("onNetworkResponseBody", new zzchl(bArr));
    }
