...
final class zzhbm {
    private static final zzhbj zza = new zzhbk();
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgyp {
        zzhbj zzhbj = zza;
        if (byteBuffer.hasArray()) {
            return zzhbj.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
    ...
    static String zzh(byte[] bArr, int i, int i2) throws zzgyp {
