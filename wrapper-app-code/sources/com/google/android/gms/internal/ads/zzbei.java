...
public final class zzbei extends AbstractSafeParcelable {
    ...
    zzbei(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzbei zza(Uri uri) {
        ...
        try {
            ...
            return new zzbei(queryParameter, j, host, str, str2, bundle, equals, 0, "", 0);
        } catch (NullPointerException | NumberFormatException e2) {
            zze.zzk("Unable to parse Uri into cache offering.", e2);
            return null;
        }
    }
