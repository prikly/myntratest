...
final class zzakx {
    ...
    zzakx(java.lang.String r14, com.google.android.gms.internal.ads.zzajn r15) {
        /*
            r13 = this;
    ...
    static zzakx zza(zzaky zzaky) throws IOException {
        if (zzala.zze(zzaky) == 538247942) {
            String zzh2 = zzala.zzh(zzaky);
            String zzh3 = zzala.zzh(zzaky);
            long zzf2 = zzala.zzf(zzaky);
            long zzf3 = zzala.zzf(zzaky);
            long zzf4 = zzala.zzf(zzaky);
            long zzf5 = zzala.zzf(zzaky);
            int zze2 = zzala.zze(zzaky);
            if (zze2 >= 0) {
                List emptyList = zze2 == 0 ? Collections.emptyList() : new ArrayList();
                for (int i = 0; i < zze2; i++) {
                    emptyList.add(new zzajw(zzala.zzh(zzaky).intern(), zzala.zzh(zzaky).intern()));
                }
                return new zzakx(zzh2, zzh3, zzf2, zzf3, zzf4, zzf5, emptyList);
            }
