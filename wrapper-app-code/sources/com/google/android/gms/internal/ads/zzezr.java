...
public final class zzezr implements zzezl {
    ...
    public zzezr(boolean z, boolean z2, String str, boolean z3, boolean z4, boolean z5, String str2, ArrayList arrayList, String str3, String str4, String str5, boolean z6, String str6, long j, boolean z7) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
    ...
    public final /* bridge */ /* synthetic */ void zzf(Object obj) {
        ...
        Bundle zza3 = zzfjr.zza(zza2, "browser");
        zza2.putBundle("browser", zza3);
        zza3.putBoolean("is_browser_custom_tabs_capable", this.zzl);
        if (!TextUtils.isEmpty(this.zzj)) {
            Bundle zza4 = zzfjr.zza(zza2, "play_store");
            zza2.putBundle("play_store", zza4);
            zza4.putString("package_version", this.zzj);
        }
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzjs)).booleanValue()) {
            bundle.putBoolean("is_bstar", this.zzo);
        }
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzjq)).booleanValue()) {
            bundle.putBoolean("gotmt_l", ((Boolean) zzba.zzc().zzb(zzbjj.zzjn)).booleanValue());
            bundle.putBoolean("gotmt_i", ((Boolean) zzba.zzc().zzb(zzbjj.zzjm)).booleanValue());
        }
    }
}
