...
public final class zzchh {
    ...
    private final void zzD(JSONObject jSONObject, String str, Object obj) throws JSONException {
        ...
        Double[] dArr;
        Integer[] numArr;
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzr)).booleanValue()) {
    ...
    public static final void zzx(Context context, String str, String str2, Bundle bundle, boolean z, zzchg zzchg) {
        ...
        Uri.Builder appendQueryParameter = new Uri.Builder().scheme("https").path("//pagead2.googlesyndication.com/pagead/gen_204").appendQueryParameter(OSOutcomeConstants.OUTCOME_ID, "gmob-apps");
        for (String str3 : bundle.keySet()) {
            appendQueryParameter.appendQueryParameter(str3, bundle.getString(str3));
        }
        zzchg.zza(appendQueryParameter.toString());
    }
