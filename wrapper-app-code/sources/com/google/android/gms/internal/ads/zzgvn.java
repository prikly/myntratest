...
final class zzgvn {
    ...
    static void zzb(long[] r18, long[] r19, long[] r20) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgvn.zzb(long[], long[], long[]):void");
    }
    ...
    static byte[] zzj(long[] jArr) {
        ...
        for (int i21 = 0; i21 < 10; i21++) {
            ...
            byte b2 = bArr[i22];
            long j8 = copyOf[i21];
            bArr[i22] = (byte) ((int) (((long) b2) | (j8 & 255)));
            int i23 = iArr[i21] + 1;
