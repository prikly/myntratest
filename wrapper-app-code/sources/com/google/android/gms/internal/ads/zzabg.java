...
final class zzabg {
    ...
    public zzabg(int i, int i2, long j, int i3, zzaaq zzaaq) {
        i2 = i2 != 1 ? 2 : i2;
        this.zzd = j;
        this.zze = i3;
        this.zza = zzaaq;
    ...
    private final zzaan zzk(int i) {
        return new zzaan(((long) this.zzl[i]) * zzj(1), this.zzk[i]);
    }
    ...
    public final zzaak zza(long j) {
        ...
        if (this.zzl[zzc2] == zzj2) {
            zzaan zzk2 = zzk(zzc2);
            return new zzaak(zzk2, zzk2);
        }
        zzaan zzk3 = zzk(zzc2);
        int i = zzc2 + 1;
        return i < this.zzk.length ? new zzaak(zzk3, zzk(i)) : new zzaak(zzk3, zzk3);
    }
    ...
    public final boolean zzh(zzzk zzzk) throws IOException {
        int i = this.zzg;
        int zze2 = i - this.zza.zze(zzzk, i, false);
        this.zzg = zze2;
        boolean z = zze2 == 0;
        if (z) {
            if (this.zzf > 0) {
                this.zza.zzs(zzj(this.zzh), Arrays.binarySearch(this.zzl, this.zzh) >= 0 ? 1 : 0, this.zzf, 0, (zzaap) null);
            }
            this.zzh++;
        }
        return z;
