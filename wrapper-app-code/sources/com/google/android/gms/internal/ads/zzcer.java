...
public final class zzcer implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    zzcer(Context context, zzg zzg, zzcft zzcft) {
    ...
    private final void zzb(String str, int i) {
        Context context;
        boolean z = false;
        if (!((Boolean) zzba.zzc().zzb(zzbjj.zzat)).booleanValue() ? str.isEmpty() || str.charAt(0) != '1' : i == 0 || str.isEmpty() || (str.charAt(0) != '1' && !str.equals("-1"))) {
            z = true;
        }
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzar)).booleanValue()) {
            this.zzc.zzH(z);
            if (((Boolean) zzba.zzc().zzb(zzbjj.zzfE)).booleanValue() && z && (context = this.zza) != null) {
    ...
    public final void onSharedPreferenceChanged(android.content.SharedPreferences r9, java.lang.String r10) {
        /*
            r8 = this;
            com.google.android.gms.internal.ads.zzbjb r0 = com.google.android.gms.internal.ads.zzbjj.zzav
            ...
            boolean r0 = com.google.android.gms.internal.ads.zzceq.zza(r10, r5)
            if (r0 == 0) goto L_0x004a
            com.google.android.gms.internal.ads.zzbjb r10 = com.google.android.gms.internal.ads.zzbjj.zzat
        ...
        L_0x004a:
            ...
            boolean r0 = com.google.android.gms.internal.ads.zzceq.zza(r10, r0)
            if (r0 != 0) goto L_0x0060
            java.lang.String r0 = "IABTCF_TCString"
            boolean r0 = com.google.android.gms.internal.ads.zzceq.zza(r10, r0)
            if (r0 != 0) goto L_0x0060
            boolean r0 = com.google.android.gms.internal.ads.zzceq.zza(r10, r2)
        ...
        L_0x00df:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcer.onSharedPreferenceChanged(android.content.SharedPreferences, java.lang.String):void");
    }
    ...
    public final void zza() {
        ...
        if (((Boolean) zzba.zzc().zzb(zzbjj.zzav)).booleanValue()) {
