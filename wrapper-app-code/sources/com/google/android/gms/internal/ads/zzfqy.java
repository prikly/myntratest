...
public final class zzfqy {
    ...
    public static JSONObject zza(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            jSONObject.put(IabUtils.KEY_WIDTH, (double) (((float) i3) / zza));
            jSONObject.put(IabUtils.KEY_HEIGHT, (double) (((float) i4) / zza));
    ...
    public static void zzd(JSONObject jSONObject, zzfrc zzfrc) {
        zzfqk zza2 = zzfrc.zza();
        JSONArray jSONArray = new JSONArray();
        ArrayList zzb2 = zzfrc.zzb();
        int size = zzb2.size();
    ...
    public static void zzi(JSONObject jSONObject) {
        ...
        if (zzb != null) {
            ...
            f3 = ((float) point.x) / zza;
            f2 = ((float) point.y) / zza;
        } else {
            f2 = 0.0f;
        }
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, (double) f3);
            jSONObject.put(IabUtils.KEY_HEIGHT, (double) f2);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }
