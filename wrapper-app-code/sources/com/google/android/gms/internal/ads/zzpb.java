...
final class zzpb {
    ...
    public final void zze() {
        ...
        float f2 = this.zzc;
        float f3 = this.zzd;
        int i3 = this.zzm + ((int) ((((((float) i2) / (f2 / f3)) + ((float) this.zzo)) / (this.zze * f3)) + 0.5f));
        short[] sArr = this.zzj;
        int i4 = this.zzh;
                ...
                while (true) {
                    ...
                    if (i13 > 0) {
                        ...
                        if (d2 > 1.0d) {
                            ...
                            if (f4 >= 2.0f) {
                                i7 = (int) (((float) i23) / (-1.0f + f4));
                            } else {
                                this.zzr = (int) ((((float) i23) * (2.0f - f4)) / (-1.0f + f4));
                                i7 = i23;
                            }
                            ...
                            if (f4 < 0.5f) {
                                i6 = (int) ((((float) i25) * f4) / (f6 - f4));
                            } else {
                                this.zzr = (int) ((((float) i25) * ((f4 + f4) - 4.0f)) / (f6 - f4));
                                i6 = i25;
                            }
                            int i26 = i25 + i6;
