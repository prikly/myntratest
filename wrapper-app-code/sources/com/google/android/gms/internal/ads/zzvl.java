...
final class zzvl extends zzvn implements Comparable {
    ...
    public zzvl(int i, zzcp zzcp, int i2, zzvf zzvf, int i3, String str) {
        ...
        while (true) {
            ...
            boolean z = zzvf.zzy;
            i4 = zzvr.zza(this.zzd, (String) zzgau.get(i8), false);
            if (i4 > 0) {
                break;
            }
            i8++;
    ...
    public final int compareTo(zzvl zzvl) {
        zzgcc zzgcc;
        zzgaj zzd = zzgaj.zzj().zzd(this.zzf, zzvl.zzf).zzc(Integer.valueOf(this.zzi), Integer.valueOf(zzvl.zzi), zzgcc.zzc().zza()).zzb(this.zzj, zzvl.zzj).zzb(this.zzk, zzvl.zzk).zzd(this.zzg, zzvl.zzg);
        ...
        zzgaj zzb = zzd.zzc(valueOf, valueOf2, zzgcc).zzb(this.zzl, zzvl.zzl);
        if (this.zzk == 0) {
            boolean z = zzvl.zzm;
