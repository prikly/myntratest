...
public final class zzfrz {
    ...
    public static zzfrz zza(Context context, Executor executor, boolean z) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z) {
            executor.execute(new zzfrv(context, taskCompletionSource));
        } else {
            executor.execute(new zzfrw(taskCompletionSource));
        }
    ...
    private final Task zzh(int i, long j, Exception exc, String str, Map map, String str2) {
        if (!this.zze) {
            return this.zzd.continueWith(this.zzc, zzfrx.zza);
        }
        ...
        return this.zzd.continueWith(this.zzc, new zzfry(zza2, i));
    }
