...
public final class zzbyl extends zzbyt {
    ...
    public final void zzc() {
        ...
        zzG.setPositiveButton(zzd2 != null ? zzd2.getString(R.string.s3) : "Accept", new zzbyj(this));
        zzG.setNegativeButton(zzd2 != null ? zzd2.getString(R.string.s4) : "Decline", new zzbyk(this));
        zzG.create().show();
    }
}
