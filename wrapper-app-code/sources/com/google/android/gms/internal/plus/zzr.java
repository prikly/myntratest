...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        public static final class C0063zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C0063zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            static {
                ...
                zzao.put(IabUtils.KEY_WIDTH, FastJsonResponse.Field.forInteger(IabUtils.KEY_WIDTH, 4));
            }
            ...
            C0063zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
        ...
        static {
            ...
            zzao.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C0063zzb.class));
        ...
        zzb(Set<Integer> set, int i, zza zza2, C0063zzb zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zza2;
            this.zzbq = zzb;
    ...
    static {
        ...
        zzao.put(OSOutcomeConstants.OUTCOME_ID, FastJsonResponse.Field.forString(OSOutcomeConstants.OUTCOME_ID, 14));
