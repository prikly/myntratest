...
final class zzjj extends zzjm {
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzjk(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e2);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzjk(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e2);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzjm.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzmy.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
