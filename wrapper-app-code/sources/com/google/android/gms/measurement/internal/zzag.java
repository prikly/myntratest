...
public final class zzag extends zzgk {
    ...
    private final String zzB(String str, String str2) {
        try {
            String str3 = (String) Class.forName("android.os.SystemProperties").getMethod(Constants.GET, new Class[]{String.class, String.class}).invoke((Object) null, new Object[]{str, ""});
            ...
            this.zzt.zzay().zzd().zzb("Could not access SystemProperties.get()", e4);
            return "";
