...
public final class zzkt implements zzgm {
    ...
    public final void zzD(zzh zzh2) {
        ...
        if (!TextUtils.isEmpty(zzh2.zzy()) || !TextUtils.isEmpty(zzh2.zzr())) {
            ...
            Uri.Builder appendQueryParameter = builder.scheme((String) zzdu.zzd.zza((Object) null)).encodedAuthority((String) zzdu.zze.zza((Object) null)).path("config/app/".concat(String.valueOf(zzy2))).appendQueryParameter("platform", MetricCommonTags.METRIC_COMMON_TAG_PLATFORM_ANDROID);
            zzki.zzt.zzf().zzh();
                ...
                try {
                    for (Long l : list) {
                        try {
                            ...
                            zzam.zzt.zzay().zzd().zzb("Failed to delete a bundle in a queue table", e2);
                            throw e2;
    ...
    public final void zzQ(zzq zzq2) {
        ...
        try {
            ...
            zzam.zzt.zzay().zzd().zzc("Error resetting analytics data. appId, error", zzeh.zzn(str), e2);
        }
        if (zzq2.zzh) {
            zzL(zzq2);
        }
    ...
    public final void zzV(String str, zzai zzai) {
        ...
        try {
            ...
            zzam.zzt.zzay().zzd().zzc("Error storing consent setting. appId, error", zzeh.zzn(str), e2);
        }
    }
    ...
    public final zzai zzh(String str) {
        ...
        try {
            ...
            zzam.zzt.zzay().zzd().zzc("Database error", "select consent_state from consent_settings where app_id=? limit 1;", e2);
            throw e2;
        } catch (Throwable th) {
            if (cursor != null) {
                cursor.close();
    ...
    public final String zzx(zzq zzq2) {
        try {
            ...
            zzay().zzd().zzc("Failed to get app instance id. appId", zzeh.zzn(zzq2.zza), e2);
            return null;
        }
    }
