...
public final class zzgj extends zzdw {
    ...
    public final List zze(zzq zzq, boolean z) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzc("Failed to get user properties. appId", zzeh.zzn(zzq.zza), e2);
            return null;
        }
    }
    ...
    public final List zzh(String str, String str2, boolean z, zzq zzq) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzc("Failed to query user properties. appId", zzeh.zzn(zzq.zza), e2);
            return Collections.emptyList();
        }
    }
    ...
    public final byte[] zzu(zzaw zzaw, String str) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzd("Failed to log and bundle. appId, event, error", zzeh.zzn(str), this.zza.zzj().zzd(zzaw.zza), e2);
            return null;
        }
    }
