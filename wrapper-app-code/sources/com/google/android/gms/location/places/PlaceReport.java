...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static PlaceReport create(String str, String str2) {
        ...
        Preconditions.checkNotEmpty(DtbDeviceDataRetriever.ORIENTATION_UNKNOWN);
        Preconditions.checkArgument(true, "Invalid source");
        return new PlaceReport(1, str, str2, DtbDeviceDataRetriever.ORIENTATION_UNKNOWN);
    }
    ...
    public String toString() {
        ...
        if (!DtbDeviceDataRetriever.ORIENTATION_UNKNOWN.equals(this.zzb)) {
