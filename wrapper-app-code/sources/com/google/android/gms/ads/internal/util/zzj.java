...
public final class zzj implements zzg {
    ...
    private final void zzR() {
        ...
        if (zzgfb != null && !zzgfb.isDone()) {
            try {
                ...
                zze.zzh("Fail to initialize AdSharedPreferenceManager.", e3);
            }
        }
    }

    private final void zzS() {
        zzcib.zza.execute(new zzi(this));
    }
    ...
    public final void zzr(Context context) {
        synchronized (this.zza) {
            if (this.zzf == null) {
                this.zzd = zzcib.zza.zza(new zzh(this, context, "admob"));
                this.zzb = true;
            }
        }
    }
