        ...
        if (c2 == 0) {
            ...
            if (MessagingAnalytics.shouldUploadFirelogAnalytics(intent)) {
                ...
                if (transportFactory != null) {
                    MessagingAnalytics.logNotificationReceived(intent, transportFactory.getTransport("FCM_CLIENT_EVENT_LOGGING", String.class, Encoding.of("json"), FirebaseMessagingService$$Lambda$0.$instance));
                } else {
