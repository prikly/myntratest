...
public class n {
    ...
    private static volatile n f19256c;

    /* renamed from: a  reason: collision with root package name */
    private Map<String, String> f19257a;

    /* renamed from: b  reason: collision with root package name */
    private volatile boolean f19258b = false;
    ...
    private n(Context context) {
        if (context != null && this.f19259d == null) {
            this.f19259d = context.getApplicationContext();
            a();
        }
    ...
    private java.lang.String d(java.lang.String r3) {
        ...
        L_0x000c:
            r2.a()
            java.util.Map<java.lang.String, java.lang.String> r0 = r2.f19257a
    ...
    private void a() {
        if (this.f19259d != null && !this.f19258b) {
            synchronized (this) {
                if (!this.f19258b) {
                    List<String> list = (List) AccessController.doPrivileged(new PrivilegedAction<List<String>>() {
                        ...
                        public java.util.List<java.lang.String> run() {
                            /*
                                ...
                                android.content.Context r2 = r2.f19259d     // Catch:{ all -> 0x003c }
                    ...
                    this.f19257a = new HashMap(list.size());
                    String str = "";
    ...
    private void a(String str, String str2) {
        if (str != null && !str.isEmpty() && str2 != null && !str2.isEmpty() && !this.f19257a.containsKey(str)) {
            this.f19257a.put(str, str2);
        }
    }
}
