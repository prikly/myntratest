...
public class SSWebView extends FrameLayout {
    ...
    private com.bytedance.sdk.component.widget.b.a f19278a;

    /* renamed from: b  reason: collision with root package name */
    private String f19279b;

    /* renamed from: c  reason: collision with root package name */
    private JSONObject f19280c;
    ...
    private void a(MotionEvent motionEvent) {
        if (this.f19281d && this.f19278a != null) {
            if ((this.f19279b != null || this.f19280c != null) && motionEvent != null) {
                try {
                    int action = motionEvent.getAction();
                    if (action == 0) {
                        this.f19282e = motionEvent.getRawX();
                        this.f19283f = motionEvent.getRawY();
                        this.f19284g = System.currentTimeMillis();
                        this.f19280c = new JSONObject();
                        if (this.k != null) {
                            this.k.setTag(t.e(getContext(), "tt_id_click_begin"), Long.valueOf(this.f19284g));
                        }
                    } else if (action == 1 || action == 3) {
                        this.f19280c.put("start_x", String.valueOf(this.f19282e));
                        this.f19280c.put("start_y", String.valueOf(this.f19283f));
                        this.f19280c.put("offset_x", String.valueOf(motionEvent.getRawX() - this.f19282e));
                        this.f19280c.put("offset_y", String.valueOf(motionEvent.getRawY() - this.f19283f));
                        this.f19280c.put("url", String.valueOf(getUrl()));
                        this.f19280c.put("tag", "");
                        this.f19285h = System.currentTimeMillis();
                        if (this.k != null) {
                            this.k.setTag(t.e(getContext(), "tt_id_click_end"), Long.valueOf(this.f19285h));
                        }
                        this.f19280c.put("down_time", this.f19284g);
                        this.f19280c.put("up_time", this.f19285h);
                        if (com.bytedance.sdk.component.widget.a.a.a().b() != null && this.i != this.f19284g) {
                            this.i = this.f19284g;
                            com.bytedance.sdk.component.widget.a.a.a().b().a(this.f19278a, this.f19279b, "in_web_click", this.f19280c, this.f19285h - this.f19284g);
                        }
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
    ...
    public void a() {
        try {
            this.k = this.p == null ? new WebView(a(this.q)) : new WebView(a(this.q), this.p);
            b();
            b(a(this.q));
        } catch (Throwable unused) {
        }
