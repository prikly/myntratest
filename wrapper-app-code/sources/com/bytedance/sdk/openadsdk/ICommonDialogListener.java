...
public interface ICommonDialogListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICommonDialogListener {
        ...
        private static class a implements ICommonDialogListener {
            ...
            public static ICommonDialogListener f19320a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f19321b;

            a(IBinder iBinder) {
                this.f19321b = iBinder;
            }
            ...
            public void onDialogBtnYes() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f19321b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onDialogBtnNo() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.ICommonDialogListener");
                    if (this.f19321b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onDialogCancel() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.ICommonDialogListener");
                    if (this.f19321b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(ICommonDialogListener iCommonDialogListener) {
            if (a.f19320a != null || iCommonDialogListener == null) {
                return false;
            }
            a.f19320a = iCommonDialogListener;
            return true;
        }
