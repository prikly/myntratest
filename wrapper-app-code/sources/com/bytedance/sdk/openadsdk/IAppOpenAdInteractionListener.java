...
public interface IAppOpenAdInteractionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppOpenAdInteractionListener {
        ...
        private static class a implements IAppOpenAdInteractionListener {
            ...
            public static IAppOpenAdInteractionListener f19316a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f19317b;

            a(IBinder iBinder) {
                this.f19317b = iBinder;
            }
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f19317b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onAdShow() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f19317b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdClicked() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f19317b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdSkip() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f19317b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdTimeOver() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f19317b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(IAppOpenAdInteractionListener iAppOpenAdInteractionListener) {
            if (a.f19316a != null || iAppOpenAdInteractionListener == null) {
                return false;
            }
            a.f19316a = iAppOpenAdInteractionListener;
            return true;
        }
