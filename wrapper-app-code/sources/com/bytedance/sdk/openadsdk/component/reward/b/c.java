...
public class c extends a {
    ...
    public void a(FrameLayout frameLayout) {
        FullInteractionStyleView fullInteractionStyleView = new FullInteractionStyleView(this.f672a, this.f678g);
        this.i = fullInteractionStyleView;
        fullInteractionStyleView.setDownloadListener(this.f679h);
        this.i.a(this.f673b, this.f677f, this.f676e, this.f674c, this.f675d);
