...
public abstract class e extends a {
    ...
    public abstract void a(View view, float f2, float f3, float f4, float f5, SparseArray<c.a> sparseArray, int i, int i2, int i3, boolean z);
    ...
    public void a(View view, float f2, float f3, float f4, float f5, SparseArray<c.a> sparseArray, boolean z) {
        View view2 = view;
        if (a(view, z)) {
            a(view, f2, f3, f4, f5, sparseArray, this.A, this.y, this.z, z);
        }
