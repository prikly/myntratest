...
public class f extends a {
    ...
    private static Map<String, RemoteCallbackList<IFullScreenVideoAdInteractionListener>> f2118a = Collections.synchronizedMap(new HashMap());

    /* renamed from: b  reason: collision with root package name */
    private static volatile f f2119b;
    ...
    public synchronized void registerFullVideoListener(String str, IFullScreenVideoAdInteractionListener iFullScreenVideoAdInteractionListener) throws RemoteException {
        ...
        f2118a.put(str, remoteCallbackList);
    }
        ...
        try {
            if (f2118a != null) {
                if ("recycleRes".equals(str2)) {
                    remoteCallbackList = f2118a.remove(str);
                } else {
                    remoteCallbackList = f2118a.get(str);
                }
