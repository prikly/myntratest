...
public class h extends a {
    ...
    private static Map<String, RemoteCallbackList<IRewardAdInteractionListener>> f2121a = Collections.synchronizedMap(new HashMap());

    /* renamed from: b  reason: collision with root package name */
    private static volatile h f2122b;
    ...
    public synchronized void registerRewardVideoListener(String str, IRewardAdInteractionListener iRewardAdInteractionListener) throws RemoteException {
        ...
        f2121a.put(str, remoteCallbackList);
    }
            ...
            try {
                if (f2121a != null) {
                    if ("recycleRes".equals(str2)) {
                        remoteCallbackList = f2121a.remove(str);
                    } else {
                        remoteCallbackList = f2121a.get(str);
                    }
