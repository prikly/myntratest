...
public class pgla {
    ...
    static class C0223pgla extends pblb.pgla {
        C0223pgla() {
        }
        ...
        public Object a(int i, long j, String str, Object obj) throws Throwable {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 17) {
                    ...
                    r0.f9740a = defaultDisplay.getWidth();
                    i2 = defaultDisplay.getHeight();
                    r0.f9741b = i2;
                    return r0.f9740a + "*" + r0.f9741b;
                }
                r0.f9740a = point.x;
                i2 = point.y;
                r0.f9741b = i2;
    ...
    public static void a() {
        ms.bd.o.Pgl.pblb.a(268435457, (pblb.pgla) new C0223pgla());
