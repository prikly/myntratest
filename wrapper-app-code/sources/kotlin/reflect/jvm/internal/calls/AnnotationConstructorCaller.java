...
public final class AnnotationConstructorCaller implements Caller {
    ...
    public AnnotationConstructorCaller(Class<?> cls, List<String> list, CallMode callMode2, Origin origin, List<Method> list2) {
        ...
        Intrinsics.checkNotNullParameter(origin, AppMeasurementSdk.ConditionalUserProperty.ORIGIN);
        ...
        if (this.callMode == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && (!CollectionsKt.minus(this.parameterNames, AppMeasurementSdk.ConditionalUserProperty.VALUE).isEmpty())) {
