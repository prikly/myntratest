...
public abstract class JvmPropertySignature {
    ...
    public static final class KotlinProperty extends JvmPropertySignature {
        ...
        public KotlinProperty(PropertyDescriptor propertyDescriptor, ProtoBuf.Property property, JvmProtoBuf.JvmPropertySignature jvmPropertySignature, NameResolver nameResolver2, TypeTable typeTable2) {
            ...
            Intrinsics.checkNotNullParameter(jvmPropertySignature, InAppPurchaseMetaData.KEY_SIGNATURE);
            ...
            if (jvmPropertySignature.hasGetter()) {
                str = Intrinsics.stringPlus(this.nameResolver.getString(this.signature.getGetter().getName()), this.nameResolver.getString(this.signature.getGetter().getDesc()));
            } else {
                ...
                if (jvmFieldSignature$default != null) {
                    ...
                    throw new KotlinReflectionInternalError(Intrinsics.stringPlus("No field signature for property: ", this.descriptor));
                }
            }
            this.string = str;
        }
