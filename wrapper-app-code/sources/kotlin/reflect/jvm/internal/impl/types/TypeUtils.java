...
public class TypeUtils {
    ...
    public static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1) {
        ...
        return contains(kotlinType, function1, (Function1<KotlinType, Boolean>) null, (SmartSet<KotlinType>) null);
    }
    ...
    public static boolean containsStoppingAt(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, Function1<KotlinType, Boolean> function12) {
        ...
        return contains(kotlinType, function1, function12, (SmartSet<KotlinType>) null);
    }
    ...
    private static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, Function1<KotlinType, Boolean> function12, SmartSet<KotlinType> smartSet) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            for (KotlinType contains : ((IntersectionTypeConstructor) constructor).getSupertypes()) {
                if (contains(contains, function1, function12, smartSet)) {
                    return true;
                }
            }
            return false;
        ...
        for (TypeProjection next : kotlinType.getArguments()) {
            if (!next.isStarProjection()) {
                if (contains(next.getType(), function1, function12, smartSet)) {
                    return true;
                }
            }
        }
