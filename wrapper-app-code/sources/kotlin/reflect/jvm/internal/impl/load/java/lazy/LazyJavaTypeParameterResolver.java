...
public final class LazyJavaTypeParameterResolver implements TypeParameterResolver {
    ...
    public final LazyJavaResolverContext f9672c;
    /* access modifiers changed from: private */
    public final DeclarationDescriptor containingDeclaration;
    private final MemoizedFunctionToNullable<JavaTypeParameter, LazyJavaTypeParameterDescriptor> resolve = this.f9672c.getStorageManager().createMemoizedFunctionWithNullableValues(new LazyJavaTypeParameterResolver$resolve$1(this));
    /* access modifiers changed from: private */
    ...
    public LazyJavaTypeParameterResolver(LazyJavaResolverContext lazyJavaResolverContext, DeclarationDescriptor declarationDescriptor, JavaTypeParameterListOwner javaTypeParameterListOwner, int i) {
        ...
        this.f9672c = lazyJavaResolverContext;
    ...
    public TypeParameterDescriptor resolveTypeParameter(JavaTypeParameter javaTypeParameter) {
        ...
        return invoke == null ? this.f9672c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter) : invoke;
    }
}
