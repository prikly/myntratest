...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    public final LazyJavaResolverContext f9676c;
    /* access modifiers changed from: private */
    public final JavaPackage jPackage;
    private final NotNullLazyValue partToFacade$delegate;
    private final JvmPackageScope scope = new JvmPackageScope(this.f9676c, this.jPackage, this);
    private final NotNullLazyValue<List<FqName>> subPackages = this.f9676c.getStorageManager().createRecursionTolerantLazyValue(new LazyJavaPackageFragment$subPackages$1(this), CollectionsKt.emptyList());
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext lazyJavaResolverContext, JavaPackage javaPackage) {
        ...
        this.f9676c = childForClassOrPackage$default;
        ...
        if (this.f9676c.getComponents().getJavaTypeEnhancementState().getDisabledDefaultAnnotations()) {
            annotations2 = Annotations.Companion.getEMPTY();
        } else {
            annotations2 = LazyJavaAnnotationsKt.resolveAnnotations(this.f9676c, this.jPackage);
        }
        this.annotations = annotations2;
        this.partToFacade$delegate = this.f9676c.getStorageManager().createLazyValue(new LazyJavaPackageFragment$partToFacade$2(this));
    }
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f9676c.getComponents().getModule();
    }
