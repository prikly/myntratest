...
public final class TypeMappingMode {
    ...
    public static final TypeMappingMode GENERIC_ARGUMENT = new TypeMappingMode(false, false, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, false, IronSourceError.ERROR_RV_SHOW_CALLED_WRONG_STATE, (DefaultConstructorMarker) null);
    public static final TypeMappingMode GENERIC_ARGUMENT_UAST = new TypeMappingMode(false, false, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, true, EventTypeExtended.EVENT_TYPE_EXTENDED_AD_EXPIRED_VALUE, (DefaultConstructorMarker) null);
    public static final TypeMappingMode RETURN_TYPE_BOXED = new TypeMappingMode(false, true, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, false, IronSourceError.ERROR_RV_EMPTY_DEFAULT_PLACEMENT, (DefaultConstructorMarker) null);
    ...
    public TypeMappingMode() {
        this(false, false, false, false, false, (TypeMappingMode) null, false, (TypeMappingMode) null, (TypeMappingMode) null, false, IronSourceError.ERROR_RV_SHOW_CALLED_WRONG_STATE, (DefaultConstructorMarker) null);
    }
