...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    public final LazyJavaResolverContext f9671c;
    ...
    public LazyJavaPackageFragmentProvider(JavaResolverComponents javaResolverComponents) {
        ...
        this.f9671c = lazyJavaResolverContext;
    ...
    private final LazyJavaPackageFragment getPackageFragment(FqName fqName) {
        JavaPackage findPackage = this.f9671c.getComponents().getFinder().findPackage(fqName);
        if (findPackage == null) {
            return null;
        }
    ...
    public boolean isEmpty(FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return this.f9671c.getComponents().getFinder().findPackage(fqName) == null;
    }
    ...
    public String toString() {
        return Intrinsics.stringPlus("LazyJavaPackageFragmentProvider of module ", this.f9671c.getComponents().getModule());
    }
}
