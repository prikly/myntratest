...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    public final DeserializationContext f9686c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f9686c.getTypeTable());
        ...
        TypeDeserializer typeDeserializer = this.f9686c.getTypeDeserializer();
