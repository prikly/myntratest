...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public final SimpleType computeDefaultType() {
        ...
        ClassDescriptor classDescriptor = getClassDescriptor();
        SimpleType makeUnsubstitutedType = TypeUtils.makeUnsubstitutedType(classifierDescriptor, classDescriptor == null ? MemberScope.Empty.INSTANCE : classDescriptor.getUnsubstitutedMemberScope(), (Function1<KotlinTypeRefiner, SimpleType>) new AbstractTypeAliasDescriptor$computeDefaultType$1(this));
