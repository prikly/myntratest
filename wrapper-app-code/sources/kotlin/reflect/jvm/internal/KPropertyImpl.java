...
public abstract class KPropertyImpl<V> extends KCallableImpl<V> implements KProperty<V> {
    ...
    public final Object getDelegateImpl(Member member, Object obj, Object obj2) {
        try {
            if ((obj == EXTENSION_PROPERTY_DELEGATE || obj2 == EXTENSION_PROPERTY_DELEGATE) && getDescriptor().getExtensionReceiverParameter() == null) {
                throw new RuntimeException('\'' + this + "' is not an extension property and thus getExtensionDelegate() is not going to work, use getDelegate() instead");
            }
            Object boundReceiver = isBound() ? getBoundReceiver() : obj;
            if (!(boundReceiver != EXTENSION_PROPERTY_DELEGATE)) {
                boundReceiver = null;
            }
            if (!isBound()) {
                obj = obj2;
