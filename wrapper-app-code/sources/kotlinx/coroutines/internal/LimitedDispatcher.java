...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0042, code lost:
        if (r4.queue.getSize() != 0) goto L_0x0046;
     */
    ...
    public void run() {
        ...
        L_0x0032:
            ...
            monitor-enter(r1)
            int r2 = r4.runningWorkers     // Catch:{ all -> 0x0050 }
            int r2 = r2 + -1
            r4.runningWorkers = r2     // Catch:{ all -> 0x0050 }
            kotlinx.coroutines.internal.LockFreeTaskQueue<java.lang.Runnable> r2 = r4.queue     // Catch:{ all -> 0x0050 }
            int r2 = r2.getSize()     // Catch:{ all -> 0x0050 }
        ...
        L_0x0046:
            ...
            int r2 = r2 + 1
            r4.runningWorkers = r2     // Catch:{ all -> 0x0050 }
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0050 }
            monitor-exit(r1)
            goto L_0x0001
        L_0x0050:
            r0 = move-exception
