...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e2) {
        ...
        if (!(e2 instanceof CopyableThrowable)) {
            return (Throwable) ctorCache.get(e2.getClass()).invoke(e2);
        }
        try {
            Result.Companion companion = Result.Companion;
            e3 = Result.m44constructorimpl(((CopyableThrowable) e2).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e3 = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m48isFailureimpl(e3)) {
            e3 = null;
        }
        return (Throwable) e3;
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            num = Result.m44constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(i);
        if (Result.m48isFailureimpl(num)) {
            num = valueOf;
        }
