...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements CancellableFlow<T>, MutableStateFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0043, code lost:
        if (r5.sequence != r6) goto L_0x004a;
     */
    ...
    private final boolean updateState(java.lang.Object r6, java.lang.Object r7) {
        ...
        L_0x001a:
            ...
            int r6 = r5.sequence     // Catch:{ all -> 0x005d }
            r7 = r6 & 1
            if (r7 != 0) goto L_0x0057
            int r6 = r6 + r0
            r5.sequence = r6     // Catch:{ all -> 0x005d }
        ...
        L_0x0040:
            monitor-enter(r5)
            int r7 = r5.sequence     // Catch:{ all -> 0x0054 }
            if (r7 != r6) goto L_0x004a
            int r6 = r6 + r0
            r5.sequence = r6     // Catch:{ all -> 0x0054 }
            monitor-exit(r5)
            return r0
        L_0x004a:
            int r6 = r5.sequence     // Catch:{ all -> 0x0054 }
