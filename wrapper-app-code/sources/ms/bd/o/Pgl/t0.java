...
public class t0 {
    ...
    private static final String f9743a = ((String) pblk.a(16777217, 0, 0, "da92a1", new byte[]{69, 113, 69, 69, 91, 53, 116, 79, 122}));

    /* renamed from: b  reason: collision with root package name */
    private static final String f9744b = ((String) pblk.a(16777217, 0, 0, "5e9757", new byte[]{Ascii.FF, 102, 88, 71, Ascii.GS, 33, 36, 65}));

    /* renamed from: c  reason: collision with root package name */
    private static final String f9745c = ((String) pblk.a(16777217, 0, 0, "ace8a6", new byte[]{86, 100, Ascii.ETB, 88, 75, 51, 103, 81}));

    /* renamed from: d  reason: collision with root package name */
    private static final String f9746d = ((String) pblk.a(16777217, 0, 0, "bb41d1", new byte[]{99, 99}));

    /* renamed from: e  reason: collision with root package name */
    private static final String f9747e = ((String) pblk.a(16777217, 0, 0, "1355fe", new byte[]{40, 38}));

    /* renamed from: f  reason: collision with root package name */
    private static final String f9748f = ((String) pblk.a(16777217, 0, 0, "28bbd6", new byte[]{37, 46}));

    /* renamed from: g  reason: collision with root package name */
    private static final String f9749g = ((String) pblk.a(16777217, 0, 0, "f56368", new byte[]{122, 54, 93}));

    /* renamed from: h  reason: collision with root package name */
    private static final String f9750h = ((String) pblk.a(16777217, 0, 0, "d724f4", new byte[]{120, 60, 79}));
    private static final String i = ((String) pblk.a(16777217, 0, 0, "26cd34", new byte[]{32, 59, 2, Ascii.NAK}));
    ...
    private static int a() {
        try {
            return new File((String) pblk.a(16777217, 0, 0, "092ead", new byte[]{110, 40, 88, 2, 17, 119, 54, Ascii.SO, 106, 54, 36, 40, Ascii.SO, 2, 71, 96, 39, Ascii.GS, 110, 122, 34, 43, 84, 94})).listFiles(j).length;
    ...
    private static java.lang.String a(java.lang.String r11) {
        /*
            ...
            java.lang.Object r11 = ms.bd.o.Pgl.pblk.a(r5, r6, r7, r9, r10)     // Catch:{ all -> 0x0039 }
    ...
    private static java.util.HashMap<java.lang.String, java.lang.String> b() {
        /*
            ...
            r14 = 75
            r8[r13] = r14     // Catch:{ all -> 0x00a5 }
            java.lang.Object r3 = ms.bd.o.Pgl.pblk.a(r3, r4, r5, r7, r8)     // Catch:{ all -> 0x00a5 }
    ...
    public static String c() {
        ...
        try {
            ...
            jSONObject.put(i, a());
            jSONObject.put(f9746d, a(b2, f9743a));
            jSONObject.put(f9747e, a(b2, f9744b));
            jSONObject.put(f9749g, a((String) pblk.a(16777217, 0, 0, "58cb7a", new byte[]{107, 41, 9, 5, 71, 114, 51, Ascii.SI, 59, 49, 33, 41, 95, 5, 17, 101, 34, Ascii.FS, 63, 125, 39, 42, 5, 89, Ascii.VT, 102, 35, 73, 125, 49, 52, 47, Ascii.SYN, 4, Ascii.CR, 103, 121, Ascii.SUB, 34, 39, 45, 52, Ascii.SYN, Ascii.EM, 55, 123, 55, 1, Ascii.CR, 52, 54, 63, 1})));
            jSONObject.put(f9750h, a((String) pblk.a(16777217, 0, 0, "f0dc27", new byte[]{56, 33, Ascii.SO, 4, 66, 36, 96, 7, 60, 48, 114, 33, 88, 4, Ascii.DC4, 51, 113, Ascii.DC4, 56, 124, 116, 34, 2, 88, Ascii.SO, 48, 112, 65, 122, 48, 103, 39, 17, 5, 8, 49, 42, Ascii.DC2, 37, 38, 126, 60, 17, Ascii.CAN, 50, 45, 108, Ascii.US, 10, 53, 101, 55, 6})));
            jSONObject.put(f9748f, a(b2, f9745c));
        } catch (Throwable unused) {
        }
