...
public abstract class pblo extends pblb.pgla {
    public Object a(int i, int i2, long j, String str, Object obj) throws Throwable {
        boolean z;
        String[] strArr = {(String) pblk.a(16777217, 0, 0, "ce879f", new byte[]{115, 105, 79, 81, 9, 120, 100, 10, 121, 98, 96, 106, 66, 80, Ascii.NAK, 120, 111, 74, 39, 78, 92, 83, 110, 113, 40, 84, 84})};
        try {
            Context b2 = pgla.a().b();
            int i3 = 0;
            while (true) {
                if (i3 >= 1) {
                    z = true;
                    break;
                } else if (b2.checkPermission(strArr[i3], Process.myPid(), Process.myUid()) != 0) {
                    break;
                } else {
                    i3++;
                }
    ...
    public void a(InputStream inputStream) {
        if (inputStream != null) {
            try {
                ...
                String str = (String) pblk.a(16777217, 0, 0, "c3cb49", new byte[]{Ascii.DEL, 50, 47, Ascii.NAK, 2});
            }
        }
    }
    ...
    public void a(OutputStream outputStream) {
        if (outputStream != null) {
            try {
                ...
                String str = (String) pblk.a(16777217, 0, 0, "cfc1d9", new byte[]{Ascii.DEL, 103, 47, 70, 84});
            }
        }
    }
