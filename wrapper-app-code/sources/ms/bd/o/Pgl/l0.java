...
public class l0 {
    ...
    private static volatile boolean f9700a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<String, c> f9701b = new ConcurrentHashMap();
    ...
    public static synchronized pgla a(String str) {
        synchronized (l0.class) {
            if (str == null) {
                throw new NullPointerException((String) pblk.a(16777217, 0, 0, "50af32", new byte[]{37, 34, 2, 59, 40, 101, 59, 4, 35, 34, 100, 48, Ascii.ETB, 82, Ascii.US, 32, 34}));
            } else if (!f9700a) {
                return null;
            } else {
    ...
    public static synchronized boolean a(Context context, c cVar, String str, String str2) {
        ...
        synchronized (l0.class) {
            if (context == null) {
                throw new NullPointerException((String) pblk.a(16777217, 0, 0, "c3c598", new byte[]{113, 62, Ascii.RS, 85, 3, 55, 116, 82, 49, 106, 103, 61, Ascii.DC4, 1, 8, 32, 116, 82, 48, 96, 50, 63, 5, 77, 10}));
            } else if (cVar2 != null) {
                String str3 = cVar2.f9689a;
                String str4 = (str3 == null || str3.length() <= 0) ? cVar2.f9695g : cVar2.f9689a;
                ...
                synchronized (l0.class) {
                    if (!f9700a) {
                        ...
                        pblb.a(16777232, (pblb.pgla) new e());
                ...
                if (f9701b.containsKey(str4)) {
                    return false;
                }
                JSONArray jSONArray = new JSONArray();
                jSONArray.put(cVar2.a(cVar2.f9689a));
                jSONArray.put(cVar2.a(cVar2.f9696h));
                jSONArray.put(cVar2.a(cVar2.f9695g));
                jSONArray.put(cVar2.a(cVar2.i));
                jSONArray.put(cVar2.a(x0.a()));
                jSONArray.put(cVar2.a(cVar2.f9690b));
                jSONArray.put(cVar2.a(cVar2.f9691c));
                jSONArray.put(cVar2.a(cVar2.f9692d));
                jSONArray.put(cVar2.a(cVar2.f9693e));
                jSONArray.put(cVar2.a(cVar2.f9694f));
                ...
                f9701b.put(str4, cVar2);
                return true;
            } else {
                throw new NullPointerException((String) pblk.a(16777217, 0, 0, "c20a0c", new byte[]{113, 63, 77, 19, 6, 115, 32, Ascii.DLE, 110, 36, 126, 52, 3, Ascii.ESC, 0, 96, 32, 17, 100, 113, 124, 37, 79, Ascii.EM}));
            }
        }
    }
}
