...
public final class pblb {
    ...
    private static final SparseArray<pgla> f9710a = new SparseArray<>();
    ...
    public static void a(int i, pgla pgla2) {
        pgla pgla3 = f9710a.get(i);
        if (pgla3 == null) {
            f9710a.put(i, pgla2);
        } else {
            throw new RuntimeException(String.format((String) pblk.a(16777217, 0, 0, "4fa152", new byte[]{96, 119, 82, 77, Ascii.VT, 33, 119, 69, 53, 100, 43, 36, 0, 64, Ascii.CR, 44, 36, 83, 53, 115, 107}), new Object[]{pgla3.toString()}));
        }
    }

    public static Object b(int i, int i2, long j, String str, Object obj) {
        pgla pgla2 = f9710a.get(i);
        if (pgla2 != null) {
            try {
            ...
            throw new RuntimeException(String.format((String) pblk.a(16777217, 0, 0, "0b8fa0", new byte[]{46, 112, Ascii.VT, 17, 81, 35, 54, 3, 44, 50, 97, 105, 88, 82, 87, 41, 37, 66, 101, 63, 37}), new Object[]{Integer.valueOf(i)}));
        }
    }
